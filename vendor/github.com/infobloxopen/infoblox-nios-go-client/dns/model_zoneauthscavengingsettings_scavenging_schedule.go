...
// checks if the ZoneauthscavengingsettingsScavengingSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoneauthscavengingsettingsScavengingSchedule{}

// ZoneauthscavengingsettingsScavengingSchedule struct for ZoneauthscavengingsettingsScavengingSchedule
type ZoneauthscavengingsettingsScavengingSchedule struct {
...
type _ZoneauthscavengingsettingsScavengingSchedule ZoneauthscavengingsettingsScavengingSchedule
...
func NewZoneauthscavengingsettingsScavengingSchedule() *ZoneauthscavengingsettingsScavengingSchedule {
	this := ZoneauthscavengingsettingsScavengingSchedule{}
	return &this
}
...
func (o ZoneauthscavengingsettingsScavengingSchedule) MarshalJSON() ([]byte, error) {
...
func (o ZoneauthscavengingsettingsScavengingSchedule) ToMap() (map[string]interface{}, error) {
...
func (o *ZoneauthscavengingsettingsScavengingSchedule) UnmarshalJSON(data []byte) (err error) {
	varZoneauthscavengingsettingsScavengingSchedule := _ZoneauthscavengingsettingsScavengingSchedule{}

	err = json.Unmarshal(data, &varZoneauthscavengingsettingsScavengingSchedule)

	if err != nil {
		return err
	}

	*o = ZoneauthscavengingsettingsScavengingSchedule(varZoneauthscavengingsettingsScavengingSchedule)
...
type NullableZoneauthscavengingsettingsScavengingSchedule struct {
	value *ZoneauthscavengingsettingsScavengingSchedule
	isSet bool
}

func (v NullableZoneauthscavengingsettingsScavengingSchedule) Get() *ZoneauthscavengingsettingsScavengingSchedule {
	return v.value
}

func (v *NullableZoneauthscavengingsettingsScavengingSchedule) Set(val *ZoneauthscavengingsettingsScavengingSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableZoneauthscavengingsettingsScavengingSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableZoneauthscavengingsettingsScavengingSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZoneauthscavengingsettingsScavengingSchedule(val *ZoneauthscavengingsettingsScavengingSchedule) *NullableZoneauthscavengingsettingsScavengingSchedule {
	return &NullableZoneauthscavengingsettingsScavengingSchedule{value: val, isSet: true}
}

func (v NullableZoneauthscavengingsettingsScavengingSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZoneauthscavengingsettingsScavengingSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
