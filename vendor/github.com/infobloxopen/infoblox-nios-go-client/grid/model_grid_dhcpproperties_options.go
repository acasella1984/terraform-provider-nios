...
// checks if the GridDhcppropertiesOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridDhcppropertiesOptions{}

// GridDhcppropertiesOptions struct for GridDhcppropertiesOptions
type GridDhcppropertiesOptions struct {
...
type _GridDhcppropertiesOptions GridDhcppropertiesOptions
...
func NewGridDhcppropertiesOptions() *GridDhcppropertiesOptions {
	this := GridDhcppropertiesOptions{}
	return &this
}
...
func (o GridDhcppropertiesOptions) MarshalJSON() ([]byte, error) {
...
func (o GridDhcppropertiesOptions) ToMap() (map[string]interface{}, error) {
...
func (o *GridDhcppropertiesOptions) UnmarshalJSON(data []byte) (err error) {
	varGridDhcppropertiesOptions := _GridDhcppropertiesOptions{}

	err = json.Unmarshal(data, &varGridDhcppropertiesOptions)

	if err != nil {
		return err
	}

	*o = GridDhcppropertiesOptions(varGridDhcppropertiesOptions)
...
type NullableGridDhcppropertiesOptions struct {
	value *GridDhcppropertiesOptions
	isSet bool
}

func (v NullableGridDhcppropertiesOptions) Get() *GridDhcppropertiesOptions {
	return v.value
}

func (v *NullableGridDhcppropertiesOptions) Set(val *GridDhcppropertiesOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableGridDhcppropertiesOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableGridDhcppropertiesOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridDhcppropertiesOptions(val *GridDhcppropertiesOptions) *NullableGridDhcppropertiesOptions {
	return &NullableGridDhcppropertiesOptions{value: val, isSet: true}
}

func (v NullableGridDhcppropertiesOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridDhcppropertiesOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
