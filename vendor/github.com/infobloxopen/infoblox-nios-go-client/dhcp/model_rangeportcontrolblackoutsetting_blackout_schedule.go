...
// checks if the RangeportcontrolblackoutsettingBlackoutSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RangeportcontrolblackoutsettingBlackoutSchedule{}

// RangeportcontrolblackoutsettingBlackoutSchedule struct for RangeportcontrolblackoutsettingBlackoutSchedule
type RangeportcontrolblackoutsettingBlackoutSchedule struct {
...
type _RangeportcontrolblackoutsettingBlackoutSchedule RangeportcontrolblackoutsettingBlackoutSchedule
...
func NewRangeportcontrolblackoutsettingBlackoutSchedule() *RangeportcontrolblackoutsettingBlackoutSchedule {
	this := RangeportcontrolblackoutsettingBlackoutSchedule{}
	return &this
}
...
func (o RangeportcontrolblackoutsettingBlackoutSchedule) MarshalJSON() ([]byte, error) {
...
func (o RangeportcontrolblackoutsettingBlackoutSchedule) ToMap() (map[string]interface{}, error) {
...
func (o *RangeportcontrolblackoutsettingBlackoutSchedule) UnmarshalJSON(data []byte) (err error) {
	varRangeportcontrolblackoutsettingBlackoutSchedule := _RangeportcontrolblackoutsettingBlackoutSchedule{}

	err = json.Unmarshal(data, &varRangeportcontrolblackoutsettingBlackoutSchedule)

	if err != nil {
		return err
	}

	*o = RangeportcontrolblackoutsettingBlackoutSchedule(varRangeportcontrolblackoutsettingBlackoutSchedule)
...
type NullableRangeportcontrolblackoutsettingBlackoutSchedule struct {
	value *RangeportcontrolblackoutsettingBlackoutSchedule
	isSet bool
}

func (v NullableRangeportcontrolblackoutsettingBlackoutSchedule) Get() *RangeportcontrolblackoutsettingBlackoutSchedule {
	return v.value
}

func (v *NullableRangeportcontrolblackoutsettingBlackoutSchedule) Set(val *RangeportcontrolblackoutsettingBlackoutSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableRangeportcontrolblackoutsettingBlackoutSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableRangeportcontrolblackoutsettingBlackoutSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRangeportcontrolblackoutsettingBlackoutSchedule(val *RangeportcontrolblackoutsettingBlackoutSchedule) *NullableRangeportcontrolblackoutsettingBlackoutSchedule {
	return &NullableRangeportcontrolblackoutsettingBlackoutSchedule{value: val, isSet: true}
}

func (v NullableRangeportcontrolblackoutsettingBlackoutSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRangeportcontrolblackoutsettingBlackoutSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
