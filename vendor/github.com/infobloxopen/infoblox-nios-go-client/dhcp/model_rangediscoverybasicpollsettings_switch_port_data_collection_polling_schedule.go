...
// checks if the RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{}

// RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule struct for RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule
type RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule struct {
...
type _RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule
...
func NewRangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule() *RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule {
	this := RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{}
	return &this
}
...
func (o RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) MarshalJSON() ([]byte, error) {
...
func (o RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) ToMap() (map[string]interface{}, error) {
...
func (o *RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) UnmarshalJSON(data []byte) (err error) {
	varRangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule := _RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{}

	err = json.Unmarshal(data, &varRangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule)

	if err != nil {
		return err
	}

	*o = RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule(varRangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule)
...
type NullableRangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule struct {
	value *RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule
	isSet bool
}

func (v NullableRangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) Get() *RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule {
	return v.value
}

func (v *NullableRangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) Set(val *RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableRangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableRangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule(val *RangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) *NullableRangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule {
	return &NullableRangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{value: val, isSet: true}
}

func (v NullableRangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
