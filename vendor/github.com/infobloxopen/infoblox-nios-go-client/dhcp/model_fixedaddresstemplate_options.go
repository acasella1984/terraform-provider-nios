...
// checks if the FixedaddresstemplateOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FixedaddresstemplateOptions{}

// FixedaddresstemplateOptions struct for FixedaddresstemplateOptions
type FixedaddresstemplateOptions struct {
...
type _FixedaddresstemplateOptions FixedaddresstemplateOptions
...
func NewFixedaddresstemplateOptions() *FixedaddresstemplateOptions {
	this := FixedaddresstemplateOptions{}
	return &this
}
...
func (o FixedaddresstemplateOptions) MarshalJSON() ([]byte, error) {
...
func (o FixedaddresstemplateOptions) ToMap() (map[string]interface{}, error) {
...
func (o *FixedaddresstemplateOptions) UnmarshalJSON(data []byte) (err error) {
	varFixedaddresstemplateOptions := _FixedaddresstemplateOptions{}

	err = json.Unmarshal(data, &varFixedaddresstemplateOptions)

	if err != nil {
		return err
	}

	*o = FixedaddresstemplateOptions(varFixedaddresstemplateOptions)
...
type NullableFixedaddresstemplateOptions struct {
	value *FixedaddresstemplateOptions
	isSet bool
}

func (v NullableFixedaddresstemplateOptions) Get() *FixedaddresstemplateOptions {
	return v.value
}

func (v *NullableFixedaddresstemplateOptions) Set(val *FixedaddresstemplateOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableFixedaddresstemplateOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableFixedaddresstemplateOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFixedaddresstemplateOptions(val *FixedaddresstemplateOptions) *NullableFixedaddresstemplateOptions {
	return &NullableFixedaddresstemplateOptions{value: val, isSet: true}
}

func (v NullableFixedaddresstemplateOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFixedaddresstemplateOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
