...
// checks if the NotificationRuleScheduledEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationRuleScheduledEvent{}

// NotificationRuleScheduledEvent struct for NotificationRuleScheduledEvent
type NotificationRuleScheduledEvent struct {
...
type _NotificationRuleScheduledEvent NotificationRuleScheduledEvent
...
func NewNotificationRuleScheduledEvent() *NotificationRuleScheduledEvent {
	this := NotificationRuleScheduledEvent{}
	return &this
}
...
func (o NotificationRuleScheduledEvent) MarshalJSON() ([]byte, error) {
...
func (o NotificationRuleScheduledEvent) ToMap() (map[string]interface{}, error) {
...
func (o *NotificationRuleScheduledEvent) UnmarshalJSON(data []byte) (err error) {
	varNotificationRuleScheduledEvent := _NotificationRuleScheduledEvent{}

	err = json.Unmarshal(data, &varNotificationRuleScheduledEvent)

	if err != nil {
		return err
	}

	*o = NotificationRuleScheduledEvent(varNotificationRuleScheduledEvent)
...
type NullableNotificationRuleScheduledEvent struct {
	value *NotificationRuleScheduledEvent
	isSet bool
}

func (v NullableNotificationRuleScheduledEvent) Get() *NotificationRuleScheduledEvent {
	return v.value
}

func (v *NullableNotificationRuleScheduledEvent) Set(val *NotificationRuleScheduledEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationRuleScheduledEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationRuleScheduledEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationRuleScheduledEvent(val *NotificationRuleScheduledEvent) *NullableNotificationRuleScheduledEvent {
	return &NullableNotificationRuleScheduledEvent{value: val, isSet: true}
}

func (v NullableNotificationRuleScheduledEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationRuleScheduledEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
