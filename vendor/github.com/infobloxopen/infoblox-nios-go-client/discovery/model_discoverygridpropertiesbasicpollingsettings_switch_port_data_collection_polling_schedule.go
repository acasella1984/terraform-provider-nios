...
// checks if the DiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule{}

// DiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule struct for DiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule
type DiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule struct {
...
type _DiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule DiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule
...
func NewDiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule() *DiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule {
	this := DiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule{}
	return &this
}
...
func (o DiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule) MarshalJSON() ([]byte, error) {
...
func (o DiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule) ToMap() (map[string]interface{}, error) {
...
func (o *DiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule) UnmarshalJSON(data []byte) (err error) {
	varDiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule := _DiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule{}

	err = json.Unmarshal(data, &varDiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule)

	if err != nil {
		return err
	}

	*o = DiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule(varDiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule)
...
type NullableDiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule struct {
	value *DiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule
	isSet bool
}

func (v NullableDiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule) Get() *DiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule {
	return v.value
}

func (v *NullableDiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule) Set(val *DiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableDiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableDiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule(val *DiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule) *NullableDiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule {
	return &NullableDiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule{value: val, isSet: true}
}

func (v NullableDiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiscoverygridpropertiesbasicpollingsettingsSwitchPortDataCollectionPollingSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
