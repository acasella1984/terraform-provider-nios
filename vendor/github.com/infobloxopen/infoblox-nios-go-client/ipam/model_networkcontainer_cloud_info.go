...
// checks if the NetworkcontainerCloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkcontainerCloudInfo{}

// NetworkcontainerCloudInfo struct for NetworkcontainerCloudInfo
type NetworkcontainerCloudInfo struct {
	DelegatedMember *NetworkcontainercloudinfoDelegatedMember `json:"delegated_member,omitempty"`
...
type _NetworkcontainerCloudInfo NetworkcontainerCloudInfo
...
func NewNetworkcontainerCloudInfo() *NetworkcontainerCloudInfo {
	this := NetworkcontainerCloudInfo{}
	return &this
}
...
func (o *NetworkcontainerCloudInfo) GetDelegatedMember() NetworkcontainercloudinfoDelegatedMember {
	if o == nil || IsNil(o.DelegatedMember) {
		var ret NetworkcontainercloudinfoDelegatedMember
		return ret
	}
...
func (o *NetworkcontainerCloudInfo) GetDelegatedMemberOk() (*NetworkcontainercloudinfoDelegatedMember, bool) {
	if o == nil || IsNil(o.DelegatedMember) {
		return nil, false
	}
...
// SetDelegatedMember gets a reference to the given NetworkcontainercloudinfoDelegatedMember and assigns it to the DelegatedMember field.
...
func (o *NetworkcontainerCloudInfo) GetAuthorityType() string {
...
func (o NetworkcontainerCloudInfo) MarshalJSON() ([]byte, error) {
...
func (o NetworkcontainerCloudInfo) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkcontainerCloudInfo) UnmarshalJSON(data []byte) (err error) {
	varNetworkcontainerCloudInfo := _NetworkcontainerCloudInfo{}

	err = json.Unmarshal(data, &varNetworkcontainerCloudInfo)

	if err != nil {
		return err
	}

	*o = NetworkcontainerCloudInfo(varNetworkcontainerCloudInfo)
...
type NullableNetworkcontainerCloudInfo struct {
	value *NetworkcontainerCloudInfo
	isSet bool
}

func (v NullableNetworkcontainerCloudInfo) Get() *NetworkcontainerCloudInfo {
	return v.value
}

func (v *NullableNetworkcontainerCloudInfo) Set(val *NetworkcontainerCloudInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkcontainerCloudInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkcontainerCloudInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkcontainerCloudInfo(val *NetworkcontainerCloudInfo) *NullableNetworkcontainerCloudInfo {
	return &NullableNetworkcontainerCloudInfo{value: val, isSet: true}
}

func (v NullableNetworkcontainerCloudInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkcontainerCloudInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
