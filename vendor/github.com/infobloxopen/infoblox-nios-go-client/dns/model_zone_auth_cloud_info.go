...
// checks if the ZoneAuthCloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoneAuthCloudInfo{}

// ZoneAuthCloudInfo struct for ZoneAuthCloudInfo
type ZoneAuthCloudInfo struct {
	DelegatedMember *ZoneauthcloudinfoDelegatedMember `json:"delegated_member,omitempty"`
...
type _ZoneAuthCloudInfo ZoneAuthCloudInfo
...
func (o *ZoneAuthCloudInfo) GetDelegatedMember() ZoneauthcloudinfoDelegatedMember {
	if o == nil || IsNil(o.DelegatedMember) {
		var ret ZoneauthcloudinfoDelegatedMember
		return ret
	}
...
// SetDelegatedMember gets a reference to the given ZoneauthcloudinfoDelegatedMember and assigns it to the DelegatedMember field.
...
func (o ZoneAuthCloudInfo) MarshalJSON() ([]byte, error) {
...
func (o ZoneAuthCloudInfo) ToMap() (map[string]interface{}, error) {
...
func (o *ZoneAuthCloudInfo) UnmarshalJSON(data []byte) (err error) {
	varZoneAuthCloudInfo := _ZoneAuthCloudInfo{}

	err = json.Unmarshal(data, &varZoneAuthCloudInfo)

	if err != nil {
		return err
	}

	*o = ZoneAuthCloudInfo(varZoneAuthCloudInfo)
...
type NullableZoneAuthCloudInfo struct {
	value *ZoneAuthCloudInfo
	isSet bool
}

func (v NullableZoneAuthCloudInfo) Get() *ZoneAuthCloudInfo {
	return v.value
}

func (v *NullableZoneAuthCloudInfo) Set(val *ZoneAuthCloudInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableZoneAuthCloudInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableZoneAuthCloudInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZoneAuthCloudInfo(val *ZoneAuthCloudInfo) *NullableZoneAuthCloudInfo {
	return &NullableZoneAuthCloudInfo{value: val, isSet: true}
}

func (v NullableZoneAuthCloudInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZoneAuthCloudInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
