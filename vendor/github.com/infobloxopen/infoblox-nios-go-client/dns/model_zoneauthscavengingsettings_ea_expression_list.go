...
// checks if the ZoneauthscavengingsettingsEaExpressionList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoneauthscavengingsettingsEaExpressionList{}

// ZoneauthscavengingsettingsEaExpressionList struct for ZoneauthscavengingsettingsEaExpressionList
type ZoneauthscavengingsettingsEaExpressionList struct {
	// The operation name.
...
type _ZoneauthscavengingsettingsEaExpressionList ZoneauthscavengingsettingsEaExpressionList
...
func NewZoneauthscavengingsettingsEaExpressionList() *ZoneauthscavengingsettingsEaExpressionList {
	this := ZoneauthscavengingsettingsEaExpressionList{}
	return &this
}
...
func (o ZoneauthscavengingsettingsEaExpressionList) MarshalJSON() ([]byte, error) {
...
func (o ZoneauthscavengingsettingsEaExpressionList) ToMap() (map[string]interface{}, error) {
...
func (o *ZoneauthscavengingsettingsEaExpressionList) UnmarshalJSON(data []byte) (err error) {
	varZoneauthscavengingsettingsEaExpressionList := _ZoneauthscavengingsettingsEaExpressionList{}

	err = json.Unmarshal(data, &varZoneauthscavengingsettingsEaExpressionList)

	if err != nil {
		return err
	}

	*o = ZoneauthscavengingsettingsEaExpressionList(varZoneauthscavengingsettingsEaExpressionList)
...
type NullableZoneauthscavengingsettingsEaExpressionList struct {
	value *ZoneauthscavengingsettingsEaExpressionList
	isSet bool
}

func (v NullableZoneauthscavengingsettingsEaExpressionList) Get() *ZoneauthscavengingsettingsEaExpressionList {
	return v.value
}

func (v *NullableZoneauthscavengingsettingsEaExpressionList) Set(val *ZoneauthscavengingsettingsEaExpressionList) {
	v.value = val
	v.isSet = true
}

func (v NullableZoneauthscavengingsettingsEaExpressionList) IsSet() bool {
	return v.isSet
}

func (v *NullableZoneauthscavengingsettingsEaExpressionList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZoneauthscavengingsettingsEaExpressionList(val *ZoneauthscavengingsettingsEaExpressionList) *NullableZoneauthscavengingsettingsEaExpressionList {
	return &NullableZoneauthscavengingsettingsEaExpressionList{value: val, isSet: true}
}

func (v NullableZoneauthscavengingsettingsEaExpressionList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZoneauthscavengingsettingsEaExpressionList) UnmarshalJSON(src []byte) error {
	v.isSet = true
