...
// checks if the GridCloudapiVmCloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridCloudapiVmCloudInfo{}

// GridCloudapiVmCloudInfo struct for GridCloudapiVmCloudInfo
type GridCloudapiVmCloudInfo struct {
	DelegatedMember *GridcloudapivmcloudinfoDelegatedMember `json:"delegated_member,omitempty"`
...
type _GridCloudapiVmCloudInfo GridCloudapiVmCloudInfo
...
func (o *GridCloudapiVmCloudInfo) GetDelegatedMember() GridcloudapivmcloudinfoDelegatedMember {
	if o == nil || IsNil(o.DelegatedMember) {
		var ret GridcloudapivmcloudinfoDelegatedMember
		return ret
	}
...
func (o *GridCloudapiVmCloudInfo) GetDelegatedMemberOk() (*GridcloudapivmcloudinfoDelegatedMember, bool) {
	if o == nil || IsNil(o.DelegatedMember) {
		return nil, false
	}
...
// SetDelegatedMember gets a reference to the given GridcloudapivmcloudinfoDelegatedMember and assigns it to the DelegatedMember field.
...
func (o *GridCloudapiVmCloudInfo) GetAuthorityType() string {
...
func (o GridCloudapiVmCloudInfo) MarshalJSON() ([]byte, error) {
...
func (o GridCloudapiVmCloudInfo) ToMap() (map[string]interface{}, error) {
...
func (o *GridCloudapiVmCloudInfo) UnmarshalJSON(data []byte) (err error) {
	varGridCloudapiVmCloudInfo := _GridCloudapiVmCloudInfo{}

	err = json.Unmarshal(data, &varGridCloudapiVmCloudInfo)

	if err != nil {
		return err
	}

	*o = GridCloudapiVmCloudInfo(varGridCloudapiVmCloudInfo)
...
type NullableGridCloudapiVmCloudInfo struct {
	value *GridCloudapiVmCloudInfo
	isSet bool
}

func (v NullableGridCloudapiVmCloudInfo) Get() *GridCloudapiVmCloudInfo {
	return v.value
}

func (v *NullableGridCloudapiVmCloudInfo) Set(val *GridCloudapiVmCloudInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableGridCloudapiVmCloudInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableGridCloudapiVmCloudInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridCloudapiVmCloudInfo(val *GridCloudapiVmCloudInfo) *NullableGridCloudapiVmCloudInfo {
	return &NullableGridCloudapiVmCloudInfo{value: val, isSet: true}
}

func (v NullableGridCloudapiVmCloudInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridCloudapiVmCloudInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
