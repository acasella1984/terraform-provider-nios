...
// checks if the DiscoveryGridpropertiesSnmpv1v2Credentials type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiscoveryGridpropertiesSnmpv1v2Credentials{}

// DiscoveryGridpropertiesSnmpv1v2Credentials struct for DiscoveryGridpropertiesSnmpv1v2Credentials
type DiscoveryGridpropertiesSnmpv1v2Credentials struct {
...
type _DiscoveryGridpropertiesSnmpv1v2Credentials DiscoveryGridpropertiesSnmpv1v2Credentials
...
func NewDiscoveryGridpropertiesSnmpv1v2Credentials() *DiscoveryGridpropertiesSnmpv1v2Credentials {
	this := DiscoveryGridpropertiesSnmpv1v2Credentials{}
	return &this
}
...
func (o DiscoveryGridpropertiesSnmpv1v2Credentials) MarshalJSON() ([]byte, error) {
...
func (o DiscoveryGridpropertiesSnmpv1v2Credentials) ToMap() (map[string]interface{}, error) {
...
func (o *DiscoveryGridpropertiesSnmpv1v2Credentials) UnmarshalJSON(data []byte) (err error) {
	varDiscoveryGridpropertiesSnmpv1v2Credentials := _DiscoveryGridpropertiesSnmpv1v2Credentials{}

	err = json.Unmarshal(data, &varDiscoveryGridpropertiesSnmpv1v2Credentials)

	if err != nil {
		return err
	}

	*o = DiscoveryGridpropertiesSnmpv1v2Credentials(varDiscoveryGridpropertiesSnmpv1v2Credentials)
...
type NullableDiscoveryGridpropertiesSnmpv1v2Credentials struct {
	value *DiscoveryGridpropertiesSnmpv1v2Credentials
	isSet bool
}

func (v NullableDiscoveryGridpropertiesSnmpv1v2Credentials) Get() *DiscoveryGridpropertiesSnmpv1v2Credentials {
	return v.value
}

func (v *NullableDiscoveryGridpropertiesSnmpv1v2Credentials) Set(val *DiscoveryGridpropertiesSnmpv1v2Credentials) {
	v.value = val
	v.isSet = true
}

func (v NullableDiscoveryGridpropertiesSnmpv1v2Credentials) IsSet() bool {
	return v.isSet
}

func (v *NullableDiscoveryGridpropertiesSnmpv1v2Credentials) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiscoveryGridpropertiesSnmpv1v2Credentials(val *DiscoveryGridpropertiesSnmpv1v2Credentials) *NullableDiscoveryGridpropertiesSnmpv1v2Credentials {
	return &NullableDiscoveryGridpropertiesSnmpv1v2Credentials{value: val, isSet: true}
}

func (v NullableDiscoveryGridpropertiesSnmpv1v2Credentials) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiscoveryGridpropertiesSnmpv1v2Credentials) UnmarshalJSON(src []byte) error {
	v.isSet = true
