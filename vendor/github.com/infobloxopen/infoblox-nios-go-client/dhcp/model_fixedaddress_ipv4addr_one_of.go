...
// checks if the FixedaddressIpv4addrOneOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FixedaddressIpv4addrOneOf{}

// FixedaddressIpv4addrOneOf fixedaddress: The IPv4 Address of the fixed address.
type FixedaddressIpv4addrOneOf struct {
...
type _FixedaddressIpv4addrOneOf FixedaddressIpv4addrOneOf
...
func NewFixedaddressIpv4addrOneOf() *FixedaddressIpv4addrOneOf {
	this := FixedaddressIpv4addrOneOf{}
	return &this
}
...
func (o FixedaddressIpv4addrOneOf) MarshalJSON() ([]byte, error) {
...
func (o FixedaddressIpv4addrOneOf) ToMap() (map[string]interface{}, error) {
...
func (o *FixedaddressIpv4addrOneOf) UnmarshalJSON(data []byte) (err error) {
	varFixedaddressIpv4addrOneOf := _FixedaddressIpv4addrOneOf{}

	err = json.Unmarshal(data, &varFixedaddressIpv4addrOneOf)

	if err != nil {
		return err
	}

	*o = FixedaddressIpv4addrOneOf(varFixedaddressIpv4addrOneOf)
...
type NullableFixedaddressIpv4addrOneOf struct {
	value *FixedaddressIpv4addrOneOf
	isSet bool
}

func (v NullableFixedaddressIpv4addrOneOf) Get() *FixedaddressIpv4addrOneOf {
	return v.value
}

func (v *NullableFixedaddressIpv4addrOneOf) Set(val *FixedaddressIpv4addrOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFixedaddressIpv4addrOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFixedaddressIpv4addrOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFixedaddressIpv4addrOneOf(val *FixedaddressIpv4addrOneOf) *NullableFixedaddressIpv4addrOneOf {
	return &NullableFixedaddressIpv4addrOneOf{value: val, isSet: true}
}

func (v NullableFixedaddressIpv4addrOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFixedaddressIpv4addrOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
