...
// checks if the ThreatprotectionruleconfigParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThreatprotectionruleconfigParams{}

// ThreatprotectionruleconfigParams struct for ThreatprotectionruleconfigParams
type ThreatprotectionruleconfigParams struct {
...
type _ThreatprotectionruleconfigParams ThreatprotectionruleconfigParams
...
func NewThreatprotectionruleconfigParams() *ThreatprotectionruleconfigParams {
	this := ThreatprotectionruleconfigParams{}
	return &this
}
...
func (o ThreatprotectionruleconfigParams) MarshalJSON() ([]byte, error) {
...
func (o ThreatprotectionruleconfigParams) ToMap() (map[string]interface{}, error) {
...
func (o *ThreatprotectionruleconfigParams) UnmarshalJSON(data []byte) (err error) {
	varThreatprotectionruleconfigParams := _ThreatprotectionruleconfigParams{}

	err = json.Unmarshal(data, &varThreatprotectionruleconfigParams)

	if err != nil {
		return err
	}

	*o = ThreatprotectionruleconfigParams(varThreatprotectionruleconfigParams)
...
type NullableThreatprotectionruleconfigParams struct {
	value *ThreatprotectionruleconfigParams
	isSet bool
}

func (v NullableThreatprotectionruleconfigParams) Get() *ThreatprotectionruleconfigParams {
	return v.value
}

func (v *NullableThreatprotectionruleconfigParams) Set(val *ThreatprotectionruleconfigParams) {
	v.value = val
	v.isSet = true
}

func (v NullableThreatprotectionruleconfigParams) IsSet() bool {
	return v.isSet
}

func (v *NullableThreatprotectionruleconfigParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableThreatprotectionruleconfigParams(val *ThreatprotectionruleconfigParams) *NullableThreatprotectionruleconfigParams {
	return &NullableThreatprotectionruleconfigParams{value: val, isSet: true}
}

func (v NullableThreatprotectionruleconfigParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableThreatprotectionruleconfigParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
