...
// checks if the RecordRpzCnameClientipaddressdn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordRpzCnameClientipaddressdn{}

// RecordRpzCnameClientipaddressdn struct for RecordRpzCnameClientipaddressdn
...
func NewRecordRpzCnameClientipaddressdn() *RecordRpzCnameClientipaddressdn {
	this := RecordRpzCnameClientipaddressdn{}
	return &this
}
...
func (o RecordRpzCnameClientipaddressdn) MarshalJSON() ([]byte, error) {
...
func (o RecordRpzCnameClientipaddressdn) ToMap() (map[string]interface{}, error) {
...
type NullableRecordRpzCnameClientipaddressdn struct {
	value *RecordRpzCnameClientipaddressdn
	isSet bool
}

func (v NullableRecordRpzCnameClientipaddressdn) Get() *RecordRpzCnameClientipaddressdn {
	return v.value
}

func (v *NullableRecordRpzCnameClientipaddressdn) Set(val *RecordRpzCnameClientipaddressdn) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordRpzCnameClientipaddressdn) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordRpzCnameClientipaddressdn) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordRpzCnameClientipaddressdn(val *RecordRpzCnameClientipaddressdn) *NullableRecordRpzCnameClientipaddressdn {
	return &NullableRecordRpzCnameClientipaddressdn{value: val, isSet: true}
}

func (v NullableRecordRpzCnameClientipaddressdn) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordRpzCnameClientipaddressdn) UnmarshalJSON(src []byte) error {
	v.isSet = true
