...
// checks if the RecordACloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordACloudInfo{}

// RecordACloudInfo struct for RecordACloudInfo
type RecordACloudInfo struct {
	DelegatedMember *RecordacloudinfoDelegatedMember `json:"delegated_member,omitempty"`
...
type _RecordACloudInfo RecordACloudInfo
...
func (o *RecordACloudInfo) GetDelegatedMember() RecordacloudinfoDelegatedMember {
	if o == nil || IsNil(o.DelegatedMember) {
		var ret RecordacloudinfoDelegatedMember
		return ret
	}
...
// SetDelegatedMember gets a reference to the given RecordacloudinfoDelegatedMember and assigns it to the DelegatedMember field.
...
func (o RecordACloudInfo) MarshalJSON() ([]byte, error) {
...
func (o RecordACloudInfo) ToMap() (map[string]interface{}, error) {
...
func (o *RecordACloudInfo) UnmarshalJSON(data []byte) (err error) {
	varRecordACloudInfo := _RecordACloudInfo{}

	err = json.Unmarshal(data, &varRecordACloudInfo)

	if err != nil {
		return err
	}

	*o = RecordACloudInfo(varRecordACloudInfo)
...
type NullableRecordACloudInfo struct {
	value *RecordACloudInfo
	isSet bool
}

func (v NullableRecordACloudInfo) Get() *RecordACloudInfo {
	return v.value
}

func (v *NullableRecordACloudInfo) Set(val *RecordACloudInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordACloudInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordACloudInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordACloudInfo(val *RecordACloudInfo) *NullableRecordACloudInfo {
	return &NullableRecordACloudInfo{value: val, isSet: true}
}

func (v NullableRecordACloudInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordACloudInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
