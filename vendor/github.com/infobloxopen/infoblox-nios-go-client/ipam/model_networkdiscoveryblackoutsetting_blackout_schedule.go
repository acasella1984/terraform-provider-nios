...
// checks if the NetworkdiscoveryblackoutsettingBlackoutSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkdiscoveryblackoutsettingBlackoutSchedule{}

// NetworkdiscoveryblackoutsettingBlackoutSchedule struct for NetworkdiscoveryblackoutsettingBlackoutSchedule
type NetworkdiscoveryblackoutsettingBlackoutSchedule struct {
...
type _NetworkdiscoveryblackoutsettingBlackoutSchedule NetworkdiscoveryblackoutsettingBlackoutSchedule
...
func NewNetworkdiscoveryblackoutsettingBlackoutSchedule() *NetworkdiscoveryblackoutsettingBlackoutSchedule {
	this := NetworkdiscoveryblackoutsettingBlackoutSchedule{}
	return &this
}
...
func (o NetworkdiscoveryblackoutsettingBlackoutSchedule) MarshalJSON() ([]byte, error) {
...
func (o NetworkdiscoveryblackoutsettingBlackoutSchedule) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkdiscoveryblackoutsettingBlackoutSchedule) UnmarshalJSON(data []byte) (err error) {
	varNetworkdiscoveryblackoutsettingBlackoutSchedule := _NetworkdiscoveryblackoutsettingBlackoutSchedule{}

	err = json.Unmarshal(data, &varNetworkdiscoveryblackoutsettingBlackoutSchedule)

	if err != nil {
		return err
	}

	*o = NetworkdiscoveryblackoutsettingBlackoutSchedule(varNetworkdiscoveryblackoutsettingBlackoutSchedule)
...
type NullableNetworkdiscoveryblackoutsettingBlackoutSchedule struct {
	value *NetworkdiscoveryblackoutsettingBlackoutSchedule
	isSet bool
}

func (v NullableNetworkdiscoveryblackoutsettingBlackoutSchedule) Get() *NetworkdiscoveryblackoutsettingBlackoutSchedule {
	return v.value
}

func (v *NullableNetworkdiscoveryblackoutsettingBlackoutSchedule) Set(val *NetworkdiscoveryblackoutsettingBlackoutSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkdiscoveryblackoutsettingBlackoutSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkdiscoveryblackoutsettingBlackoutSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkdiscoveryblackoutsettingBlackoutSchedule(val *NetworkdiscoveryblackoutsettingBlackoutSchedule) *NullableNetworkdiscoveryblackoutsettingBlackoutSchedule {
	return &NullableNetworkdiscoveryblackoutsettingBlackoutSchedule{value: val, isSet: true}
}

func (v NullableNetworkdiscoveryblackoutsettingBlackoutSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkdiscoveryblackoutsettingBlackoutSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
