...
// checks if the Ipv6networkportcontrolblackoutsettingBlackoutSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Ipv6networkportcontrolblackoutsettingBlackoutSchedule{}

// Ipv6networkportcontrolblackoutsettingBlackoutSchedule struct for Ipv6networkportcontrolblackoutsettingBlackoutSchedule
type Ipv6networkportcontrolblackoutsettingBlackoutSchedule struct {
...
type _Ipv6networkportcontrolblackoutsettingBlackoutSchedule Ipv6networkportcontrolblackoutsettingBlackoutSchedule

// NewIpv6networkportcontrolblackoutsettingBlackoutSchedule instantiates a new Ipv6networkportcontrolblackoutsettingBlackoutSchedule object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewIpv6networkportcontrolblackoutsettingBlackoutSchedule() *Ipv6networkportcontrolblackoutsettingBlackoutSchedule {
	this := Ipv6networkportcontrolblackoutsettingBlackoutSchedule{}
	return &this
}

// NewIpv6networkportcontrolblackoutsettingBlackoutScheduleWithDefaults instantiates a new Ipv6networkportcontrolblackoutsettingBlackoutSchedule object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewIpv6networkportcontrolblackoutsettingBlackoutScheduleWithDefaults() *Ipv6networkportcontrolblackoutsettingBlackoutSchedule {
	this := Ipv6networkportcontrolblackoutsettingBlackoutSchedule{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *Ipv6networkportcontrolblackoutsettingBlackoutSchedule) GetRecurringTimeOk() (*int64, bool) {
	if o == nil || IsNil(o.RecurringTime) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *Ipv6networkportcontrolblackoutsettingBlackoutSchedule) GetDisableOk() (*bool, bool) {
	if o == nil || IsNil(o.Disable) {
		return nil, false
	}
...
func (o Ipv6networkportcontrolblackoutsettingBlackoutSchedule) MarshalJSON() ([]byte, error) {
...
func (o *Ipv6networkportcontrolblackoutsettingBlackoutSchedule) UnmarshalJSON(data []byte) (err error) {
	varIpv6networkportcontrolblackoutsettingBlackoutSchedule := _Ipv6networkportcontrolblackoutsettingBlackoutSchedule{}

	err = json.Unmarshal(data, &varIpv6networkportcontrolblackoutsettingBlackoutSchedule)

	if err != nil {
		return err
	}

	*o = Ipv6networkportcontrolblackoutsettingBlackoutSchedule(varIpv6networkportcontrolblackoutsettingBlackoutSchedule)
...
type NullableIpv6networkportcontrolblackoutsettingBlackoutSchedule struct {
	value *Ipv6networkportcontrolblackoutsettingBlackoutSchedule
	isSet bool
}

func (v NullableIpv6networkportcontrolblackoutsettingBlackoutSchedule) Get() *Ipv6networkportcontrolblackoutsettingBlackoutSchedule {
	return v.value
}

func (v *NullableIpv6networkportcontrolblackoutsettingBlackoutSchedule) Set(val *Ipv6networkportcontrolblackoutsettingBlackoutSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableIpv6networkportcontrolblackoutsettingBlackoutSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableIpv6networkportcontrolblackoutsettingBlackoutSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpv6networkportcontrolblackoutsettingBlackoutSchedule(val *Ipv6networkportcontrolblackoutsettingBlackoutSchedule) *NullableIpv6networkportcontrolblackoutsettingBlackoutSchedule {
	return &NullableIpv6networkportcontrolblackoutsettingBlackoutSchedule{value: val, isSet: true}
}

func (v NullableIpv6networkportcontrolblackoutsettingBlackoutSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpv6networkportcontrolblackoutsettingBlackoutSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
