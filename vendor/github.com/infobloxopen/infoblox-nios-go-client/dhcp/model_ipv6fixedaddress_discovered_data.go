...
// checks if the Ipv6fixedaddressDiscoveredData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Ipv6fixedaddressDiscoveredData{}

// Ipv6fixedaddressDiscoveredData struct for Ipv6fixedaddressDiscoveredData
type Ipv6fixedaddressDiscoveredData struct {
...
type _Ipv6fixedaddressDiscoveredData Ipv6fixedaddressDiscoveredData
...
func NewIpv6fixedaddressDiscoveredData() *Ipv6fixedaddressDiscoveredData {
	this := Ipv6fixedaddressDiscoveredData{}
	return &this
}
...
func (o *Ipv6fixedaddressDiscoveredData) SetDeviceType(v string) {
	o.DeviceType = &v
}
...
func (o *Ipv6fixedaddressDiscoveredData) HasDiscoveredName() bool {
	if o != nil && !IsNil(o.DiscoveredName) {
		return true
	}
...
func (o *Ipv6fixedaddressDiscoveredData) SetLastDiscovered(v int64) {
	o.LastDiscovered = &v
}
...
func (o *Ipv6fixedaddressDiscoveredData) HasMgmtIpAddress() bool {
	if o != nil && !IsNil(o.MgmtIpAddress) {
		return true
	}
...
func (o *Ipv6fixedaddressDiscoveredData) GetNetworkComponentIp() string {
...
// and a boolean to check if the value has been set.
func (o *Ipv6fixedaddressDiscoveredData) GetNetworkComponentNameOk() (*string, bool) {
	if o == nil || IsNil(o.NetworkComponentName) {
		return nil, false
	}
...
func (o *Ipv6fixedaddressDiscoveredData) HasOpenPorts() bool {
	if o != nil && !IsNil(o.OpenPorts) {
		return true
	}
...
func (o *Ipv6fixedaddressDiscoveredData) SetPortVlanDescription(v string) {
...
func (o *Ipv6fixedaddressDiscoveredData) HasPortVlanNumber() bool {
	if o != nil && !IsNil(o.PortVlanNumber) {
		return true
	}
...
func (o *Ipv6fixedaddressDiscoveredData) HasVSwitch() bool {
	if o != nil && !IsNil(o.VSwitch) {
		return true
	}
...
func (o *Ipv6fixedaddressDiscoveredData) SetVswitchIpv6Enabled(v bool) {
...
func (o *Ipv6fixedaddressDiscoveredData) HasVportMacAddress() bool {
	if o != nil && !IsNil(o.VportMacAddress) {
		return true
	}
...
func (o *Ipv6fixedaddressDiscoveredData) GetVportConfMode() string {
...
// and a boolean to check if the value has been set.
func (o *Ipv6fixedaddressDiscoveredData) GetVportModeOk() (*string, bool) {
	if o == nil || IsNil(o.VportMode) {
		return nil, false
	}
...
func (o *Ipv6fixedaddressDiscoveredData) HasVswitchTepType() bool {
	if o != nil && !IsNil(o.VswitchTepType) {
		return true
	}
...
func (o *Ipv6fixedaddressDiscoveredData) GetVswitchTepVlan() string {
...
// and a boolean to check if the value has been set.
func (o *Ipv6fixedaddressDiscoveredData) GetVswitchTepMulticastOk() (*string, bool) {
	if o == nil || IsNil(o.VswitchTepMulticast) {
		return nil, false
	}
...
func (o *Ipv6fixedaddressDiscoveredData) SetCiscoIseSessionState(v string) {
...
func (o *Ipv6fixedaddressDiscoveredData) HasTaskName() bool {
	if o != nil && !IsNil(o.TaskName) {
		return true
	}
...
func (o *Ipv6fixedaddressDiscoveredData) GetVrfDescription() string {
...
// and a boolean to check if the value has been set.
func (o *Ipv6fixedaddressDiscoveredData) GetBgpAsOk() (*int64, bool) {
	if o == nil || IsNil(o.BgpAs) {
		return nil, false
	}
	return o.BgpAs, true
...
func (o Ipv6fixedaddressDiscoveredData) MarshalJSON() ([]byte, error) {
...
func (o *Ipv6fixedaddressDiscoveredData) UnmarshalJSON(data []byte) (err error) {
	varIpv6fixedaddressDiscoveredData := _Ipv6fixedaddressDiscoveredData{}

	err = json.Unmarshal(data, &varIpv6fixedaddressDiscoveredData)

	if err != nil {
		return err
	}

	*o = Ipv6fixedaddressDiscoveredData(varIpv6fixedaddressDiscoveredData)
...
type NullableIpv6fixedaddressDiscoveredData struct {
	value *Ipv6fixedaddressDiscoveredData
	isSet bool
}

func (v NullableIpv6fixedaddressDiscoveredData) Get() *Ipv6fixedaddressDiscoveredData {
	return v.value
}

func (v *NullableIpv6fixedaddressDiscoveredData) Set(val *Ipv6fixedaddressDiscoveredData) {
	v.value = val
	v.isSet = true
}

func (v NullableIpv6fixedaddressDiscoveredData) IsSet() bool {
	return v.isSet
}

func (v *NullableIpv6fixedaddressDiscoveredData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpv6fixedaddressDiscoveredData(val *Ipv6fixedaddressDiscoveredData) *NullableIpv6fixedaddressDiscoveredData {
	return &NullableIpv6fixedaddressDiscoveredData{value: val, isSet: true}
}

func (v NullableIpv6fixedaddressDiscoveredData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpv6fixedaddressDiscoveredData) UnmarshalJSON(src []byte) error {
	v.isSet = true
