...
// checks if the RecordAliasAwsRte53RecordInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordAliasAwsRte53RecordInfo{}

// RecordAliasAwsRte53RecordInfo struct for RecordAliasAwsRte53RecordInfo
type RecordAliasAwsRte53RecordInfo struct {
...
type _RecordAliasAwsRte53RecordInfo RecordAliasAwsRte53RecordInfo
...
func NewRecordAliasAwsRte53RecordInfo() *RecordAliasAwsRte53RecordInfo {
	this := RecordAliasAwsRte53RecordInfo{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *RecordAliasAwsRte53RecordInfo) GetGeolocationContinentCodeOk() (*string, bool) {
	if o == nil || IsNil(o.GeolocationContinentCode) {
		return nil, false
	}
...
func (o RecordAliasAwsRte53RecordInfo) MarshalJSON() ([]byte, error) {
...
func (o *RecordAliasAwsRte53RecordInfo) UnmarshalJSON(data []byte) (err error) {
	varRecordAliasAwsRte53RecordInfo := _RecordAliasAwsRte53RecordInfo{}

	err = json.Unmarshal(data, &varRecordAliasAwsRte53RecordInfo)

	if err != nil {
		return err
	}

	*o = RecordAliasAwsRte53RecordInfo(varRecordAliasAwsRte53RecordInfo)
...
type NullableRecordAliasAwsRte53RecordInfo struct {
	value *RecordAliasAwsRte53RecordInfo
	isSet bool
}

func (v NullableRecordAliasAwsRte53RecordInfo) Get() *RecordAliasAwsRte53RecordInfo {
	return v.value
}

func (v *NullableRecordAliasAwsRte53RecordInfo) Set(val *RecordAliasAwsRte53RecordInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordAliasAwsRte53RecordInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordAliasAwsRte53RecordInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordAliasAwsRte53RecordInfo(val *RecordAliasAwsRte53RecordInfo) *NullableRecordAliasAwsRte53RecordInfo {
	return &NullableRecordAliasAwsRte53RecordInfo{value: val, isSet: true}
}

func (v NullableRecordAliasAwsRte53RecordInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordAliasAwsRte53RecordInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
