...
// checks if the MemberDhcppropertiesOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MemberDhcppropertiesOptions{}

// MemberDhcppropertiesOptions struct for MemberDhcppropertiesOptions
type MemberDhcppropertiesOptions struct {
...
type _MemberDhcppropertiesOptions MemberDhcppropertiesOptions
...
func NewMemberDhcppropertiesOptions() *MemberDhcppropertiesOptions {
	this := MemberDhcppropertiesOptions{}
	return &this
}
...
func (o MemberDhcppropertiesOptions) MarshalJSON() ([]byte, error) {
...
func (o MemberDhcppropertiesOptions) ToMap() (map[string]interface{}, error) {
...
func (o *MemberDhcppropertiesOptions) UnmarshalJSON(data []byte) (err error) {
	varMemberDhcppropertiesOptions := _MemberDhcppropertiesOptions{}

	err = json.Unmarshal(data, &varMemberDhcppropertiesOptions)

	if err != nil {
		return err
	}

	*o = MemberDhcppropertiesOptions(varMemberDhcppropertiesOptions)
...
type NullableMemberDhcppropertiesOptions struct {
	value *MemberDhcppropertiesOptions
	isSet bool
}

func (v NullableMemberDhcppropertiesOptions) Get() *MemberDhcppropertiesOptions {
	return v.value
}

func (v *NullableMemberDhcppropertiesOptions) Set(val *MemberDhcppropertiesOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableMemberDhcppropertiesOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableMemberDhcppropertiesOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMemberDhcppropertiesOptions(val *MemberDhcppropertiesOptions) *NullableMemberDhcppropertiesOptions {
	return &NullableMemberDhcppropertiesOptions{value: val, isSet: true}
}

func (v NullableMemberDhcppropertiesOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMemberDhcppropertiesOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
