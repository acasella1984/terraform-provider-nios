...
// checks if the MembernodeinfoMgmtNetworkSetting type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MembernodeinfoMgmtNetworkSetting{}

// MembernodeinfoMgmtNetworkSetting struct for MembernodeinfoMgmtNetworkSetting
type MembernodeinfoMgmtNetworkSetting struct {
...
type _MembernodeinfoMgmtNetworkSetting MembernodeinfoMgmtNetworkSetting
...
func NewMembernodeinfoMgmtNetworkSetting() *MembernodeinfoMgmtNetworkSetting {
	this := MembernodeinfoMgmtNetworkSetting{}
	return &this
}
...
func (o *MembernodeinfoMgmtNetworkSetting) HasSubnetMask() bool {
	if o != nil && !IsNil(o.SubnetMask) {
		return true
	}
...
func (o MembernodeinfoMgmtNetworkSetting) MarshalJSON() ([]byte, error) {
...
func (o MembernodeinfoMgmtNetworkSetting) ToMap() (map[string]interface{}, error) {
...
func (o *MembernodeinfoMgmtNetworkSetting) UnmarshalJSON(data []byte) (err error) {
	varMembernodeinfoMgmtNetworkSetting := _MembernodeinfoMgmtNetworkSetting{}

	err = json.Unmarshal(data, &varMembernodeinfoMgmtNetworkSetting)

	if err != nil {
		return err
	}

	*o = MembernodeinfoMgmtNetworkSetting(varMembernodeinfoMgmtNetworkSetting)
...
type NullableMembernodeinfoMgmtNetworkSetting struct {
	value *MembernodeinfoMgmtNetworkSetting
	isSet bool
}

func (v NullableMembernodeinfoMgmtNetworkSetting) Get() *MembernodeinfoMgmtNetworkSetting {
	return v.value
}

func (v *NullableMembernodeinfoMgmtNetworkSetting) Set(val *MembernodeinfoMgmtNetworkSetting) {
	v.value = val
	v.isSet = true
}

func (v NullableMembernodeinfoMgmtNetworkSetting) IsSet() bool {
	return v.isSet
}

func (v *NullableMembernodeinfoMgmtNetworkSetting) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMembernodeinfoMgmtNetworkSetting(val *MembernodeinfoMgmtNetworkSetting) *NullableMembernodeinfoMgmtNetworkSetting {
	return &NullableMembernodeinfoMgmtNetworkSetting{value: val, isSet: true}
}

func (v NullableMembernodeinfoMgmtNetworkSetting) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMembernodeinfoMgmtNetworkSetting) UnmarshalJSON(src []byte) error {
	v.isSet = true
