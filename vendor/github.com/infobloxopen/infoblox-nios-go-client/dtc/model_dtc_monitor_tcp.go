...
// checks if the DtcMonitorTcp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DtcMonitorTcp{}

// DtcMonitorTcp struct for DtcMonitorTcp
...
func (o DtcMonitorTcp) MarshalJSON() ([]byte, error) {
...
type NullableDtcMonitorTcp struct {
	value *DtcMonitorTcp
	isSet bool
}

func (v NullableDtcMonitorTcp) Get() *DtcMonitorTcp {
	return v.value
}

func (v *NullableDtcMonitorTcp) Set(val *DtcMonitorTcp) {
	v.value = val
	v.isSet = true
}

func (v NullableDtcMonitorTcp) IsSet() bool {
	return v.isSet
}

func (v *NullableDtcMonitorTcp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDtcMonitorTcp(val *DtcMonitorTcp) *NullableDtcMonitorTcp {
	return &NullableDtcMonitorTcp{value: val, isSet: true}
}

func (v NullableDtcMonitorTcp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDtcMonitorTcp) UnmarshalJSON(src []byte) error {
	v.isSet = true
