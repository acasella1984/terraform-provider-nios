...
// checks if the GridCloudapiTenantCloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridCloudapiTenantCloudInfo{}

// GridCloudapiTenantCloudInfo struct for GridCloudapiTenantCloudInfo
type GridCloudapiTenantCloudInfo struct {
	DelegatedMember *GridcloudapitenantcloudinfoDelegatedMember `json:"delegated_member,omitempty"`
...
type _GridCloudapiTenantCloudInfo GridCloudapiTenantCloudInfo
...
func NewGridCloudapiTenantCloudInfo() *GridCloudapiTenantCloudInfo {
	this := GridCloudapiTenantCloudInfo{}
	return &this
}
...
func (o *GridCloudapiTenantCloudInfo) GetDelegatedMember() GridcloudapitenantcloudinfoDelegatedMember {
	if o == nil || IsNil(o.DelegatedMember) {
		var ret GridcloudapitenantcloudinfoDelegatedMember
		return ret
	}
...
// SetDelegatedMember gets a reference to the given GridcloudapitenantcloudinfoDelegatedMember and assigns it to the DelegatedMember field.
...
// and a boolean to check if the value has been set.
func (o *GridCloudapiTenantCloudInfo) GetDelegatedRootOk() (*string, bool) {
	if o == nil || IsNil(o.DelegatedRoot) {
		return nil, false
	}
...
func (o *GridCloudapiTenantCloudInfo) HasMgmtPlatform() bool {
	if o != nil && !IsNil(o.MgmtPlatform) {
		return true
	}
...
func (o GridCloudapiTenantCloudInfo) MarshalJSON() ([]byte, error) {
...
func (o GridCloudapiTenantCloudInfo) ToMap() (map[string]interface{}, error) {
...
func (o *GridCloudapiTenantCloudInfo) UnmarshalJSON(data []byte) (err error) {
	varGridCloudapiTenantCloudInfo := _GridCloudapiTenantCloudInfo{}

	err = json.Unmarshal(data, &varGridCloudapiTenantCloudInfo)

	if err != nil {
		return err
	}

	*o = GridCloudapiTenantCloudInfo(varGridCloudapiTenantCloudInfo)
...
type NullableGridCloudapiTenantCloudInfo struct {
	value *GridCloudapiTenantCloudInfo
	isSet bool
}

func (v NullableGridCloudapiTenantCloudInfo) Get() *GridCloudapiTenantCloudInfo {
	return v.value
}

func (v *NullableGridCloudapiTenantCloudInfo) Set(val *GridCloudapiTenantCloudInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableGridCloudapiTenantCloudInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableGridCloudapiTenantCloudInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridCloudapiTenantCloudInfo(val *GridCloudapiTenantCloudInfo) *NullableGridCloudapiTenantCloudInfo {
	return &NullableGridCloudapiTenantCloudInfo{value: val, isSet: true}
}

func (v NullableGridCloudapiTenantCloudInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridCloudapiTenantCloudInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
