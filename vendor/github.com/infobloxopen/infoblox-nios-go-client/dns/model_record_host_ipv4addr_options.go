...
// checks if the RecordHostIpv4addrOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordHostIpv4addrOptions{}

// RecordHostIpv4addrOptions struct for RecordHostIpv4addrOptions
type RecordHostIpv4addrOptions struct {
...
type _RecordHostIpv4addrOptions RecordHostIpv4addrOptions
...
func NewRecordHostIpv4addrOptions() *RecordHostIpv4addrOptions {
	this := RecordHostIpv4addrOptions{}
	return &this
}
...
func (o RecordHostIpv4addrOptions) MarshalJSON() ([]byte, error) {
...
func (o RecordHostIpv4addrOptions) ToMap() (map[string]interface{}, error) {
...
func (o *RecordHostIpv4addrOptions) UnmarshalJSON(data []byte) (err error) {
	varRecordHostIpv4addrOptions := _RecordHostIpv4addrOptions{}

	err = json.Unmarshal(data, &varRecordHostIpv4addrOptions)

	if err != nil {
		return err
	}

	*o = RecordHostIpv4addrOptions(varRecordHostIpv4addrOptions)
...
type NullableRecordHostIpv4addrOptions struct {
	value *RecordHostIpv4addrOptions
	isSet bool
}

func (v NullableRecordHostIpv4addrOptions) Get() *RecordHostIpv4addrOptions {
	return v.value
}

func (v *NullableRecordHostIpv4addrOptions) Set(val *RecordHostIpv4addrOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordHostIpv4addrOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordHostIpv4addrOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordHostIpv4addrOptions(val *RecordHostIpv4addrOptions) *NullableRecordHostIpv4addrOptions {
	return &NullableRecordHostIpv4addrOptions{value: val, isSet: true}
}

func (v NullableRecordHostIpv4addrOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordHostIpv4addrOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
