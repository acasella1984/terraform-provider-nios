...
// checks if the RangeOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RangeOptions{}

// RangeOptions struct for RangeOptions
...
type _RangeOptions RangeOptions
...
func (o RangeOptions) MarshalJSON() ([]byte, error) {
...
func (o RangeOptions) ToMap() (map[string]interface{}, error) {
...
func (o *RangeOptions) UnmarshalJSON(data []byte) (err error) {
	varRangeOptions := _RangeOptions{}

	err = json.Unmarshal(data, &varRangeOptions)

	if err != nil {
		return err
	}

	*o = RangeOptions(varRangeOptions)
...
type NullableRangeOptions struct {
	value *RangeOptions
	isSet bool
}

func (v NullableRangeOptions) Get() *RangeOptions {
	return v.value
}

func (v *NullableRangeOptions) Set(val *RangeOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableRangeOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableRangeOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRangeOptions(val *RangeOptions) *NullableRangeOptions {
	return &NullableRangeOptions{value: val, isSet: true}
}

func (v NullableRangeOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRangeOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
