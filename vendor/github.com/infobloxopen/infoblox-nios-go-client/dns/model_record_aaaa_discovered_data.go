...
// checks if the RecordAaaaDiscoveredData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordAaaaDiscoveredData{}

// RecordAaaaDiscoveredData struct for RecordAaaaDiscoveredData
type RecordAaaaDiscoveredData struct {
...
type _RecordAaaaDiscoveredData RecordAaaaDiscoveredData
...
// and a boolean to check if the value has been set.
func (o *RecordAaaaDiscoveredData) GetFirstDiscoveredOk() (*int64, bool) {
	if o == nil || IsNil(o.FirstDiscovered) {
		return nil, false
	}
...
func (o *RecordAaaaDiscoveredData) SetIprgState(v string) {
	o.IprgState = &v
}
...
func (o *RecordAaaaDiscoveredData) HasLastDiscovered() bool {
	if o != nil && !IsNil(o.LastDiscovered) {
		return true
	}
...
func (o *RecordAaaaDiscoveredData) GetNetbiosName() string {
...
// and a boolean to check if the value has been set.
func (o *RecordAaaaDiscoveredData) GetNetworkComponentIpOk() (*string, bool) {
	if o == nil || IsNil(o.NetworkComponentIp) {
		return nil, false
	}
...
func (o *RecordAaaaDiscoveredData) SetNetworkComponentPortName(v string) {
...
// and a boolean to check if the value has been set.
func (o *RecordAaaaDiscoveredData) GetVDatacenterOk() (*string, bool) {
	if o == nil || IsNil(o.VDatacenter) {
		return nil, false
	}
...
func (o *RecordAaaaDiscoveredData) SetVEntityType(v string) {
	o.VEntityType = &v
}
...
func (o *RecordAaaaDiscoveredData) SetVswitchSegmentName(v string) {
...
// and a boolean to check if the value has been set.
func (o *RecordAaaaDiscoveredData) GetVswitchTepMulticastOk() (*string, bool) {
	if o == nil || IsNil(o.VswitchTepMulticast) {
		return nil, false
	}
...
func (o *RecordAaaaDiscoveredData) SetCiscoIseSessionState(v string) {
...
func (o *RecordAaaaDiscoveredData) HasTaskName() bool {
	if o != nil && !IsNil(o.TaskName) {
		return true
	}
...
func (o *RecordAaaaDiscoveredData) GetVrfDescription() string {
...
// and a boolean to check if the value has been set.
func (o *RecordAaaaDiscoveredData) GetBgpAsOk() (*int64, bool) {
	if o == nil || IsNil(o.BgpAs) {
		return nil, false
	}
	return o.BgpAs, true
...
func (o RecordAaaaDiscoveredData) MarshalJSON() ([]byte, error) {
...
func (o RecordAaaaDiscoveredData) ToMap() (map[string]interface{}, error) {
...
func (o *RecordAaaaDiscoveredData) UnmarshalJSON(data []byte) (err error) {
	varRecordAaaaDiscoveredData := _RecordAaaaDiscoveredData{}

	err = json.Unmarshal(data, &varRecordAaaaDiscoveredData)

	if err != nil {
		return err
	}

	*o = RecordAaaaDiscoveredData(varRecordAaaaDiscoveredData)
...
type NullableRecordAaaaDiscoveredData struct {
	value *RecordAaaaDiscoveredData
	isSet bool
}

func (v NullableRecordAaaaDiscoveredData) Get() *RecordAaaaDiscoveredData {
	return v.value
}

func (v *NullableRecordAaaaDiscoveredData) Set(val *RecordAaaaDiscoveredData) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordAaaaDiscoveredData) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordAaaaDiscoveredData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordAaaaDiscoveredData(val *RecordAaaaDiscoveredData) *NullableRecordAaaaDiscoveredData {
	return &NullableRecordAaaaDiscoveredData{value: val, isSet: true}
}

func (v NullableRecordAaaaDiscoveredData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordAaaaDiscoveredData) UnmarshalJSON(src []byte) error {
	v.isSet = true
