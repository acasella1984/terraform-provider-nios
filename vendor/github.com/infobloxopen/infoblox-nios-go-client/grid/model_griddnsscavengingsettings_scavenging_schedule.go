...
// checks if the GriddnsscavengingsettingsScavengingSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GriddnsscavengingsettingsScavengingSchedule{}

// GriddnsscavengingsettingsScavengingSchedule struct for GriddnsscavengingsettingsScavengingSchedule
type GriddnsscavengingsettingsScavengingSchedule struct {
...
type _GriddnsscavengingsettingsScavengingSchedule GriddnsscavengingsettingsScavengingSchedule
...
func NewGriddnsscavengingsettingsScavengingSchedule() *GriddnsscavengingsettingsScavengingSchedule {
	this := GriddnsscavengingsettingsScavengingSchedule{}
	return &this
}
...
func (o GriddnsscavengingsettingsScavengingSchedule) MarshalJSON() ([]byte, error) {
...
func (o GriddnsscavengingsettingsScavengingSchedule) ToMap() (map[string]interface{}, error) {
...
func (o *GriddnsscavengingsettingsScavengingSchedule) UnmarshalJSON(data []byte) (err error) {
	varGriddnsscavengingsettingsScavengingSchedule := _GriddnsscavengingsettingsScavengingSchedule{}

	err = json.Unmarshal(data, &varGriddnsscavengingsettingsScavengingSchedule)

	if err != nil {
		return err
	}

	*o = GriddnsscavengingsettingsScavengingSchedule(varGriddnsscavengingsettingsScavengingSchedule)
...
type NullableGriddnsscavengingsettingsScavengingSchedule struct {
	value *GriddnsscavengingsettingsScavengingSchedule
	isSet bool
}

func (v NullableGriddnsscavengingsettingsScavengingSchedule) Get() *GriddnsscavengingsettingsScavengingSchedule {
	return v.value
}

func (v *NullableGriddnsscavengingsettingsScavengingSchedule) Set(val *GriddnsscavengingsettingsScavengingSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableGriddnsscavengingsettingsScavengingSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableGriddnsscavengingsettingsScavengingSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGriddnsscavengingsettingsScavengingSchedule(val *GriddnsscavengingsettingsScavengingSchedule) *NullableGriddnsscavengingsettingsScavengingSchedule {
	return &NullableGriddnsscavengingsettingsScavengingSchedule{value: val, isSet: true}
}

func (v NullableGriddnsscavengingsettingsScavengingSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGriddnsscavengingsettingsScavengingSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
