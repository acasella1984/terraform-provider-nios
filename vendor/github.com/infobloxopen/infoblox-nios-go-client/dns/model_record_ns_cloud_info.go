...
// checks if the RecordNsCloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordNsCloudInfo{}

// RecordNsCloudInfo struct for RecordNsCloudInfo
type RecordNsCloudInfo struct {
	DelegatedMember *RecordnscloudinfoDelegatedMember `json:"delegated_member,omitempty"`
...
type _RecordNsCloudInfo RecordNsCloudInfo
...
func (o *RecordNsCloudInfo) GetDelegatedMember() RecordnscloudinfoDelegatedMember {
	if o == nil || IsNil(o.DelegatedMember) {
		var ret RecordnscloudinfoDelegatedMember
		return ret
	}
...
// SetDelegatedMember gets a reference to the given RecordnscloudinfoDelegatedMember and assigns it to the DelegatedMember field.
...
func (o RecordNsCloudInfo) MarshalJSON() ([]byte, error) {
...
func (o RecordNsCloudInfo) ToMap() (map[string]interface{}, error) {
...
func (o *RecordNsCloudInfo) UnmarshalJSON(data []byte) (err error) {
	varRecordNsCloudInfo := _RecordNsCloudInfo{}

	err = json.Unmarshal(data, &varRecordNsCloudInfo)

	if err != nil {
		return err
	}

	*o = RecordNsCloudInfo(varRecordNsCloudInfo)
...
type NullableRecordNsCloudInfo struct {
	value *RecordNsCloudInfo
	isSet bool
}

func (v NullableRecordNsCloudInfo) Get() *RecordNsCloudInfo {
	return v.value
}

func (v *NullableRecordNsCloudInfo) Set(val *RecordNsCloudInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordNsCloudInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordNsCloudInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordNsCloudInfo(val *RecordNsCloudInfo) *NullableRecordNsCloudInfo {
	return &NullableRecordNsCloudInfo{value: val, isSet: true}
}

func (v NullableRecordNsCloudInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordNsCloudInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
