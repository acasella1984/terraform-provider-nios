...
// checks if the RecordDnameCloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordDnameCloudInfo{}

// RecordDnameCloudInfo struct for RecordDnameCloudInfo
type RecordDnameCloudInfo struct {
	DelegatedMember *RecorddnamecloudinfoDelegatedMember `json:"delegated_member,omitempty"`
...
type _RecordDnameCloudInfo RecordDnameCloudInfo
...
func (o *RecordDnameCloudInfo) GetDelegatedMember() RecorddnamecloudinfoDelegatedMember {
	if o == nil || IsNil(o.DelegatedMember) {
		var ret RecorddnamecloudinfoDelegatedMember
		return ret
	}
...
func (o *RecordDnameCloudInfo) GetDelegatedMemberOk() (*RecorddnamecloudinfoDelegatedMember, bool) {
	if o == nil || IsNil(o.DelegatedMember) {
		return nil, false
	}
...
// SetDelegatedMember gets a reference to the given RecorddnamecloudinfoDelegatedMember and assigns it to the DelegatedMember field.
...
func (o *RecordDnameCloudInfo) GetAuthorityType() string {
...
func (o RecordDnameCloudInfo) MarshalJSON() ([]byte, error) {
...
func (o RecordDnameCloudInfo) ToMap() (map[string]interface{}, error) {
...
func (o *RecordDnameCloudInfo) UnmarshalJSON(data []byte) (err error) {
	varRecordDnameCloudInfo := _RecordDnameCloudInfo{}

	err = json.Unmarshal(data, &varRecordDnameCloudInfo)

	if err != nil {
		return err
	}

	*o = RecordDnameCloudInfo(varRecordDnameCloudInfo)
...
type NullableRecordDnameCloudInfo struct {
	value *RecordDnameCloudInfo
	isSet bool
}

func (v NullableRecordDnameCloudInfo) Get() *RecordDnameCloudInfo {
	return v.value
}

func (v *NullableRecordDnameCloudInfo) Set(val *RecordDnameCloudInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordDnameCloudInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordDnameCloudInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordDnameCloudInfo(val *RecordDnameCloudInfo) *NullableRecordDnameCloudInfo {
	return &NullableRecordDnameCloudInfo{value: val, isSet: true}
}

func (v NullableRecordDnameCloudInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordDnameCloudInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
