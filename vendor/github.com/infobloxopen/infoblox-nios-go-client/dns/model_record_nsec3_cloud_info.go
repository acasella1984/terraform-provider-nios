...
// checks if the RecordNsec3CloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordNsec3CloudInfo{}

// RecordNsec3CloudInfo struct for RecordNsec3CloudInfo
type RecordNsec3CloudInfo struct {
	DelegatedMember *Recordnsec3cloudinfoDelegatedMember `json:"delegated_member,omitempty"`
...
type _RecordNsec3CloudInfo RecordNsec3CloudInfo
...
func (o *RecordNsec3CloudInfo) GetDelegatedMember() Recordnsec3cloudinfoDelegatedMember {
	if o == nil || IsNil(o.DelegatedMember) {
		var ret Recordnsec3cloudinfoDelegatedMember
		return ret
	}
...
// SetDelegatedMember gets a reference to the given Recordnsec3cloudinfoDelegatedMember and assigns it to the DelegatedMember field.
...
func (o RecordNsec3CloudInfo) MarshalJSON() ([]byte, error) {
...
func (o RecordNsec3CloudInfo) ToMap() (map[string]interface{}, error) {
...
func (o *RecordNsec3CloudInfo) UnmarshalJSON(data []byte) (err error) {
	varRecordNsec3CloudInfo := _RecordNsec3CloudInfo{}

	err = json.Unmarshal(data, &varRecordNsec3CloudInfo)

	if err != nil {
		return err
	}

	*o = RecordNsec3CloudInfo(varRecordNsec3CloudInfo)
...
type NullableRecordNsec3CloudInfo struct {
	value *RecordNsec3CloudInfo
	isSet bool
}

func (v NullableRecordNsec3CloudInfo) Get() *RecordNsec3CloudInfo {
	return v.value
}

func (v *NullableRecordNsec3CloudInfo) Set(val *RecordNsec3CloudInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordNsec3CloudInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordNsec3CloudInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordNsec3CloudInfo(val *RecordNsec3CloudInfo) *NullableRecordNsec3CloudInfo {
	return &NullableRecordNsec3CloudInfo{value: val, isSet: true}
}

func (v NullableRecordNsec3CloudInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordNsec3CloudInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
