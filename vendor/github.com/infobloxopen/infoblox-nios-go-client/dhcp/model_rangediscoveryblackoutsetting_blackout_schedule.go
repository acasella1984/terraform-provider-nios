...
// checks if the RangediscoveryblackoutsettingBlackoutSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RangediscoveryblackoutsettingBlackoutSchedule{}

// RangediscoveryblackoutsettingBlackoutSchedule struct for RangediscoveryblackoutsettingBlackoutSchedule
type RangediscoveryblackoutsettingBlackoutSchedule struct {
...
type _RangediscoveryblackoutsettingBlackoutSchedule RangediscoveryblackoutsettingBlackoutSchedule

// NewRangediscoveryblackoutsettingBlackoutSchedule instantiates a new RangediscoveryblackoutsettingBlackoutSchedule object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRangediscoveryblackoutsettingBlackoutSchedule() *RangediscoveryblackoutsettingBlackoutSchedule {
	this := RangediscoveryblackoutsettingBlackoutSchedule{}
	return &this
}

// NewRangediscoveryblackoutsettingBlackoutScheduleWithDefaults instantiates a new RangediscoveryblackoutsettingBlackoutSchedule object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewRangediscoveryblackoutsettingBlackoutScheduleWithDefaults() *RangediscoveryblackoutsettingBlackoutSchedule {
	this := RangediscoveryblackoutsettingBlackoutSchedule{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *RangediscoveryblackoutsettingBlackoutSchedule) GetRecurringTimeOk() (*int64, bool) {
	if o == nil || IsNil(o.RecurringTime) {
		return nil, false
	}
...
func (o *RangediscoveryblackoutsettingBlackoutSchedule) SetEvery(v int64) {
	o.Every = &v
}
...
func (o *RangediscoveryblackoutsettingBlackoutSchedule) HasHourOfDay() bool {
	if o != nil && !IsNil(o.HourOfDay) {
		return true
	}
...
func (o RangediscoveryblackoutsettingBlackoutSchedule) MarshalJSON() ([]byte, error) {
...
func (o RangediscoveryblackoutsettingBlackoutSchedule) ToMap() (map[string]interface{}, error) {
...
func (o *RangediscoveryblackoutsettingBlackoutSchedule) UnmarshalJSON(data []byte) (err error) {
	varRangediscoveryblackoutsettingBlackoutSchedule := _RangediscoveryblackoutsettingBlackoutSchedule{}

	err = json.Unmarshal(data, &varRangediscoveryblackoutsettingBlackoutSchedule)

	if err != nil {
		return err
	}

	*o = RangediscoveryblackoutsettingBlackoutSchedule(varRangediscoveryblackoutsettingBlackoutSchedule)
...
type NullableRangediscoveryblackoutsettingBlackoutSchedule struct {
	value *RangediscoveryblackoutsettingBlackoutSchedule
	isSet bool
}

func (v NullableRangediscoveryblackoutsettingBlackoutSchedule) Get() *RangediscoveryblackoutsettingBlackoutSchedule {
	return v.value
}

func (v *NullableRangediscoveryblackoutsettingBlackoutSchedule) Set(val *RangediscoveryblackoutsettingBlackoutSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableRangediscoveryblackoutsettingBlackoutSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableRangediscoveryblackoutsettingBlackoutSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRangediscoveryblackoutsettingBlackoutSchedule(val *RangediscoveryblackoutsettingBlackoutSchedule) *NullableRangediscoveryblackoutsettingBlackoutSchedule {
	return &NullableRangediscoveryblackoutsettingBlackoutSchedule{value: val, isSet: true}
}

func (v NullableRangediscoveryblackoutsettingBlackoutSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRangediscoveryblackoutsettingBlackoutSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
