...
// checks if the DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule{}

// DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule struct for DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule
type DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule struct {
...
type _DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule

// NewDiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule instantiates a new DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule() *DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule {
	this := DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule{}
	return &this
}

// NewDiscoverygridpropertiesportcontrolblackoutsettingBlackoutScheduleWithDefaults instantiates a new DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDiscoverygridpropertiesportcontrolblackoutsettingBlackoutScheduleWithDefaults() *DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule {
	this := DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule{}
	return &this
}
...
func (o *DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule) GetMonth() int64 {
...
func (o DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule) MarshalJSON() ([]byte, error) {
...
func (o *DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule) UnmarshalJSON(data []byte) (err error) {
	varDiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule := _DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule{}

	err = json.Unmarshal(data, &varDiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule)

	if err != nil {
		return err
	}

	*o = DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule(varDiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule)
...
type NullableDiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule struct {
	value *DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule
	isSet bool
}

func (v NullableDiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule) Get() *DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule {
	return v.value
}

func (v *NullableDiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule) Set(val *DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableDiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableDiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule(val *DiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule) *NullableDiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule {
	return &NullableDiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule{value: val, isSet: true}
}

func (v NullableDiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiscoverygridpropertiesportcontrolblackoutsettingBlackoutSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
