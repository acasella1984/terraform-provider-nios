...
// checks if the RecordMxAwsRte53RecordInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordMxAwsRte53RecordInfo{}

// RecordMxAwsRte53RecordInfo struct for RecordMxAwsRte53RecordInfo
type RecordMxAwsRte53RecordInfo struct {
...
type _RecordMxAwsRte53RecordInfo RecordMxAwsRte53RecordInfo
...
func NewRecordMxAwsRte53RecordInfo() *RecordMxAwsRte53RecordInfo {
	this := RecordMxAwsRte53RecordInfo{}
	return &this
}
...
func (o RecordMxAwsRte53RecordInfo) MarshalJSON() ([]byte, error) {
...
func (o RecordMxAwsRte53RecordInfo) ToMap() (map[string]interface{}, error) {
...
func (o *RecordMxAwsRte53RecordInfo) UnmarshalJSON(data []byte) (err error) {
	varRecordMxAwsRte53RecordInfo := _RecordMxAwsRte53RecordInfo{}

	err = json.Unmarshal(data, &varRecordMxAwsRte53RecordInfo)

	if err != nil {
		return err
	}

	*o = RecordMxAwsRte53RecordInfo(varRecordMxAwsRte53RecordInfo)
...
type NullableRecordMxAwsRte53RecordInfo struct {
	value *RecordMxAwsRte53RecordInfo
	isSet bool
}

func (v NullableRecordMxAwsRte53RecordInfo) Get() *RecordMxAwsRte53RecordInfo {
	return v.value
}

func (v *NullableRecordMxAwsRte53RecordInfo) Set(val *RecordMxAwsRte53RecordInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordMxAwsRte53RecordInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordMxAwsRte53RecordInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordMxAwsRte53RecordInfo(val *RecordMxAwsRte53RecordInfo) *NullableRecordMxAwsRte53RecordInfo {
	return &NullableRecordMxAwsRte53RecordInfo{value: val, isSet: true}
}

func (v NullableRecordMxAwsRte53RecordInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordMxAwsRte53RecordInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
