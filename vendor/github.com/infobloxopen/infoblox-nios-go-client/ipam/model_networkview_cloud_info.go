...
// checks if the NetworkviewCloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkviewCloudInfo{}

// NetworkviewCloudInfo struct for NetworkviewCloudInfo
type NetworkviewCloudInfo struct {
	DelegatedMember *NetworkviewcloudinfoDelegatedMember `json:"delegated_member,omitempty"`
...
type _NetworkviewCloudInfo NetworkviewCloudInfo
...
func (o *NetworkviewCloudInfo) GetDelegatedMember() NetworkviewcloudinfoDelegatedMember {
	if o == nil || IsNil(o.DelegatedMember) {
		var ret NetworkviewcloudinfoDelegatedMember
		return ret
	}
...
func (o *NetworkviewCloudInfo) GetDelegatedMemberOk() (*NetworkviewcloudinfoDelegatedMember, bool) {
	if o == nil || IsNil(o.DelegatedMember) {
		return nil, false
	}
...
// SetDelegatedMember gets a reference to the given NetworkviewcloudinfoDelegatedMember and assigns it to the DelegatedMember field.
...
func (o *NetworkviewCloudInfo) GetAuthorityType() string {
...
func (o NetworkviewCloudInfo) MarshalJSON() ([]byte, error) {
...
func (o NetworkviewCloudInfo) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkviewCloudInfo) UnmarshalJSON(data []byte) (err error) {
	varNetworkviewCloudInfo := _NetworkviewCloudInfo{}

	err = json.Unmarshal(data, &varNetworkviewCloudInfo)

	if err != nil {
		return err
	}

	*o = NetworkviewCloudInfo(varNetworkviewCloudInfo)
...
type NullableNetworkviewCloudInfo struct {
	value *NetworkviewCloudInfo
	isSet bool
}

func (v NullableNetworkviewCloudInfo) Get() *NetworkviewCloudInfo {
	return v.value
}

func (v *NullableNetworkviewCloudInfo) Set(val *NetworkviewCloudInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkviewCloudInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkviewCloudInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkviewCloudInfo(val *NetworkviewCloudInfo) *NullableNetworkviewCloudInfo {
	return &NullableNetworkviewCloudInfo{value: val, isSet: true}
}

func (v NullableNetworkviewCloudInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkviewCloudInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
