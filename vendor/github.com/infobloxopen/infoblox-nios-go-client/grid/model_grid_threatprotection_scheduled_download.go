...
// checks if the GridThreatprotectionScheduledDownload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridThreatprotectionScheduledDownload{}

// GridThreatprotectionScheduledDownload struct for GridThreatprotectionScheduledDownload
type GridThreatprotectionScheduledDownload struct {
...
type _GridThreatprotectionScheduledDownload GridThreatprotectionScheduledDownload

// NewGridThreatprotectionScheduledDownload instantiates a new GridThreatprotectionScheduledDownload object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGridThreatprotectionScheduledDownload() *GridThreatprotectionScheduledDownload {
	this := GridThreatprotectionScheduledDownload{}
	return &this
}

// NewGridThreatprotectionScheduledDownloadWithDefaults instantiates a new GridThreatprotectionScheduledDownload object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGridThreatprotectionScheduledDownloadWithDefaults() *GridThreatprotectionScheduledDownload {
	this := GridThreatprotectionScheduledDownload{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *GridThreatprotectionScheduledDownload) GetRecurringTimeOk() (*int64, bool) {
	if o == nil || IsNil(o.RecurringTime) {
		return nil, false
	}
...
func (o *GridThreatprotectionScheduledDownload) SetEvery(v int64) {
	o.Every = &v
}
...
func (o *GridThreatprotectionScheduledDownload) HasHourOfDay() bool {
	if o != nil && !IsNil(o.HourOfDay) {
		return true
	}
...
func (o GridThreatprotectionScheduledDownload) MarshalJSON() ([]byte, error) {
...
func (o GridThreatprotectionScheduledDownload) ToMap() (map[string]interface{}, error) {
...
func (o *GridThreatprotectionScheduledDownload) UnmarshalJSON(data []byte) (err error) {
	varGridThreatprotectionScheduledDownload := _GridThreatprotectionScheduledDownload{}

	err = json.Unmarshal(data, &varGridThreatprotectionScheduledDownload)

	if err != nil {
		return err
	}

	*o = GridThreatprotectionScheduledDownload(varGridThreatprotectionScheduledDownload)
...
type NullableGridThreatprotectionScheduledDownload struct {
	value *GridThreatprotectionScheduledDownload
	isSet bool
}

func (v NullableGridThreatprotectionScheduledDownload) Get() *GridThreatprotectionScheduledDownload {
	return v.value
}

func (v *NullableGridThreatprotectionScheduledDownload) Set(val *GridThreatprotectionScheduledDownload) {
	v.value = val
	v.isSet = true
}

func (v NullableGridThreatprotectionScheduledDownload) IsSet() bool {
	return v.isSet
}

func (v *NullableGridThreatprotectionScheduledDownload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridThreatprotectionScheduledDownload(val *GridThreatprotectionScheduledDownload) *NullableGridThreatprotectionScheduledDownload {
	return &NullableGridThreatprotectionScheduledDownload{value: val, isSet: true}
}

func (v NullableGridThreatprotectionScheduledDownload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridThreatprotectionScheduledDownload) UnmarshalJSON(src []byte) error {
	v.isSet = true
