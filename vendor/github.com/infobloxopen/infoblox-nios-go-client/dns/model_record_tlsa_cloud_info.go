...
// checks if the RecordTlsaCloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordTlsaCloudInfo{}

// RecordTlsaCloudInfo struct for RecordTlsaCloudInfo
type RecordTlsaCloudInfo struct {
	DelegatedMember *RecordtlsacloudinfoDelegatedMember `json:"delegated_member,omitempty"`
...
type _RecordTlsaCloudInfo RecordTlsaCloudInfo
...
func (o *RecordTlsaCloudInfo) GetDelegatedMember() RecordtlsacloudinfoDelegatedMember {
	if o == nil || IsNil(o.DelegatedMember) {
		var ret RecordtlsacloudinfoDelegatedMember
		return ret
	}
...
func (o *RecordTlsaCloudInfo) GetDelegatedMemberOk() (*RecordtlsacloudinfoDelegatedMember, bool) {
	if o == nil || IsNil(o.DelegatedMember) {
		return nil, false
	}
...
// SetDelegatedMember gets a reference to the given RecordtlsacloudinfoDelegatedMember and assigns it to the DelegatedMember field.
...
func (o *RecordTlsaCloudInfo) GetAuthorityType() string {
...
func (o RecordTlsaCloudInfo) MarshalJSON() ([]byte, error) {
...
func (o RecordTlsaCloudInfo) ToMap() (map[string]interface{}, error) {
...
func (o *RecordTlsaCloudInfo) UnmarshalJSON(data []byte) (err error) {
	varRecordTlsaCloudInfo := _RecordTlsaCloudInfo{}

	err = json.Unmarshal(data, &varRecordTlsaCloudInfo)

	if err != nil {
		return err
	}

	*o = RecordTlsaCloudInfo(varRecordTlsaCloudInfo)
...
type NullableRecordTlsaCloudInfo struct {
	value *RecordTlsaCloudInfo
	isSet bool
}

func (v NullableRecordTlsaCloudInfo) Get() *RecordTlsaCloudInfo {
	return v.value
}

func (v *NullableRecordTlsaCloudInfo) Set(val *RecordTlsaCloudInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordTlsaCloudInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordTlsaCloudInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordTlsaCloudInfo(val *RecordTlsaCloudInfo) *NullableRecordTlsaCloudInfo {
	return &NullableRecordTlsaCloudInfo{value: val, isSet: true}
}

func (v NullableRecordTlsaCloudInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordTlsaCloudInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
