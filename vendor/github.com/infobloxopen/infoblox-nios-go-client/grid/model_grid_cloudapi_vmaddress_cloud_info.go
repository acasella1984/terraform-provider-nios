...
// checks if the GridCloudapiVmaddressCloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridCloudapiVmaddressCloudInfo{}

// GridCloudapiVmaddressCloudInfo struct for GridCloudapiVmaddressCloudInfo
type GridCloudapiVmaddressCloudInfo struct {
	DelegatedMember *GridcloudapivmaddresscloudinfoDelegatedMember `json:"delegated_member,omitempty"`
...
type _GridCloudapiVmaddressCloudInfo GridCloudapiVmaddressCloudInfo
...
func NewGridCloudapiVmaddressCloudInfo() *GridCloudapiVmaddressCloudInfo {
	this := GridCloudapiVmaddressCloudInfo{}
	return &this
}
...
func (o *GridCloudapiVmaddressCloudInfo) GetDelegatedMember() GridcloudapivmaddresscloudinfoDelegatedMember {
	if o == nil || IsNil(o.DelegatedMember) {
		var ret GridcloudapivmaddresscloudinfoDelegatedMember
		return ret
	}
...
// SetDelegatedMember gets a reference to the given GridcloudapivmaddresscloudinfoDelegatedMember and assigns it to the DelegatedMember field.
...
func (o GridCloudapiVmaddressCloudInfo) MarshalJSON() ([]byte, error) {
...
func (o GridCloudapiVmaddressCloudInfo) ToMap() (map[string]interface{}, error) {
...
func (o *GridCloudapiVmaddressCloudInfo) UnmarshalJSON(data []byte) (err error) {
	varGridCloudapiVmaddressCloudInfo := _GridCloudapiVmaddressCloudInfo{}

	err = json.Unmarshal(data, &varGridCloudapiVmaddressCloudInfo)

	if err != nil {
		return err
	}

	*o = GridCloudapiVmaddressCloudInfo(varGridCloudapiVmaddressCloudInfo)
...
type NullableGridCloudapiVmaddressCloudInfo struct {
	value *GridCloudapiVmaddressCloudInfo
	isSet bool
}

func (v NullableGridCloudapiVmaddressCloudInfo) Get() *GridCloudapiVmaddressCloudInfo {
	return v.value
}

func (v *NullableGridCloudapiVmaddressCloudInfo) Set(val *GridCloudapiVmaddressCloudInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableGridCloudapiVmaddressCloudInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableGridCloudapiVmaddressCloudInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridCloudapiVmaddressCloudInfo(val *GridCloudapiVmaddressCloudInfo) *NullableGridCloudapiVmaddressCloudInfo {
	return &NullableGridCloudapiVmaddressCloudInfo{value: val, isSet: true}
}

func (v NullableGridCloudapiVmaddressCloudInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridCloudapiVmaddressCloudInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
