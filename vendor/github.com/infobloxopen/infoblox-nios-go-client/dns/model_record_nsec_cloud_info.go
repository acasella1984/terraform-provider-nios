...
// checks if the RecordNsecCloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordNsecCloudInfo{}

// RecordNsecCloudInfo struct for RecordNsecCloudInfo
type RecordNsecCloudInfo struct {
	DelegatedMember *RecordnseccloudinfoDelegatedMember `json:"delegated_member,omitempty"`
...
type _RecordNsecCloudInfo RecordNsecCloudInfo
...
func (o *RecordNsecCloudInfo) GetDelegatedMember() RecordnseccloudinfoDelegatedMember {
	if o == nil || IsNil(o.DelegatedMember) {
		var ret RecordnseccloudinfoDelegatedMember
		return ret
	}
...
// SetDelegatedMember gets a reference to the given RecordnseccloudinfoDelegatedMember and assigns it to the DelegatedMember field.
...
func (o RecordNsecCloudInfo) MarshalJSON() ([]byte, error) {
...
func (o RecordNsecCloudInfo) ToMap() (map[string]interface{}, error) {
...
func (o *RecordNsecCloudInfo) UnmarshalJSON(data []byte) (err error) {
	varRecordNsecCloudInfo := _RecordNsecCloudInfo{}

	err = json.Unmarshal(data, &varRecordNsecCloudInfo)

	if err != nil {
		return err
	}

	*o = RecordNsecCloudInfo(varRecordNsecCloudInfo)
...
type NullableRecordNsecCloudInfo struct {
	value *RecordNsecCloudInfo
	isSet bool
}

func (v NullableRecordNsecCloudInfo) Get() *RecordNsecCloudInfo {
	return v.value
}

func (v *NullableRecordNsecCloudInfo) Set(val *RecordNsecCloudInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordNsecCloudInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordNsecCloudInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordNsecCloudInfo(val *RecordNsecCloudInfo) *NullableRecordNsecCloudInfo {
	return &NullableRecordNsecCloudInfo{value: val, isSet: true}
}

func (v NullableRecordNsecCloudInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordNsecCloudInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
