...
// checks if the RecordRpzNaptr type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordRpzNaptr{}

// RecordRpzNaptr struct for RecordRpzNaptr
...
func (o RecordRpzNaptr) MarshalJSON() ([]byte, error) {
...
type NullableRecordRpzNaptr struct {
	value *RecordRpzNaptr
	isSet bool
}

func (v NullableRecordRpzNaptr) Get() *RecordRpzNaptr {
	return v.value
}

func (v *NullableRecordRpzNaptr) Set(val *RecordRpzNaptr) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordRpzNaptr) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordRpzNaptr) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordRpzNaptr(val *RecordRpzNaptr) *NullableRecordRpzNaptr {
	return &NullableRecordRpzNaptr{value: val, isSet: true}
}

func (v NullableRecordRpzNaptr) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordRpzNaptr) UnmarshalJSON(src []byte) error {
	v.isSet = true
