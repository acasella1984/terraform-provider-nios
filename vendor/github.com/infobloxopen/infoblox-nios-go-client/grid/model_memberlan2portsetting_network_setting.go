...
// checks if the Memberlan2portsettingNetworkSetting type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Memberlan2portsettingNetworkSetting{}

// Memberlan2portsettingNetworkSetting struct for Memberlan2portsettingNetworkSetting
type Memberlan2portsettingNetworkSetting struct {
...
type _Memberlan2portsettingNetworkSetting Memberlan2portsettingNetworkSetting
...
func NewMemberlan2portsettingNetworkSetting() *Memberlan2portsettingNetworkSetting {
	this := Memberlan2portsettingNetworkSetting{}
	return &this
}
...
func (o Memberlan2portsettingNetworkSetting) MarshalJSON() ([]byte, error) {
...
func (o Memberlan2portsettingNetworkSetting) ToMap() (map[string]interface{}, error) {
...
func (o *Memberlan2portsettingNetworkSetting) UnmarshalJSON(data []byte) (err error) {
	varMemberlan2portsettingNetworkSetting := _Memberlan2portsettingNetworkSetting{}

	err = json.Unmarshal(data, &varMemberlan2portsettingNetworkSetting)

	if err != nil {
		return err
	}

	*o = Memberlan2portsettingNetworkSetting(varMemberlan2portsettingNetworkSetting)
...
type NullableMemberlan2portsettingNetworkSetting struct {
	value *Memberlan2portsettingNetworkSetting
	isSet bool
}

func (v NullableMemberlan2portsettingNetworkSetting) Get() *Memberlan2portsettingNetworkSetting {
	return v.value
}

func (v *NullableMemberlan2portsettingNetworkSetting) Set(val *Memberlan2portsettingNetworkSetting) {
	v.value = val
	v.isSet = true
}

func (v NullableMemberlan2portsettingNetworkSetting) IsSet() bool {
	return v.isSet
}

func (v *NullableMemberlan2portsettingNetworkSetting) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMemberlan2portsettingNetworkSetting(val *Memberlan2portsettingNetworkSetting) *NullableMemberlan2portsettingNetworkSetting {
	return &NullableMemberlan2portsettingNetworkSetting{value: val, isSet: true}
}

func (v NullableMemberlan2portsettingNetworkSetting) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMemberlan2portsettingNetworkSetting) UnmarshalJSON(src []byte) error {
	v.isSet = true
