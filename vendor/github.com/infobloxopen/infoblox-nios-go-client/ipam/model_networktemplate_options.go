...
// checks if the NetworktemplateOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworktemplateOptions{}

// NetworktemplateOptions struct for NetworktemplateOptions
type NetworktemplateOptions struct {
...
type _NetworktemplateOptions NetworktemplateOptions
...
func (o NetworktemplateOptions) MarshalJSON() ([]byte, error) {
...
func (o NetworktemplateOptions) ToMap() (map[string]interface{}, error) {
...
func (o *NetworktemplateOptions) UnmarshalJSON(data []byte) (err error) {
	varNetworktemplateOptions := _NetworktemplateOptions{}

	err = json.Unmarshal(data, &varNetworktemplateOptions)

	if err != nil {
		return err
	}

	*o = NetworktemplateOptions(varNetworktemplateOptions)
...
type NullableNetworktemplateOptions struct {
	value *NetworktemplateOptions
	isSet bool
}

func (v NullableNetworktemplateOptions) Get() *NetworktemplateOptions {
	return v.value
}

func (v *NullableNetworktemplateOptions) Set(val *NetworktemplateOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworktemplateOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworktemplateOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworktemplateOptions(val *NetworktemplateOptions) *NullableNetworktemplateOptions {
	return &NullableNetworktemplateOptions{value: val, isSet: true}
}

func (v NullableNetworktemplateOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworktemplateOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
