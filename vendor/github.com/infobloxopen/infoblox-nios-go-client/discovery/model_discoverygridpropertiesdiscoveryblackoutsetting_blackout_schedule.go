...
// checks if the DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule{}

// DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule struct for DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule
type DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule struct {
...
type _DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule

// NewDiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule instantiates a new DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule() *DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule {
	this := DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule{}
	return &this
}

// NewDiscoverygridpropertiesdiscoveryblackoutsettingBlackoutScheduleWithDefaults instantiates a new DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDiscoverygridpropertiesdiscoveryblackoutsettingBlackoutScheduleWithDefaults() *DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule {
	this := DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule{}
	return &this
}
...
func (o *DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule) GetEvery() int64 {
...
func (o *DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule) GetHourOfDay() int64 {
...
// and a boolean to check if the value has been set.
func (o *DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule) GetMonthOk() (*int64, bool) {
	if o == nil || IsNil(o.Month) {
		return nil, false
	}
	return o.Month, true
...
func (o DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule) MarshalJSON() ([]byte, error) {
...
func (o DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule) ToMap() (map[string]interface{}, error) {
...
func (o *DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule) UnmarshalJSON(data []byte) (err error) {
	varDiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule := _DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule{}

	err = json.Unmarshal(data, &varDiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule)

	if err != nil {
		return err
	}

	*o = DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule(varDiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule)
...
type NullableDiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule struct {
	value *DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule
	isSet bool
}

func (v NullableDiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule) Get() *DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule {
	return v.value
}

func (v *NullableDiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule) Set(val *DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableDiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableDiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule(val *DiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule) *NullableDiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule {
	return &NullableDiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule{value: val, isSet: true}
}

func (v NullableDiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiscoverygridpropertiesdiscoveryblackoutsettingBlackoutSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
