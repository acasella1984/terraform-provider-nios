...
// checks if the FilteroptionOptionList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FilteroptionOptionList{}

// FilteroptionOptionList struct for FilteroptionOptionList
type FilteroptionOptionList struct {
...
type _FilteroptionOptionList FilteroptionOptionList
...
func (o FilteroptionOptionList) MarshalJSON() ([]byte, error) {
...
func (o FilteroptionOptionList) ToMap() (map[string]interface{}, error) {
...
func (o *FilteroptionOptionList) UnmarshalJSON(data []byte) (err error) {
	varFilteroptionOptionList := _FilteroptionOptionList{}

	err = json.Unmarshal(data, &varFilteroptionOptionList)

	if err != nil {
		return err
	}

	*o = FilteroptionOptionList(varFilteroptionOptionList)
...
type NullableFilteroptionOptionList struct {
	value *FilteroptionOptionList
	isSet bool
}

func (v NullableFilteroptionOptionList) Get() *FilteroptionOptionList {
	return v.value
}

func (v *NullableFilteroptionOptionList) Set(val *FilteroptionOptionList) {
	v.value = val
	v.isSet = true
}

func (v NullableFilteroptionOptionList) IsSet() bool {
	return v.isSet
}

func (v *NullableFilteroptionOptionList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFilteroptionOptionList(val *FilteroptionOptionList) *NullableFilteroptionOptionList {
	return &NullableFilteroptionOptionList{value: val, isSet: true}
}

func (v NullableFilteroptionOptionList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFilteroptionOptionList) UnmarshalJSON(src []byte) error {
	v.isSet = true
