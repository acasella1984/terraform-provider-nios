...
// checks if the Ipv6sharednetworkOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Ipv6sharednetworkOptions{}

// Ipv6sharednetworkOptions struct for Ipv6sharednetworkOptions
type Ipv6sharednetworkOptions struct {
...
type _Ipv6sharednetworkOptions Ipv6sharednetworkOptions
...
func (o Ipv6sharednetworkOptions) MarshalJSON() ([]byte, error) {
...
func (o Ipv6sharednetworkOptions) ToMap() (map[string]interface{}, error) {
...
func (o *Ipv6sharednetworkOptions) UnmarshalJSON(data []byte) (err error) {
	varIpv6sharednetworkOptions := _Ipv6sharednetworkOptions{}

	err = json.Unmarshal(data, &varIpv6sharednetworkOptions)

	if err != nil {
		return err
	}

	*o = Ipv6sharednetworkOptions(varIpv6sharednetworkOptions)
...
type NullableIpv6sharednetworkOptions struct {
	value *Ipv6sharednetworkOptions
	isSet bool
}

func (v NullableIpv6sharednetworkOptions) Get() *Ipv6sharednetworkOptions {
	return v.value
}

func (v *NullableIpv6sharednetworkOptions) Set(val *Ipv6sharednetworkOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableIpv6sharednetworkOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableIpv6sharednetworkOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpv6sharednetworkOptions(val *Ipv6sharednetworkOptions) *NullableIpv6sharednetworkOptions {
	return &NullableIpv6sharednetworkOptions{value: val, isSet: true}
}

func (v NullableIpv6sharednetworkOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpv6sharednetworkOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
