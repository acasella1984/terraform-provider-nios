...
// checks if the Ipv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Ipv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{}

// Ipv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule struct for Ipv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule
type Ipv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule struct {
...
type _Ipv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule Ipv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule
...
func NewIpv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule() *Ipv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule {
	this := Ipv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{}
	return &this
}
...
func (o Ipv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) MarshalJSON() ([]byte, error) {
...
func (o Ipv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) ToMap() (map[string]interface{}, error) {
...
func (o *Ipv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) UnmarshalJSON(data []byte) (err error) {
	varIpv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule := _Ipv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{}

	err = json.Unmarshal(data, &varIpv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule)

	if err != nil {
		return err
	}

	*o = Ipv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule(varIpv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule)
...
type NullableIpv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule struct {
	value *Ipv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule
	isSet bool
}

func (v NullableIpv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) Get() *Ipv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule {
	return v.value
}

func (v *NullableIpv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) Set(val *Ipv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableIpv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableIpv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule(val *Ipv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) *NullableIpv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule {
	return &NullableIpv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{value: val, isSet: true}
}

func (v NullableIpv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpv6rangediscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
