...
// checks if the RecordTxtAwsRte53RecordInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordTxtAwsRte53RecordInfo{}

// RecordTxtAwsRte53RecordInfo struct for RecordTxtAwsRte53RecordInfo
type RecordTxtAwsRte53RecordInfo struct {
...
type _RecordTxtAwsRte53RecordInfo RecordTxtAwsRte53RecordInfo
...
func NewRecordTxtAwsRte53RecordInfo() *RecordTxtAwsRte53RecordInfo {
	this := RecordTxtAwsRte53RecordInfo{}
	return &this
}
...
func (o RecordTxtAwsRte53RecordInfo) MarshalJSON() ([]byte, error) {
...
func (o RecordTxtAwsRte53RecordInfo) ToMap() (map[string]interface{}, error) {
...
func (o *RecordTxtAwsRte53RecordInfo) UnmarshalJSON(data []byte) (err error) {
	varRecordTxtAwsRte53RecordInfo := _RecordTxtAwsRte53RecordInfo{}

	err = json.Unmarshal(data, &varRecordTxtAwsRte53RecordInfo)

	if err != nil {
		return err
	}

	*o = RecordTxtAwsRte53RecordInfo(varRecordTxtAwsRte53RecordInfo)
...
type NullableRecordTxtAwsRte53RecordInfo struct {
	value *RecordTxtAwsRte53RecordInfo
	isSet bool
}

func (v NullableRecordTxtAwsRte53RecordInfo) Get() *RecordTxtAwsRte53RecordInfo {
	return v.value
}

func (v *NullableRecordTxtAwsRte53RecordInfo) Set(val *RecordTxtAwsRte53RecordInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordTxtAwsRte53RecordInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordTxtAwsRte53RecordInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordTxtAwsRte53RecordInfo(val *RecordTxtAwsRte53RecordInfo) *NullableRecordTxtAwsRte53RecordInfo {
	return &NullableRecordTxtAwsRte53RecordInfo{value: val, isSet: true}
}

func (v NullableRecordTxtAwsRte53RecordInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordTxtAwsRte53RecordInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
