...
// checks if the Ipv6networkCloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Ipv6networkCloudInfo{}

// Ipv6networkCloudInfo struct for Ipv6networkCloudInfo
type Ipv6networkCloudInfo struct {
	DelegatedMember *Ipv6networkcloudinfoDelegatedMember `json:"delegated_member,omitempty"`
...
type _Ipv6networkCloudInfo Ipv6networkCloudInfo
...
func (o *Ipv6networkCloudInfo) GetDelegatedMember() Ipv6networkcloudinfoDelegatedMember {
	if o == nil || IsNil(o.DelegatedMember) {
		var ret Ipv6networkcloudinfoDelegatedMember
		return ret
	}
...
func (o *Ipv6networkCloudInfo) GetDelegatedMemberOk() (*Ipv6networkcloudinfoDelegatedMember, bool) {
	if o == nil || IsNil(o.DelegatedMember) {
		return nil, false
	}
...
// SetDelegatedMember gets a reference to the given Ipv6networkcloudinfoDelegatedMember and assigns it to the DelegatedMember field.
...
func (o *Ipv6networkCloudInfo) GetAuthorityType() string {
...
func (o Ipv6networkCloudInfo) MarshalJSON() ([]byte, error) {
...
func (o Ipv6networkCloudInfo) ToMap() (map[string]interface{}, error) {
...
func (o *Ipv6networkCloudInfo) UnmarshalJSON(data []byte) (err error) {
	varIpv6networkCloudInfo := _Ipv6networkCloudInfo{}

	err = json.Unmarshal(data, &varIpv6networkCloudInfo)

	if err != nil {
		return err
	}

	*o = Ipv6networkCloudInfo(varIpv6networkCloudInfo)
...
type NullableIpv6networkCloudInfo struct {
	value *Ipv6networkCloudInfo
	isSet bool
}

func (v NullableIpv6networkCloudInfo) Get() *Ipv6networkCloudInfo {
	return v.value
}

func (v *NullableIpv6networkCloudInfo) Set(val *Ipv6networkCloudInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableIpv6networkCloudInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableIpv6networkCloudInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpv6networkCloudInfo(val *Ipv6networkCloudInfo) *NullableIpv6networkCloudInfo {
	return &NullableIpv6networkCloudInfo{value: val, isSet: true}
}

func (v NullableIpv6networkCloudInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpv6networkCloudInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
