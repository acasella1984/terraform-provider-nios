...
// checks if the NetworkportcontrolblackoutsettingBlackoutSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkportcontrolblackoutsettingBlackoutSchedule{}

// NetworkportcontrolblackoutsettingBlackoutSchedule struct for NetworkportcontrolblackoutsettingBlackoutSchedule
type NetworkportcontrolblackoutsettingBlackoutSchedule struct {
...
type _NetworkportcontrolblackoutsettingBlackoutSchedule NetworkportcontrolblackoutsettingBlackoutSchedule

// NewNetworkportcontrolblackoutsettingBlackoutSchedule instantiates a new NetworkportcontrolblackoutsettingBlackoutSchedule object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewNetworkportcontrolblackoutsettingBlackoutSchedule() *NetworkportcontrolblackoutsettingBlackoutSchedule {
	this := NetworkportcontrolblackoutsettingBlackoutSchedule{}
	return &this
}

// NewNetworkportcontrolblackoutsettingBlackoutScheduleWithDefaults instantiates a new NetworkportcontrolblackoutsettingBlackoutSchedule object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewNetworkportcontrolblackoutsettingBlackoutScheduleWithDefaults() *NetworkportcontrolblackoutsettingBlackoutSchedule {
	this := NetworkportcontrolblackoutsettingBlackoutSchedule{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *NetworkportcontrolblackoutsettingBlackoutSchedule) GetRecurringTimeOk() (*int64, bool) {
	if o == nil || IsNil(o.RecurringTime) {
		return nil, false
	}
...
func (o *NetworkportcontrolblackoutsettingBlackoutSchedule) SetEvery(v int64) {
	o.Every = &v
}
...
func (o *NetworkportcontrolblackoutsettingBlackoutSchedule) HasHourOfDay() bool {
	if o != nil && !IsNil(o.HourOfDay) {
		return true
	}
...
func (o NetworkportcontrolblackoutsettingBlackoutSchedule) MarshalJSON() ([]byte, error) {
...
func (o NetworkportcontrolblackoutsettingBlackoutSchedule) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkportcontrolblackoutsettingBlackoutSchedule) UnmarshalJSON(data []byte) (err error) {
	varNetworkportcontrolblackoutsettingBlackoutSchedule := _NetworkportcontrolblackoutsettingBlackoutSchedule{}

	err = json.Unmarshal(data, &varNetworkportcontrolblackoutsettingBlackoutSchedule)

	if err != nil {
		return err
	}

	*o = NetworkportcontrolblackoutsettingBlackoutSchedule(varNetworkportcontrolblackoutsettingBlackoutSchedule)
...
type NullableNetworkportcontrolblackoutsettingBlackoutSchedule struct {
	value *NetworkportcontrolblackoutsettingBlackoutSchedule
	isSet bool
}

func (v NullableNetworkportcontrolblackoutsettingBlackoutSchedule) Get() *NetworkportcontrolblackoutsettingBlackoutSchedule {
	return v.value
}

func (v *NullableNetworkportcontrolblackoutsettingBlackoutSchedule) Set(val *NetworkportcontrolblackoutsettingBlackoutSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkportcontrolblackoutsettingBlackoutSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkportcontrolblackoutsettingBlackoutSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkportcontrolblackoutsettingBlackoutSchedule(val *NetworkportcontrolblackoutsettingBlackoutSchedule) *NullableNetworkportcontrolblackoutsettingBlackoutSchedule {
	return &NullableNetworkportcontrolblackoutsettingBlackoutSchedule{value: val, isSet: true}
}

func (v NullableNetworkportcontrolblackoutsettingBlackoutSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkportcontrolblackoutsettingBlackoutSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
