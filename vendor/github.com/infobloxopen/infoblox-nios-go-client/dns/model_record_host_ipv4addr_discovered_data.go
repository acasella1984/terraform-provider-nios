...
// checks if the RecordHostIpv4addrDiscoveredData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordHostIpv4addrDiscoveredData{}

// RecordHostIpv4addrDiscoveredData struct for RecordHostIpv4addrDiscoveredData
type RecordHostIpv4addrDiscoveredData struct {
...
type _RecordHostIpv4addrDiscoveredData RecordHostIpv4addrDiscoveredData
...
func NewRecordHostIpv4addrDiscoveredData() *RecordHostIpv4addrDiscoveredData {
	this := RecordHostIpv4addrDiscoveredData{}
	return &this
}
...
func (o *RecordHostIpv4addrDiscoveredData) SetDeviceType(v string) {
	o.DeviceType = &v
}
...
func (o *RecordHostIpv4addrDiscoveredData) HasDiscoveredName() bool {
	if o != nil && !IsNil(o.DiscoveredName) {
		return true
	}
...
func (o *RecordHostIpv4addrDiscoveredData) SetLastDiscovered(v int64) {
	o.LastDiscovered = &v
}
...
func (o *RecordHostIpv4addrDiscoveredData) HasMgmtIpAddress() bool {
	if o != nil && !IsNil(o.MgmtIpAddress) {
		return true
	}
...
func (o *RecordHostIpv4addrDiscoveredData) GetNetworkComponentIp() string {
...
// and a boolean to check if the value has been set.
func (o *RecordHostIpv4addrDiscoveredData) GetNetworkComponentNameOk() (*string, bool) {
	if o == nil || IsNil(o.NetworkComponentName) {
		return nil, false
	}
...
func (o *RecordHostIpv4addrDiscoveredData) HasOpenPorts() bool {
	if o != nil && !IsNil(o.OpenPorts) {
		return true
	}
...
func (o *RecordHostIpv4addrDiscoveredData) SetPortVlanDescription(v string) {
...
func (o *RecordHostIpv4addrDiscoveredData) HasPortVlanNumber() bool {
	if o != nil && !IsNil(o.PortVlanNumber) {
		return true
	}
...
func (o *RecordHostIpv4addrDiscoveredData) HasVSwitch() bool {
	if o != nil && !IsNil(o.VSwitch) {
		return true
	}
...
func (o *RecordHostIpv4addrDiscoveredData) SetVswitchIpv6Enabled(v bool) {
...
func (o *RecordHostIpv4addrDiscoveredData) HasVportMacAddress() bool {
	if o != nil && !IsNil(o.VportMacAddress) {
		return true
	}
...
func (o *RecordHostIpv4addrDiscoveredData) GetVportConfMode() string {
...
// and a boolean to check if the value has been set.
func (o *RecordHostIpv4addrDiscoveredData) GetVportModeOk() (*string, bool) {
	if o == nil || IsNil(o.VportMode) {
		return nil, false
	}
...
func (o *RecordHostIpv4addrDiscoveredData) HasVswitchTepType() bool {
	if o != nil && !IsNil(o.VswitchTepType) {
		return true
	}
...
func (o *RecordHostIpv4addrDiscoveredData) GetVswitchTepVlan() string {
...
// and a boolean to check if the value has been set.
func (o *RecordHostIpv4addrDiscoveredData) GetVswitchTepMulticastOk() (*string, bool) {
	if o == nil || IsNil(o.VswitchTepMulticast) {
		return nil, false
	}
...
func (o *RecordHostIpv4addrDiscoveredData) SetCiscoIseSessionState(v string) {
...
func (o *RecordHostIpv4addrDiscoveredData) HasTaskName() bool {
	if o != nil && !IsNil(o.TaskName) {
		return true
	}
...
func (o *RecordHostIpv4addrDiscoveredData) GetVrfDescription() string {
...
// and a boolean to check if the value has been set.
func (o *RecordHostIpv4addrDiscoveredData) GetBgpAsOk() (*int64, bool) {
	if o == nil || IsNil(o.BgpAs) {
		return nil, false
	}
	return o.BgpAs, true
...
func (o RecordHostIpv4addrDiscoveredData) MarshalJSON() ([]byte, error) {
...
func (o RecordHostIpv4addrDiscoveredData) ToMap() (map[string]interface{}, error) {
...
func (o *RecordHostIpv4addrDiscoveredData) UnmarshalJSON(data []byte) (err error) {
	varRecordHostIpv4addrDiscoveredData := _RecordHostIpv4addrDiscoveredData{}

	err = json.Unmarshal(data, &varRecordHostIpv4addrDiscoveredData)

	if err != nil {
		return err
	}

	*o = RecordHostIpv4addrDiscoveredData(varRecordHostIpv4addrDiscoveredData)
...
type NullableRecordHostIpv4addrDiscoveredData struct {
	value *RecordHostIpv4addrDiscoveredData
	isSet bool
}

func (v NullableRecordHostIpv4addrDiscoveredData) Get() *RecordHostIpv4addrDiscoveredData {
	return v.value
}

func (v *NullableRecordHostIpv4addrDiscoveredData) Set(val *RecordHostIpv4addrDiscoveredData) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordHostIpv4addrDiscoveredData) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordHostIpv4addrDiscoveredData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordHostIpv4addrDiscoveredData(val *RecordHostIpv4addrDiscoveredData) *NullableRecordHostIpv4addrDiscoveredData {
	return &NullableRecordHostIpv4addrDiscoveredData{value: val, isSet: true}
}

func (v NullableRecordHostIpv4addrDiscoveredData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordHostIpv4addrDiscoveredData) UnmarshalJSON(src []byte) error {
	v.isSet = true
