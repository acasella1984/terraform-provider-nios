...
// checks if the NetworkcontainerNetworkOneOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkcontainerNetworkOneOf{}

// NetworkcontainerNetworkOneOf networkcontainer: The network address in IPv4 Address/CIDR format. For regular expression searches, only the IPv4 Address portion is supported. Searches for the CIDR portion is always an exact match. For example, both network containers 10.0.0.0/8 and 20.1.0.0/16 are matched by expression '.0' and only 20.1.0.0/16 is matched by '.0/16'.
type NetworkcontainerNetworkOneOf struct {
...
type _NetworkcontainerNetworkOneOf NetworkcontainerNetworkOneOf
...
func NewNetworkcontainerNetworkOneOf() *NetworkcontainerNetworkOneOf {
	this := NetworkcontainerNetworkOneOf{}
	return &this
}
...
func (o NetworkcontainerNetworkOneOf) MarshalJSON() ([]byte, error) {
...
func (o NetworkcontainerNetworkOneOf) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkcontainerNetworkOneOf) UnmarshalJSON(data []byte) (err error) {
	varNetworkcontainerNetworkOneOf := _NetworkcontainerNetworkOneOf{}

	err = json.Unmarshal(data, &varNetworkcontainerNetworkOneOf)

	if err != nil {
		return err
	}

	*o = NetworkcontainerNetworkOneOf(varNetworkcontainerNetworkOneOf)
...
type NullableNetworkcontainerNetworkOneOf struct {
	value *NetworkcontainerNetworkOneOf
	isSet bool
}

func (v NullableNetworkcontainerNetworkOneOf) Get() *NetworkcontainerNetworkOneOf {
	return v.value
}

func (v *NullableNetworkcontainerNetworkOneOf) Set(val *NetworkcontainerNetworkOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkcontainerNetworkOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkcontainerNetworkOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkcontainerNetworkOneOf(val *NetworkcontainerNetworkOneOf) *NullableNetworkcontainerNetworkOneOf {
	return &NullableNetworkcontainerNetworkOneOf{value: val, isSet: true}
}

func (v NullableNetworkcontainerNetworkOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkcontainerNetworkOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
