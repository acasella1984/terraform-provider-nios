...
// checks if the NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{}

// NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule struct for NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule
type NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule struct {
...
type _NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule

// NewNetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule instantiates a new NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewNetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule() *NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule {
	this := NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{}
	return &this
}

// NewNetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingScheduleWithDefaults instantiates a new NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewNetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingScheduleWithDefaults() *NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule {
	this := NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{}
	return &this
}
...
func (o *NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) SetMinutesPastHour(v int64) {
	o.MinutesPastHour = &v
}
...
func (o *NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) SetYear(v int64) {
	o.Year = &v
}
...
func (o *NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) SetDayOfMonth(v int64) {
	o.DayOfMonth = &v
}
...
func (o *NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) SetDisable(v bool) {
	o.Disable = &v
}

func (o NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) MarshalJSON() ([]byte, error) {
...
func (o NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) UnmarshalJSON(data []byte) (err error) {
	varNetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule := _NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{}

	err = json.Unmarshal(data, &varNetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule)

	if err != nil {
		return err
	}

	*o = NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule(varNetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule)
...
type NullableNetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule struct {
	value *NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule
	isSet bool
}

func (v NullableNetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) Get() *NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule {
	return v.value
}

func (v *NullableNetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) Set(val *NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule(val *NetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) *NullableNetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule {
	return &NullableNetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{value: val, isSet: true}
}

func (v NullableNetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
