...
// checks if the Ipv6networkDiscoveryBasicPollSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Ipv6networkDiscoveryBasicPollSettings{}

// Ipv6networkDiscoveryBasicPollSettings struct for Ipv6networkDiscoveryBasicPollSettings
type Ipv6networkDiscoveryBasicPollSettings struct {
	...
	SwitchPortDataCollectionPollingSchedule *Ipv6networkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule `json:"switch_port_data_collection_polling_schedule,omitempty"`
...
type _Ipv6networkDiscoveryBasicPollSettings Ipv6networkDiscoveryBasicPollSettings
...
func NewIpv6networkDiscoveryBasicPollSettings() *Ipv6networkDiscoveryBasicPollSettings {
	this := Ipv6networkDiscoveryBasicPollSettings{}
	return &this
}
...
func (o *Ipv6networkDiscoveryBasicPollSettings) GetSwitchPortDataCollectionPollingSchedule() Ipv6networkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule {
	if o == nil || IsNil(o.SwitchPortDataCollectionPollingSchedule) {
		var ret Ipv6networkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule
		return ret
	}
...
// SetSwitchPortDataCollectionPollingSchedule gets a reference to the given Ipv6networkdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule and assigns it to the SwitchPortDataCollectionPollingSchedule field.
...
func (o Ipv6networkDiscoveryBasicPollSettings) MarshalJSON() ([]byte, error) {
...
func (o Ipv6networkDiscoveryBasicPollSettings) ToMap() (map[string]interface{}, error) {
...
func (o *Ipv6networkDiscoveryBasicPollSettings) UnmarshalJSON(data []byte) (err error) {
	varIpv6networkDiscoveryBasicPollSettings := _Ipv6networkDiscoveryBasicPollSettings{}

	err = json.Unmarshal(data, &varIpv6networkDiscoveryBasicPollSettings)

	if err != nil {
		return err
	}

	*o = Ipv6networkDiscoveryBasicPollSettings(varIpv6networkDiscoveryBasicPollSettings)
...
type NullableIpv6networkDiscoveryBasicPollSettings struct {
	value *Ipv6networkDiscoveryBasicPollSettings
	isSet bool
}

func (v NullableIpv6networkDiscoveryBasicPollSettings) Get() *Ipv6networkDiscoveryBasicPollSettings {
	return v.value
}

func (v *NullableIpv6networkDiscoveryBasicPollSettings) Set(val *Ipv6networkDiscoveryBasicPollSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableIpv6networkDiscoveryBasicPollSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableIpv6networkDiscoveryBasicPollSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpv6networkDiscoveryBasicPollSettings(val *Ipv6networkDiscoveryBasicPollSettings) *NullableIpv6networkDiscoveryBasicPollSettings {
	return &NullableIpv6networkDiscoveryBasicPollSettings{value: val, isSet: true}
}

func (v NullableIpv6networkDiscoveryBasicPollSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpv6networkDiscoveryBasicPollSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
