...
// checks if the RecordNaptrCloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordNaptrCloudInfo{}

// RecordNaptrCloudInfo struct for RecordNaptrCloudInfo
type RecordNaptrCloudInfo struct {
	DelegatedMember *RecordnaptrcloudinfoDelegatedMember `json:"delegated_member,omitempty"`
...
type _RecordNaptrCloudInfo RecordNaptrCloudInfo
...
func (o *RecordNaptrCloudInfo) GetDelegatedMember() RecordnaptrcloudinfoDelegatedMember {
	if o == nil || IsNil(o.DelegatedMember) {
		var ret RecordnaptrcloudinfoDelegatedMember
		return ret
	}
...
func (o *RecordNaptrCloudInfo) GetDelegatedMemberOk() (*RecordnaptrcloudinfoDelegatedMember, bool) {
	if o == nil || IsNil(o.DelegatedMember) {
		return nil, false
	}
...
// SetDelegatedMember gets a reference to the given RecordnaptrcloudinfoDelegatedMember and assigns it to the DelegatedMember field.
...
func (o *RecordNaptrCloudInfo) GetAuthorityType() string {
...
func (o RecordNaptrCloudInfo) MarshalJSON() ([]byte, error) {
...
func (o RecordNaptrCloudInfo) ToMap() (map[string]interface{}, error) {
...
func (o *RecordNaptrCloudInfo) UnmarshalJSON(data []byte) (err error) {
	varRecordNaptrCloudInfo := _RecordNaptrCloudInfo{}

	err = json.Unmarshal(data, &varRecordNaptrCloudInfo)

	if err != nil {
		return err
	}

	*o = RecordNaptrCloudInfo(varRecordNaptrCloudInfo)
...
type NullableRecordNaptrCloudInfo struct {
	value *RecordNaptrCloudInfo
	isSet bool
}

func (v NullableRecordNaptrCloudInfo) Get() *RecordNaptrCloudInfo {
	return v.value
}

func (v *NullableRecordNaptrCloudInfo) Set(val *RecordNaptrCloudInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordNaptrCloudInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordNaptrCloudInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordNaptrCloudInfo(val *RecordNaptrCloudInfo) *NullableRecordNaptrCloudInfo {
	return &NullableRecordNaptrCloudInfo{value: val, isSet: true}
}

func (v NullableRecordNaptrCloudInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordNaptrCloudInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
