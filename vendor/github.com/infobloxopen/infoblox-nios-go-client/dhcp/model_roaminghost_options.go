...
// checks if the RoaminghostOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoaminghostOptions{}

// RoaminghostOptions struct for RoaminghostOptions
type RoaminghostOptions struct {
...
type _RoaminghostOptions RoaminghostOptions
...
func (o RoaminghostOptions) MarshalJSON() ([]byte, error) {
...
func (o RoaminghostOptions) ToMap() (map[string]interface{}, error) {
...
func (o *RoaminghostOptions) UnmarshalJSON(data []byte) (err error) {
	varRoaminghostOptions := _RoaminghostOptions{}

	err = json.Unmarshal(data, &varRoaminghostOptions)

	if err != nil {
		return err
	}

	*o = RoaminghostOptions(varRoaminghostOptions)
...
type NullableRoaminghostOptions struct {
	value *RoaminghostOptions
	isSet bool
}

func (v NullableRoaminghostOptions) Get() *RoaminghostOptions {
	return v.value
}

func (v *NullableRoaminghostOptions) Set(val *RoaminghostOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableRoaminghostOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableRoaminghostOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoaminghostOptions(val *RoaminghostOptions) *NullableRoaminghostOptions {
	return &NullableRoaminghostOptions{value: val, isSet: true}
}

func (v NullableRoaminghostOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoaminghostOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
