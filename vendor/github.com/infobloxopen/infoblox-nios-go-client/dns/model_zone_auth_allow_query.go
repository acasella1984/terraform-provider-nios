...
// checks if the ZoneAuthAllowQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoneAuthAllowQuery{}
...
type _ZoneAuthAllowQuery ZoneAuthAllowQuery
...
func (o ZoneAuthAllowQuery) MarshalJSON() ([]byte, error) {
...
func (o *ZoneAuthAllowQuery) UnmarshalJSON(data []byte) (err error) {
	varZoneAuthAllowQuery := _ZoneAuthAllowQuery{}

	err = json.Unmarshal(data, &varZoneAuthAllowQuery)

	if err != nil {
		return err
	}

	*o = ZoneAuthAllowQuery(varZoneAuthAllowQuery)
...
type NullableZoneAuthAllowQuery struct {
	value *ZoneAuthAllowQuery
	isSet bool
}

func (v NullableZoneAuthAllowQuery) Get() *ZoneAuthAllowQuery {
	return v.value
}

func (v *NullableZoneAuthAllowQuery) Set(val *ZoneAuthAllowQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableZoneAuthAllowQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableZoneAuthAllowQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZoneAuthAllowQuery(val *ZoneAuthAllowQuery) *NullableZoneAuthAllowQuery {
	return &NullableZoneAuthAllowQuery{value: val, isSet: true}
}

func (v NullableZoneAuthAllowQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZoneAuthAllowQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
