...
// checks if the NotificationRestTemplateParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationRestTemplateParameters{}

// NotificationRestTemplateParameters struct for NotificationRestTemplateParameters
type NotificationRestTemplateParameters struct {
...
type _NotificationRestTemplateParameters NotificationRestTemplateParameters
...
func NewNotificationRestTemplateParameters() *NotificationRestTemplateParameters {
	this := NotificationRestTemplateParameters{}
	return &this
}
...
func (o NotificationRestTemplateParameters) MarshalJSON() ([]byte, error) {
...
func (o NotificationRestTemplateParameters) ToMap() (map[string]interface{}, error) {
...
func (o *NotificationRestTemplateParameters) UnmarshalJSON(data []byte) (err error) {
	varNotificationRestTemplateParameters := _NotificationRestTemplateParameters{}

	err = json.Unmarshal(data, &varNotificationRestTemplateParameters)

	if err != nil {
		return err
	}

	*o = NotificationRestTemplateParameters(varNotificationRestTemplateParameters)
...
type NullableNotificationRestTemplateParameters struct {
	value *NotificationRestTemplateParameters
	isSet bool
}

func (v NullableNotificationRestTemplateParameters) Get() *NotificationRestTemplateParameters {
	return v.value
}

func (v *NullableNotificationRestTemplateParameters) Set(val *NotificationRestTemplateParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationRestTemplateParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationRestTemplateParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationRestTemplateParameters(val *NotificationRestTemplateParameters) *NullableNotificationRestTemplateParameters {
	return &NullableNotificationRestTemplateParameters{value: val, isSet: true}
}

func (v NullableNotificationRestTemplateParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationRestTemplateParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
