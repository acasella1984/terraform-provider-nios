...
func ExpandNsgroupStubmemberStubMembers(ctx context.Context, o types.Object, diags *diag.Diagnostics) *dns.NsgroupStubmemberStubMembers {
...
func (m *NsgroupStubmemberStubMembersModel) Expand(ctx context.Context, diags *diag.Diagnostics) *dns.NsgroupStubmemberStubMembers {
	if m == nil {
		return nil
	}
...
func FlattenNsgroupStubmemberStubMembers(ctx context.Context, from *dns.NsgroupStubmemberStubMembers, diags *diag.Diagnostics) types.Object {
	if from == nil {
...
func (m *NsgroupStubmemberStubMembersModel) Flatten(ctx context.Context, from *dns.NsgroupStubmemberStubMembers, diags *diag.Diagnostics) {
	if from == nil {
		return
	}
	if m == nil {
