...
// checks if the RecordRrsigCloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordRrsigCloudInfo{}

// RecordRrsigCloudInfo struct for RecordRrsigCloudInfo
type RecordRrsigCloudInfo struct {
	DelegatedMember *RecordrrsigcloudinfoDelegatedMember `json:"delegated_member,omitempty"`
...
type _RecordRrsigCloudInfo RecordRrsigCloudInfo

// NewRecordRrsigCloudInfo instantiates a new RecordRrsigCloudInfo object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRecordRrsigCloudInfo() *RecordRrsigCloudInfo {
	this := RecordRrsigCloudInfo{}
	return &this
}

// NewRecordRrsigCloudInfoWithDefaults instantiates a new RecordRrsigCloudInfo object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewRecordRrsigCloudInfoWithDefaults() *RecordRrsigCloudInfo {
	this := RecordRrsigCloudInfo{}
	return &this
}

// GetDelegatedMember returns the DelegatedMember field value if set, zero value otherwise.
func (o *RecordRrsigCloudInfo) GetDelegatedMember() RecordrrsigcloudinfoDelegatedMember {
	if o == nil || IsNil(o.DelegatedMember) {
		var ret RecordrrsigcloudinfoDelegatedMember
		return ret
	}
...
func (o *RecordRrsigCloudInfo) GetDelegatedMemberOk() (*RecordrrsigcloudinfoDelegatedMember, bool) {
	if o == nil || IsNil(o.DelegatedMember) {
		return nil, false
	}
...
func (o *RecordRrsigCloudInfo) HasDelegatedMember() bool {
	if o != nil && !IsNil(o.DelegatedMember) {
		return true
	}
...
// SetDelegatedMember gets a reference to the given RecordrrsigcloudinfoDelegatedMember and assigns it to the DelegatedMember field.
func (o *RecordRrsigCloudInfo) SetDelegatedMember(v RecordrrsigcloudinfoDelegatedMember) {
	o.DelegatedMember = &v
}

// GetDelegatedScope returns the DelegatedScope field value if set, zero value otherwise.
func (o *RecordRrsigCloudInfo) GetDelegatedScope() string {
...
// and a boolean to check if the value has been set.
func (o *RecordRrsigCloudInfo) GetDelegatedScopeOk() (*string, bool) {
	if o == nil || IsNil(o.DelegatedScope) {
		return nil, false
	}
...
func (o *RecordRrsigCloudInfo) HasDelegatedScope() bool {
	if o != nil && !IsNil(o.DelegatedScope) {
		return true
	}
...
func (o *RecordRrsigCloudInfo) SetDelegatedScope(v string) {
	o.DelegatedScope = &v
}

// GetDelegatedRoot returns the DelegatedRoot field value if set, zero value otherwise.
func (o *RecordRrsigCloudInfo) GetDelegatedRoot() string {
...
// and a boolean to check if the value has been set.
func (o *RecordRrsigCloudInfo) GetDelegatedRootOk() (*string, bool) {
	if o == nil || IsNil(o.DelegatedRoot) {
		return nil, false
	}
...
func (o *RecordRrsigCloudInfo) HasDelegatedRoot() bool {
	if o != nil && !IsNil(o.DelegatedRoot) {
		return true
	}
...
func (o *RecordRrsigCloudInfo) SetDelegatedRoot(v string) {
	o.DelegatedRoot = &v
}

// GetOwnedByAdaptor returns the OwnedByAdaptor field value if set, zero value otherwise.
func (o *RecordRrsigCloudInfo) GetOwnedByAdaptor() bool {
...
// and a boolean to check if the value has been set.
func (o *RecordRrsigCloudInfo) GetOwnedByAdaptorOk() (*bool, bool) {
	if o == nil || IsNil(o.OwnedByAdaptor) {
		return nil, false
	}
...
func (o *RecordRrsigCloudInfo) HasOwnedByAdaptor() bool {
	if o != nil && !IsNil(o.OwnedByAdaptor) {
		return true
	}
...
func (o *RecordRrsigCloudInfo) SetOwnedByAdaptor(v bool) {
	o.OwnedByAdaptor = &v
}

// GetUsage returns the Usage field value if set, zero value otherwise.
func (o *RecordRrsigCloudInfo) GetUsage() string {
...
// and a boolean to check if the value has been set.
func (o *RecordRrsigCloudInfo) GetUsageOk() (*string, bool) {
	if o == nil || IsNil(o.Usage) {
		return nil, false
	}
	return o.Usage, true
...
func (o *RecordRrsigCloudInfo) HasUsage() bool {
	if o != nil && !IsNil(o.Usage) {
		return true
	}
...
func (o *RecordRrsigCloudInfo) SetUsage(v string) {
	o.Usage = &v
}

// GetTenant returns the Tenant field value if set, zero value otherwise.
func (o *RecordRrsigCloudInfo) GetTenant() string {
...
// and a boolean to check if the value has been set.
func (o *RecordRrsigCloudInfo) GetTenantOk() (*string, bool) {
	if o == nil || IsNil(o.Tenant) {
		return nil, false
	}
...
func (o *RecordRrsigCloudInfo) HasTenant() bool {
	if o != nil && !IsNil(o.Tenant) {
		return true
	}
...
func (o *RecordRrsigCloudInfo) SetTenant(v string) {
	o.Tenant = &v
}

// GetMgmtPlatform returns the MgmtPlatform field value if set, zero value otherwise.
func (o *RecordRrsigCloudInfo) GetMgmtPlatform() string {
...
// and a boolean to check if the value has been set.
func (o *RecordRrsigCloudInfo) GetMgmtPlatformOk() (*string, bool) {
	if o == nil || IsNil(o.MgmtPlatform) {
		return nil, false
	}
...
func (o *RecordRrsigCloudInfo) HasMgmtPlatform() bool {
	if o != nil && !IsNil(o.MgmtPlatform) {
		return true
	}
...
func (o *RecordRrsigCloudInfo) SetMgmtPlatform(v string) {
	o.MgmtPlatform = &v
}

// GetAuthorityType returns the AuthorityType field value if set, zero value otherwise.
func (o *RecordRrsigCloudInfo) GetAuthorityType() string {
...
// and a boolean to check if the value has been set.
func (o *RecordRrsigCloudInfo) GetAuthorityTypeOk() (*string, bool) {
	if o == nil || IsNil(o.AuthorityType) {
		return nil, false
	}
...
func (o *RecordRrsigCloudInfo) HasAuthorityType() bool {
	if o != nil && !IsNil(o.AuthorityType) {
		return true
	}
...
func (o *RecordRrsigCloudInfo) SetAuthorityType(v string) {
	o.AuthorityType = &v
}

func (o RecordRrsigCloudInfo) MarshalJSON() ([]byte, error) {
...
func (o RecordRrsigCloudInfo) ToMap() (map[string]interface{}, error) {
...
func (o *RecordRrsigCloudInfo) UnmarshalJSON(data []byte) (err error) {
	varRecordRrsigCloudInfo := _RecordRrsigCloudInfo{}

	err = json.Unmarshal(data, &varRecordRrsigCloudInfo)

	if err != nil {
		return err
	}

	*o = RecordRrsigCloudInfo(varRecordRrsigCloudInfo)
...
type NullableRecordRrsigCloudInfo struct {
	value *RecordRrsigCloudInfo
	isSet bool
}

func (v NullableRecordRrsigCloudInfo) Get() *RecordRrsigCloudInfo {
	return v.value
}

func (v *NullableRecordRrsigCloudInfo) Set(val *RecordRrsigCloudInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordRrsigCloudInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordRrsigCloudInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordRrsigCloudInfo(val *RecordRrsigCloudInfo) *NullableRecordRrsigCloudInfo {
	return &NullableRecordRrsigCloudInfo{value: val, isSet: true}
}

func (v NullableRecordRrsigCloudInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordRrsigCloudInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
