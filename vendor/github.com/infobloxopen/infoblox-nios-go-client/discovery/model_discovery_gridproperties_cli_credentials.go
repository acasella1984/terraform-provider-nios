...
// checks if the DiscoveryGridpropertiesCliCredentials type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiscoveryGridpropertiesCliCredentials{}

// DiscoveryGridpropertiesCliCredentials struct for DiscoveryGridpropertiesCliCredentials
type DiscoveryGridpropertiesCliCredentials struct {
	// The CLI user name.
...
type _DiscoveryGridpropertiesCliCredentials DiscoveryGridpropertiesCliCredentials
...
func NewDiscoveryGridpropertiesCliCredentials() *DiscoveryGridpropertiesCliCredentials {
	this := DiscoveryGridpropertiesCliCredentials{}
	return &this
}
...
func (o DiscoveryGridpropertiesCliCredentials) MarshalJSON() ([]byte, error) {
...
func (o DiscoveryGridpropertiesCliCredentials) ToMap() (map[string]interface{}, error) {
...
func (o *DiscoveryGridpropertiesCliCredentials) UnmarshalJSON(data []byte) (err error) {
	varDiscoveryGridpropertiesCliCredentials := _DiscoveryGridpropertiesCliCredentials{}

	err = json.Unmarshal(data, &varDiscoveryGridpropertiesCliCredentials)

	if err != nil {
		return err
	}

	*o = DiscoveryGridpropertiesCliCredentials(varDiscoveryGridpropertiesCliCredentials)
...
type NullableDiscoveryGridpropertiesCliCredentials struct {
	value *DiscoveryGridpropertiesCliCredentials
	isSet bool
}

func (v NullableDiscoveryGridpropertiesCliCredentials) Get() *DiscoveryGridpropertiesCliCredentials {
	return v.value
}

func (v *NullableDiscoveryGridpropertiesCliCredentials) Set(val *DiscoveryGridpropertiesCliCredentials) {
	v.value = val
	v.isSet = true
}

func (v NullableDiscoveryGridpropertiesCliCredentials) IsSet() bool {
	return v.isSet
}

func (v *NullableDiscoveryGridpropertiesCliCredentials) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiscoveryGridpropertiesCliCredentials(val *DiscoveryGridpropertiesCliCredentials) *NullableDiscoveryGridpropertiesCliCredentials {
	return &NullableDiscoveryGridpropertiesCliCredentials{value: val, isSet: true}
}

func (v NullableDiscoveryGridpropertiesCliCredentials) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiscoveryGridpropertiesCliCredentials) UnmarshalJSON(src []byte) error {
	v.isSet = true
