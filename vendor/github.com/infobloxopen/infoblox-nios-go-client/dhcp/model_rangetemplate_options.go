...
// checks if the RangetemplateOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RangetemplateOptions{}

// RangetemplateOptions struct for RangetemplateOptions
type RangetemplateOptions struct {
...
type _RangetemplateOptions RangetemplateOptions
...
func (o RangetemplateOptions) MarshalJSON() ([]byte, error) {
...
func (o RangetemplateOptions) ToMap() (map[string]interface{}, error) {
...
func (o *RangetemplateOptions) UnmarshalJSON(data []byte) (err error) {
	varRangetemplateOptions := _RangetemplateOptions{}

	err = json.Unmarshal(data, &varRangetemplateOptions)

	if err != nil {
		return err
	}

	*o = RangetemplateOptions(varRangetemplateOptions)
...
type NullableRangetemplateOptions struct {
	value *RangetemplateOptions
	isSet bool
}

func (v NullableRangetemplateOptions) Get() *RangetemplateOptions {
	return v.value
}

func (v *NullableRangetemplateOptions) Set(val *RangetemplateOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableRangetemplateOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableRangetemplateOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRangetemplateOptions(val *RangetemplateOptions) *NullableRangetemplateOptions {
	return &NullableRangetemplateOptions{value: val, isSet: true}
}

func (v NullableRangetemplateOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRangetemplateOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
