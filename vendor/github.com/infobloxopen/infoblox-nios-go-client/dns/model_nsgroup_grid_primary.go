...
// checks if the NsgroupGridPrimary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NsgroupGridPrimary{}

// NsgroupGridPrimary struct for NsgroupGridPrimary
type NsgroupGridPrimary struct {
	...
	PreferredPrimaries []NsgroupgridprimaryPreferredPrimaries `json:"preferred_primaries,omitempty"`
...
type _NsgroupGridPrimary NsgroupGridPrimary
...
func (o *NsgroupGridPrimary) GetPreferredPrimaries() []NsgroupgridprimaryPreferredPrimaries {
	if o == nil || IsNil(o.PreferredPrimaries) {
		var ret []NsgroupgridprimaryPreferredPrimaries
		return ret
	}
...
// SetPreferredPrimaries gets a reference to the given []NsgroupgridprimaryPreferredPrimaries and assigns it to the PreferredPrimaries field.
...
func (o NsgroupGridPrimary) MarshalJSON() ([]byte, error) {
...
func (o NsgroupGridPrimary) ToMap() (map[string]interface{}, error) {
...
func (o *NsgroupGridPrimary) UnmarshalJSON(data []byte) (err error) {
	varNsgroupGridPrimary := _NsgroupGridPrimary{}

	err = json.Unmarshal(data, &varNsgroupGridPrimary)

	if err != nil {
		return err
	}

	*o = NsgroupGridPrimary(varNsgroupGridPrimary)
...
type NullableNsgroupGridPrimary struct {
	value *NsgroupGridPrimary
	isSet bool
}

func (v NullableNsgroupGridPrimary) Get() *NsgroupGridPrimary {
	return v.value
}

func (v *NullableNsgroupGridPrimary) Set(val *NsgroupGridPrimary) {
	v.value = val
	v.isSet = true
}

func (v NullableNsgroupGridPrimary) IsSet() bool {
	return v.isSet
}

func (v *NullableNsgroupGridPrimary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNsgroupGridPrimary(val *NsgroupGridPrimary) *NullableNsgroupGridPrimary {
	return &NullableNsgroupGridPrimary{value: val, isSet: true}
}

func (v NullableNsgroupGridPrimary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNsgroupGridPrimary) UnmarshalJSON(src []byte) error {
	v.isSet = true
