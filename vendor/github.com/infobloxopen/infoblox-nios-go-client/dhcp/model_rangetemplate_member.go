...
// checks if the RangetemplateMember type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RangetemplateMember{}

// RangetemplateMember struct for RangetemplateMember
...
type _RangetemplateMember RangetemplateMember
...
func (o RangetemplateMember) MarshalJSON() ([]byte, error) {
...
func (o RangetemplateMember) ToMap() (map[string]interface{}, error) {
...
func (o *RangetemplateMember) UnmarshalJSON(data []byte) (err error) {
	varRangetemplateMember := _RangetemplateMember{}

	err = json.Unmarshal(data, &varRangetemplateMember)

	if err != nil {
		return err
	}

	*o = RangetemplateMember(varRangetemplateMember)
...
type NullableRangetemplateMember struct {
	value *RangetemplateMember
	isSet bool
}

func (v NullableRangetemplateMember) Get() *RangetemplateMember {
	return v.value
}

func (v *NullableRangetemplateMember) Set(val *RangetemplateMember) {
	v.value = val
	v.isSet = true
}

func (v NullableRangetemplateMember) IsSet() bool {
	return v.isSet
}

func (v *NullableRangetemplateMember) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRangetemplateMember(val *RangetemplateMember) *NullableRangetemplateMember {
	return &NullableRangetemplateMember{value: val, isSet: true}
}

func (v NullableRangetemplateMember) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRangetemplateMember) UnmarshalJSON(src []byte) error {
	v.isSet = true
