...
// checks if the NsgroupforwardingmemberforwardingserversForwardTo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NsgroupforwardingmemberforwardingserversForwardTo{}

// NsgroupforwardingmemberforwardingserversForwardTo struct for NsgroupforwardingmemberforwardingserversForwardTo
type NsgroupforwardingmemberforwardingserversForwardTo struct {
...
type _NsgroupforwardingmemberforwardingserversForwardTo NsgroupforwardingmemberforwardingserversForwardTo
...
func NewNsgroupforwardingmemberforwardingserversForwardTo() *NsgroupforwardingmemberforwardingserversForwardTo {
	this := NsgroupforwardingmemberforwardingserversForwardTo{}
	return &this
}
...
func (o NsgroupforwardingmemberforwardingserversForwardTo) MarshalJSON() ([]byte, error) {
...
func (o NsgroupforwardingmemberforwardingserversForwardTo) ToMap() (map[string]interface{}, error) {
...
func (o *NsgroupforwardingmemberforwardingserversForwardTo) UnmarshalJSON(data []byte) (err error) {
	varNsgroupforwardingmemberforwardingserversForwardTo := _NsgroupforwardingmemberforwardingserversForwardTo{}

	err = json.Unmarshal(data, &varNsgroupforwardingmemberforwardingserversForwardTo)

	if err != nil {
		return err
	}

	*o = NsgroupforwardingmemberforwardingserversForwardTo(varNsgroupforwardingmemberforwardingserversForwardTo)
...
type NullableNsgroupforwardingmemberforwardingserversForwardTo struct {
	value *NsgroupforwardingmemberforwardingserversForwardTo
	isSet bool
}

func (v NullableNsgroupforwardingmemberforwardingserversForwardTo) Get() *NsgroupforwardingmemberforwardingserversForwardTo {
	return v.value
}

func (v *NullableNsgroupforwardingmemberforwardingserversForwardTo) Set(val *NsgroupforwardingmemberforwardingserversForwardTo) {
	v.value = val
	v.isSet = true
}

func (v NullableNsgroupforwardingmemberforwardingserversForwardTo) IsSet() bool {
	return v.isSet
}

func (v *NullableNsgroupforwardingmemberforwardingserversForwardTo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNsgroupforwardingmemberforwardingserversForwardTo(val *NsgroupforwardingmemberforwardingserversForwardTo) *NullableNsgroupforwardingmemberforwardingserversForwardTo {
	return &NullableNsgroupforwardingmemberforwardingserversForwardTo{value: val, isSet: true}
}

func (v NullableNsgroupforwardingmemberforwardingserversForwardTo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNsgroupforwardingmemberforwardingserversForwardTo) UnmarshalJSON(src []byte) error {
	v.isSet = true
