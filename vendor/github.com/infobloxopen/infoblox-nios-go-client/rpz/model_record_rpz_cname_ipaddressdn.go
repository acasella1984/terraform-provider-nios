...
// checks if the RecordRpzCnameIpaddressdn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordRpzCnameIpaddressdn{}

// RecordRpzCnameIpaddressdn struct for RecordRpzCnameIpaddressdn
...
func NewRecordRpzCnameIpaddressdn() *RecordRpzCnameIpaddressdn {
	this := RecordRpzCnameIpaddressdn{}
	return &this
}
...
func (o *RecordRpzCnameIpaddressdn) SetExtAttrs(v map[string]ExtAttrs) {
	o.ExtAttrs = &v
}
...
func (o RecordRpzCnameIpaddressdn) MarshalJSON() ([]byte, error) {
...
func (o RecordRpzCnameIpaddressdn) ToMap() (map[string]interface{}, error) {
...
type NullableRecordRpzCnameIpaddressdn struct {
	value *RecordRpzCnameIpaddressdn
	isSet bool
}

func (v NullableRecordRpzCnameIpaddressdn) Get() *RecordRpzCnameIpaddressdn {
	return v.value
}

func (v *NullableRecordRpzCnameIpaddressdn) Set(val *RecordRpzCnameIpaddressdn) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordRpzCnameIpaddressdn) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordRpzCnameIpaddressdn) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordRpzCnameIpaddressdn(val *RecordRpzCnameIpaddressdn) *NullableRecordRpzCnameIpaddressdn {
	return &NullableRecordRpzCnameIpaddressdn{value: val, isSet: true}
}

func (v NullableRecordRpzCnameIpaddressdn) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordRpzCnameIpaddressdn) UnmarshalJSON(src []byte) error {
	v.isSet = true
