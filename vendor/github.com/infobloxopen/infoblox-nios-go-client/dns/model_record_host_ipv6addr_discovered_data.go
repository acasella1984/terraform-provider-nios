...
// checks if the RecordHostIpv6addrDiscoveredData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordHostIpv6addrDiscoveredData{}

// RecordHostIpv6addrDiscoveredData struct for RecordHostIpv6addrDiscoveredData
type RecordHostIpv6addrDiscoveredData struct {
...
type _RecordHostIpv6addrDiscoveredData RecordHostIpv6addrDiscoveredData
...
func NewRecordHostIpv6addrDiscoveredData() *RecordHostIpv6addrDiscoveredData {
	this := RecordHostIpv6addrDiscoveredData{}
	return &this
}
...
func (o RecordHostIpv6addrDiscoveredData) MarshalJSON() ([]byte, error) {
...
func (o RecordHostIpv6addrDiscoveredData) ToMap() (map[string]interface{}, error) {
...
func (o *RecordHostIpv6addrDiscoveredData) UnmarshalJSON(data []byte) (err error) {
	varRecordHostIpv6addrDiscoveredData := _RecordHostIpv6addrDiscoveredData{}

	err = json.Unmarshal(data, &varRecordHostIpv6addrDiscoveredData)

	if err != nil {
		return err
	}

	*o = RecordHostIpv6addrDiscoveredData(varRecordHostIpv6addrDiscoveredData)
...
type NullableRecordHostIpv6addrDiscoveredData struct {
	value *RecordHostIpv6addrDiscoveredData
	isSet bool
}

func (v NullableRecordHostIpv6addrDiscoveredData) Get() *RecordHostIpv6addrDiscoveredData {
	return v.value
}

func (v *NullableRecordHostIpv6addrDiscoveredData) Set(val *RecordHostIpv6addrDiscoveredData) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordHostIpv6addrDiscoveredData) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordHostIpv6addrDiscoveredData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordHostIpv6addrDiscoveredData(val *RecordHostIpv6addrDiscoveredData) *NullableRecordHostIpv6addrDiscoveredData {
	return &NullableRecordHostIpv6addrDiscoveredData{value: val, isSet: true}
}

func (v NullableRecordHostIpv6addrDiscoveredData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordHostIpv6addrDiscoveredData) UnmarshalJSON(src []byte) error {
	v.isSet = true
