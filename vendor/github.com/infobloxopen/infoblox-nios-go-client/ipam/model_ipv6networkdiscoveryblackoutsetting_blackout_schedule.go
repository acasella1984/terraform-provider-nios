...
// checks if the Ipv6networkdiscoveryblackoutsettingBlackoutSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Ipv6networkdiscoveryblackoutsettingBlackoutSchedule{}

// Ipv6networkdiscoveryblackoutsettingBlackoutSchedule struct for Ipv6networkdiscoveryblackoutsettingBlackoutSchedule
type Ipv6networkdiscoveryblackoutsettingBlackoutSchedule struct {
...
type _Ipv6networkdiscoveryblackoutsettingBlackoutSchedule Ipv6networkdiscoveryblackoutsettingBlackoutSchedule

// NewIpv6networkdiscoveryblackoutsettingBlackoutSchedule instantiates a new Ipv6networkdiscoveryblackoutsettingBlackoutSchedule object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewIpv6networkdiscoveryblackoutsettingBlackoutSchedule() *Ipv6networkdiscoveryblackoutsettingBlackoutSchedule {
	this := Ipv6networkdiscoveryblackoutsettingBlackoutSchedule{}
	return &this
}

// NewIpv6networkdiscoveryblackoutsettingBlackoutScheduleWithDefaults instantiates a new Ipv6networkdiscoveryblackoutsettingBlackoutSchedule object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewIpv6networkdiscoveryblackoutsettingBlackoutScheduleWithDefaults() *Ipv6networkdiscoveryblackoutsettingBlackoutSchedule {
	this := Ipv6networkdiscoveryblackoutsettingBlackoutSchedule{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *Ipv6networkdiscoveryblackoutsettingBlackoutSchedule) GetRecurringTimeOk() (*int64, bool) {
	if o == nil || IsNil(o.RecurringTime) {
		return nil, false
	}
...
func (o *Ipv6networkdiscoveryblackoutsettingBlackoutSchedule) SetEvery(v int64) {
	o.Every = &v
}
...
func (o *Ipv6networkdiscoveryblackoutsettingBlackoutSchedule) HasHourOfDay() bool {
	if o != nil && !IsNil(o.HourOfDay) {
		return true
	}
...
func (o Ipv6networkdiscoveryblackoutsettingBlackoutSchedule) MarshalJSON() ([]byte, error) {
...
func (o Ipv6networkdiscoveryblackoutsettingBlackoutSchedule) ToMap() (map[string]interface{}, error) {
...
func (o *Ipv6networkdiscoveryblackoutsettingBlackoutSchedule) UnmarshalJSON(data []byte) (err error) {
	varIpv6networkdiscoveryblackoutsettingBlackoutSchedule := _Ipv6networkdiscoveryblackoutsettingBlackoutSchedule{}

	err = json.Unmarshal(data, &varIpv6networkdiscoveryblackoutsettingBlackoutSchedule)

	if err != nil {
		return err
	}

	*o = Ipv6networkdiscoveryblackoutsettingBlackoutSchedule(varIpv6networkdiscoveryblackoutsettingBlackoutSchedule)
...
type NullableIpv6networkdiscoveryblackoutsettingBlackoutSchedule struct {
	value *Ipv6networkdiscoveryblackoutsettingBlackoutSchedule
	isSet bool
}

func (v NullableIpv6networkdiscoveryblackoutsettingBlackoutSchedule) Get() *Ipv6networkdiscoveryblackoutsettingBlackoutSchedule {
	return v.value
}

func (v *NullableIpv6networkdiscoveryblackoutsettingBlackoutSchedule) Set(val *Ipv6networkdiscoveryblackoutsettingBlackoutSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableIpv6networkdiscoveryblackoutsettingBlackoutSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableIpv6networkdiscoveryblackoutsettingBlackoutSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpv6networkdiscoveryblackoutsettingBlackoutSchedule(val *Ipv6networkdiscoveryblackoutsettingBlackoutSchedule) *NullableIpv6networkdiscoveryblackoutsettingBlackoutSchedule {
	return &NullableIpv6networkdiscoveryblackoutsettingBlackoutSchedule{value: val, isSet: true}
}

func (v NullableIpv6networkdiscoveryblackoutsettingBlackoutSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpv6networkdiscoveryblackoutsettingBlackoutSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
