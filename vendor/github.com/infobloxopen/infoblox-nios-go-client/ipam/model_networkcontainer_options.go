...
// checks if the NetworkcontainerOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkcontainerOptions{}

// NetworkcontainerOptions struct for NetworkcontainerOptions
type NetworkcontainerOptions struct {
...
type _NetworkcontainerOptions NetworkcontainerOptions
...
func (o NetworkcontainerOptions) MarshalJSON() ([]byte, error) {
...
func (o NetworkcontainerOptions) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkcontainerOptions) UnmarshalJSON(data []byte) (err error) {
	varNetworkcontainerOptions := _NetworkcontainerOptions{}

	err = json.Unmarshal(data, &varNetworkcontainerOptions)

	if err != nil {
		return err
	}

	*o = NetworkcontainerOptions(varNetworkcontainerOptions)
...
type NullableNetworkcontainerOptions struct {
	value *NetworkcontainerOptions
	isSet bool
}

func (v NullableNetworkcontainerOptions) Get() *NetworkcontainerOptions {
	return v.value
}

func (v *NullableNetworkcontainerOptions) Set(val *NetworkcontainerOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkcontainerOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkcontainerOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkcontainerOptions(val *NetworkcontainerOptions) *NullableNetworkcontainerOptions {
	return &NullableNetworkcontainerOptions{value: val, isSet: true}
}

func (v NullableNetworkcontainerOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkcontainerOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
