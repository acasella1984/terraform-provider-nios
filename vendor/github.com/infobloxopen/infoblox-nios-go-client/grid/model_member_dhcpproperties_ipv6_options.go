...
// checks if the MemberDhcppropertiesIpv6Options type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MemberDhcppropertiesIpv6Options{}

// MemberDhcppropertiesIpv6Options struct for MemberDhcppropertiesIpv6Options
type MemberDhcppropertiesIpv6Options struct {
...
type _MemberDhcppropertiesIpv6Options MemberDhcppropertiesIpv6Options
...
func NewMemberDhcppropertiesIpv6Options() *MemberDhcppropertiesIpv6Options {
	this := MemberDhcppropertiesIpv6Options{}
	return &this
}
...
func (o MemberDhcppropertiesIpv6Options) MarshalJSON() ([]byte, error) {
...
func (o MemberDhcppropertiesIpv6Options) ToMap() (map[string]interface{}, error) {
...
func (o *MemberDhcppropertiesIpv6Options) UnmarshalJSON(data []byte) (err error) {
	varMemberDhcppropertiesIpv6Options := _MemberDhcppropertiesIpv6Options{}

	err = json.Unmarshal(data, &varMemberDhcppropertiesIpv6Options)

	if err != nil {
		return err
	}

	*o = MemberDhcppropertiesIpv6Options(varMemberDhcppropertiesIpv6Options)
...
type NullableMemberDhcppropertiesIpv6Options struct {
	value *MemberDhcppropertiesIpv6Options
	isSet bool
}

func (v NullableMemberDhcppropertiesIpv6Options) Get() *MemberDhcppropertiesIpv6Options {
	return v.value
}

func (v *NullableMemberDhcppropertiesIpv6Options) Set(val *MemberDhcppropertiesIpv6Options) {
	v.value = val
	v.isSet = true
}

func (v NullableMemberDhcppropertiesIpv6Options) IsSet() bool {
	return v.isSet
}

func (v *NullableMemberDhcppropertiesIpv6Options) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMemberDhcppropertiesIpv6Options(val *MemberDhcppropertiesIpv6Options) *NullableMemberDhcppropertiesIpv6Options {
	return &NullableMemberDhcppropertiesIpv6Options{value: val, isSet: true}
}

func (v NullableMemberDhcppropertiesIpv6Options) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMemberDhcppropertiesIpv6Options) UnmarshalJSON(src []byte) error {
	v.isSet = true
