...
// checks if the MemberDnsAllowQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MemberDnsAllowQuery{}

// MemberDnsAllowQuery struct for MemberDnsAllowQuery
type MemberDnsAllowQuery struct {
...
type _MemberDnsAllowQuery MemberDnsAllowQuery
...
func (o MemberDnsAllowQuery) MarshalJSON() ([]byte, error) {
...
func (o MemberDnsAllowQuery) ToMap() (map[string]interface{}, error) {
...
func (o *MemberDnsAllowQuery) UnmarshalJSON(data []byte) (err error) {
	varMemberDnsAllowQuery := _MemberDnsAllowQuery{}

	err = json.Unmarshal(data, &varMemberDnsAllowQuery)

	if err != nil {
		return err
	}

	*o = MemberDnsAllowQuery(varMemberDnsAllowQuery)
...
type NullableMemberDnsAllowQuery struct {
	value *MemberDnsAllowQuery
	isSet bool
}

func (v NullableMemberDnsAllowQuery) Get() *MemberDnsAllowQuery {
	return v.value
}

func (v *NullableMemberDnsAllowQuery) Set(val *MemberDnsAllowQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableMemberDnsAllowQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableMemberDnsAllowQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMemberDnsAllowQuery(val *MemberDnsAllowQuery) *NullableMemberDnsAllowQuery {
	return &NullableMemberDnsAllowQuery{value: val, isSet: true}
}

func (v NullableMemberDnsAllowQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMemberDnsAllowQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
