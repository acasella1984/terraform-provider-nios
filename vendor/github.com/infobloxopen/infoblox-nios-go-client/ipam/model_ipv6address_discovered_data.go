...
// checks if the Ipv6addressDiscoveredData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Ipv6addressDiscoveredData{}

// Ipv6addressDiscoveredData struct for Ipv6addressDiscoveredData
type Ipv6addressDiscoveredData struct {
...
type _Ipv6addressDiscoveredData Ipv6addressDiscoveredData
...
func NewIpv6addressDiscoveredData() *Ipv6addressDiscoveredData {
	this := Ipv6addressDiscoveredData{}
	return &this
}
...
func (o Ipv6addressDiscoveredData) MarshalJSON() ([]byte, error) {
...
func (o Ipv6addressDiscoveredData) ToMap() (map[string]interface{}, error) {
...
func (o *Ipv6addressDiscoveredData) UnmarshalJSON(data []byte) (err error) {
	varIpv6addressDiscoveredData := _Ipv6addressDiscoveredData{}

	err = json.Unmarshal(data, &varIpv6addressDiscoveredData)

	if err != nil {
		return err
	}

	*o = Ipv6addressDiscoveredData(varIpv6addressDiscoveredData)
...
type NullableIpv6addressDiscoveredData struct {
	value *Ipv6addressDiscoveredData
	isSet bool
}

func (v NullableIpv6addressDiscoveredData) Get() *Ipv6addressDiscoveredData {
	return v.value
}

func (v *NullableIpv6addressDiscoveredData) Set(val *Ipv6addressDiscoveredData) {
	v.value = val
	v.isSet = true
}

func (v NullableIpv6addressDiscoveredData) IsSet() bool {
	return v.isSet
}

func (v *NullableIpv6addressDiscoveredData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpv6addressDiscoveredData(val *Ipv6addressDiscoveredData) *NullableIpv6addressDiscoveredData {
	return &NullableIpv6addressDiscoveredData{value: val, isSet: true}
}

func (v NullableIpv6addressDiscoveredData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpv6addressDiscoveredData) UnmarshalJSON(src []byte) error {
	v.isSet = true
