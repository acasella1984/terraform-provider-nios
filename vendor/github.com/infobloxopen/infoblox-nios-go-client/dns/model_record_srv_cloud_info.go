...
// checks if the RecordSrvCloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordSrvCloudInfo{}

// RecordSrvCloudInfo struct for RecordSrvCloudInfo
type RecordSrvCloudInfo struct {
	DelegatedMember *RecordsrvcloudinfoDelegatedMember `json:"delegated_member,omitempty"`
...
type _RecordSrvCloudInfo RecordSrvCloudInfo
...
func (o *RecordSrvCloudInfo) GetDelegatedMember() RecordsrvcloudinfoDelegatedMember {
	if o == nil || IsNil(o.DelegatedMember) {
		var ret RecordsrvcloudinfoDelegatedMember
		return ret
	}
...
// SetDelegatedMember gets a reference to the given RecordsrvcloudinfoDelegatedMember and assigns it to the DelegatedMember field.
...
func (o RecordSrvCloudInfo) MarshalJSON() ([]byte, error) {
...
func (o RecordSrvCloudInfo) ToMap() (map[string]interface{}, error) {
...
func (o *RecordSrvCloudInfo) UnmarshalJSON(data []byte) (err error) {
	varRecordSrvCloudInfo := _RecordSrvCloudInfo{}

	err = json.Unmarshal(data, &varRecordSrvCloudInfo)

	if err != nil {
		return err
	}

	*o = RecordSrvCloudInfo(varRecordSrvCloudInfo)
...
type NullableRecordSrvCloudInfo struct {
	value *RecordSrvCloudInfo
	isSet bool
}

func (v NullableRecordSrvCloudInfo) Get() *RecordSrvCloudInfo {
	return v.value
}

func (v *NullableRecordSrvCloudInfo) Set(val *RecordSrvCloudInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordSrvCloudInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordSrvCloudInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordSrvCloudInfo(val *RecordSrvCloudInfo) *NullableRecordSrvCloudInfo {
	return &NullableRecordSrvCloudInfo{value: val, isSet: true}
}

func (v NullableRecordSrvCloudInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordSrvCloudInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
