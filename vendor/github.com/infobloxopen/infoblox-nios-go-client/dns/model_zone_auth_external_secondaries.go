...
// checks if the ZoneAuthExternalSecondaries type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoneAuthExternalSecondaries{}

// ZoneAuthExternalSecondaries struct for ZoneAuthExternalSecondaries
type ZoneAuthExternalSecondaries struct {
...
type _ZoneAuthExternalSecondaries ZoneAuthExternalSecondaries
...
func NewZoneAuthExternalSecondaries() *ZoneAuthExternalSecondaries {
	this := ZoneAuthExternalSecondaries{}
	return &this
}
...
func (o *ZoneAuthExternalSecondaries) SetAddress(v string) {
	o.Address = &v
}
...
func (o *ZoneAuthExternalSecondaries) HasSharedWithMsParentDelegation() bool {
	if o != nil && !IsNil(o.SharedWithMsParentDelegation) {
		return true
	}
...
func (o ZoneAuthExternalSecondaries) MarshalJSON() ([]byte, error) {
...
func (o ZoneAuthExternalSecondaries) ToMap() (map[string]interface{}, error) {
...
func (o *ZoneAuthExternalSecondaries) UnmarshalJSON(data []byte) (err error) {
	varZoneAuthExternalSecondaries := _ZoneAuthExternalSecondaries{}

	err = json.Unmarshal(data, &varZoneAuthExternalSecondaries)

	if err != nil {
		return err
	}

	*o = ZoneAuthExternalSecondaries(varZoneAuthExternalSecondaries)
...
type NullableZoneAuthExternalSecondaries struct {
	value *ZoneAuthExternalSecondaries
	isSet bool
}

func (v NullableZoneAuthExternalSecondaries) Get() *ZoneAuthExternalSecondaries {
	return v.value
}

func (v *NullableZoneAuthExternalSecondaries) Set(val *ZoneAuthExternalSecondaries) {
	v.value = val
	v.isSet = true
}

func (v NullableZoneAuthExternalSecondaries) IsSet() bool {
	return v.isSet
}

func (v *NullableZoneAuthExternalSecondaries) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZoneAuthExternalSecondaries(val *ZoneAuthExternalSecondaries) *NullableZoneAuthExternalSecondaries {
	return &NullableZoneAuthExternalSecondaries{value: val, isSet: true}
}

func (v NullableZoneAuthExternalSecondaries) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZoneAuthExternalSecondaries) UnmarshalJSON(src []byte) error {
	v.isSet = true
