...
// checks if the Ipv6rangetemplateMember type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Ipv6rangetemplateMember{}

// Ipv6rangetemplateMember struct for Ipv6rangetemplateMember
type Ipv6rangetemplateMember struct {
...
type _Ipv6rangetemplateMember Ipv6rangetemplateMember
...
func (o Ipv6rangetemplateMember) MarshalJSON() ([]byte, error) {
...
func (o Ipv6rangetemplateMember) ToMap() (map[string]interface{}, error) {
...
func (o *Ipv6rangetemplateMember) UnmarshalJSON(data []byte) (err error) {
	varIpv6rangetemplateMember := _Ipv6rangetemplateMember{}

	err = json.Unmarshal(data, &varIpv6rangetemplateMember)

	if err != nil {
		return err
	}

	*o = Ipv6rangetemplateMember(varIpv6rangetemplateMember)
...
type NullableIpv6rangetemplateMember struct {
	value *Ipv6rangetemplateMember
	isSet bool
}

func (v NullableIpv6rangetemplateMember) Get() *Ipv6rangetemplateMember {
	return v.value
}

func (v *NullableIpv6rangetemplateMember) Set(val *Ipv6rangetemplateMember) {
	v.value = val
	v.isSet = true
}

func (v NullableIpv6rangetemplateMember) IsSet() bool {
	return v.isSet
}

func (v *NullableIpv6rangetemplateMember) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpv6rangetemplateMember(val *Ipv6rangetemplateMember) *NullableIpv6rangetemplateMember {
	return &NullableIpv6rangetemplateMember{value: val, isSet: true}
}

func (v NullableIpv6rangetemplateMember) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpv6rangetemplateMember) UnmarshalJSON(src []byte) error {
	v.isSet = true
