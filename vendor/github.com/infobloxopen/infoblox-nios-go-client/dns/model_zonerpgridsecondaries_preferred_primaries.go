...
// checks if the ZonerpgridsecondariesPreferredPrimaries type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZonerpgridsecondariesPreferredPrimaries{}

// ZonerpgridsecondariesPreferredPrimaries struct for ZonerpgridsecondariesPreferredPrimaries
type ZonerpgridsecondariesPreferredPrimaries struct {
...
type _ZonerpgridsecondariesPreferredPrimaries ZonerpgridsecondariesPreferredPrimaries
...
func NewZonerpgridsecondariesPreferredPrimaries() *ZonerpgridsecondariesPreferredPrimaries {
	this := ZonerpgridsecondariesPreferredPrimaries{}
	return &this
}
...
func (o ZonerpgridsecondariesPreferredPrimaries) MarshalJSON() ([]byte, error) {
...
func (o ZonerpgridsecondariesPreferredPrimaries) ToMap() (map[string]interface{}, error) {
...
func (o *ZonerpgridsecondariesPreferredPrimaries) UnmarshalJSON(data []byte) (err error) {
	varZonerpgridsecondariesPreferredPrimaries := _ZonerpgridsecondariesPreferredPrimaries{}

	err = json.Unmarshal(data, &varZonerpgridsecondariesPreferredPrimaries)

	if err != nil {
		return err
	}

	*o = ZonerpgridsecondariesPreferredPrimaries(varZonerpgridsecondariesPreferredPrimaries)
...
type NullableZonerpgridsecondariesPreferredPrimaries struct {
	value *ZonerpgridsecondariesPreferredPrimaries
	isSet bool
}

func (v NullableZonerpgridsecondariesPreferredPrimaries) Get() *ZonerpgridsecondariesPreferredPrimaries {
	return v.value
}

func (v *NullableZonerpgridsecondariesPreferredPrimaries) Set(val *ZonerpgridsecondariesPreferredPrimaries) {
	v.value = val
	v.isSet = true
}

func (v NullableZonerpgridsecondariesPreferredPrimaries) IsSet() bool {
	return v.isSet
}

func (v *NullableZonerpgridsecondariesPreferredPrimaries) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZonerpgridsecondariesPreferredPrimaries(val *ZonerpgridsecondariesPreferredPrimaries) *NullableZonerpgridsecondariesPreferredPrimaries {
	return &NullableZonerpgridsecondariesPreferredPrimaries{value: val, isSet: true}
}

func (v NullableZonerpgridsecondariesPreferredPrimaries) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZonerpgridsecondariesPreferredPrimaries) UnmarshalJSON(src []byte) error {
	v.isSet = true
