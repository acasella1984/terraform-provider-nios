...
// checks if the NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{}

// NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule struct for NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule
type NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule struct {
...
type _NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule

// NewNetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule instantiates a new NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewNetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule() *NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule {
	this := NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{}
	return &this
}

// NewNetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingScheduleWithDefaults instantiates a new NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewNetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingScheduleWithDefaults() *NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule {
	this := NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{}
	return &this
}
...
func (o *NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) SetMinutesPastHour(v int64) {
	o.MinutesPastHour = &v
}
...
func (o *NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) SetYear(v int64) {
	o.Year = &v
}
...
func (o *NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) SetDayOfMonth(v int64) {
	o.DayOfMonth = &v
}
...
func (o *NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) SetDisable(v bool) {
	o.Disable = &v
}

func (o NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) MarshalJSON() ([]byte, error) {
...
func (o NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) UnmarshalJSON(data []byte) (err error) {
	varNetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule := _NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{}

	err = json.Unmarshal(data, &varNetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule)

	if err != nil {
		return err
	}

	*o = NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule(varNetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule)
...
type NullableNetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule struct {
	value *NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule
	isSet bool
}

func (v NullableNetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) Get() *NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule {
	return v.value
}

func (v *NullableNetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) Set(val *NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule(val *NetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) *NullableNetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule {
	return &NullableNetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{value: val, isSet: true}
}

func (v NullableNetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
