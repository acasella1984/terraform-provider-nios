...
// checks if the GridsecuritysettingAdminAccessItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridsecuritysettingAdminAccessItems{}

// GridsecuritysettingAdminAccessItems struct for GridsecuritysettingAdminAccessItems
type GridsecuritysettingAdminAccessItems struct {
...
type _GridsecuritysettingAdminAccessItems GridsecuritysettingAdminAccessItems
...
func NewGridsecuritysettingAdminAccessItems() *GridsecuritysettingAdminAccessItems {
	this := GridsecuritysettingAdminAccessItems{}
	return &this
}
...
func (o *GridsecuritysettingAdminAccessItems) SetAddress(v string) {
	o.Address = &v
}
...
func (o GridsecuritysettingAdminAccessItems) MarshalJSON() ([]byte, error) {
...
func (o GridsecuritysettingAdminAccessItems) ToMap() (map[string]interface{}, error) {
...
func (o *GridsecuritysettingAdminAccessItems) UnmarshalJSON(data []byte) (err error) {
	varGridsecuritysettingAdminAccessItems := _GridsecuritysettingAdminAccessItems{}

	err = json.Unmarshal(data, &varGridsecuritysettingAdminAccessItems)

	if err != nil {
		return err
	}

	*o = GridsecuritysettingAdminAccessItems(varGridsecuritysettingAdminAccessItems)
...
type NullableGridsecuritysettingAdminAccessItems struct {
	value *GridsecuritysettingAdminAccessItems
	isSet bool
}

func (v NullableGridsecuritysettingAdminAccessItems) Get() *GridsecuritysettingAdminAccessItems {
	return v.value
}

func (v *NullableGridsecuritysettingAdminAccessItems) Set(val *GridsecuritysettingAdminAccessItems) {
	v.value = val
	v.isSet = true
}

func (v NullableGridsecuritysettingAdminAccessItems) IsSet() bool {
	return v.isSet
}

func (v *NullableGridsecuritysettingAdminAccessItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridsecuritysettingAdminAccessItems(val *GridsecuritysettingAdminAccessItems) *NullableGridsecuritysettingAdminAccessItems {
	return &NullableGridsecuritysettingAdminAccessItems{value: val, isSet: true}
}

func (v NullableGridsecuritysettingAdminAccessItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridsecuritysettingAdminAccessItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
