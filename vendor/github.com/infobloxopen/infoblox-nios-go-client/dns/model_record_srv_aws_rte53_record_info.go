...
// checks if the RecordSrvAwsRte53RecordInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordSrvAwsRte53RecordInfo{}

// RecordSrvAwsRte53RecordInfo struct for RecordSrvAwsRte53RecordInfo
type RecordSrvAwsRte53RecordInfo struct {
...
type _RecordSrvAwsRte53RecordInfo RecordSrvAwsRte53RecordInfo
...
func NewRecordSrvAwsRte53RecordInfo() *RecordSrvAwsRte53RecordInfo {
	this := RecordSrvAwsRte53RecordInfo{}
	return &this
}
...
func (o RecordSrvAwsRte53RecordInfo) MarshalJSON() ([]byte, error) {
...
func (o RecordSrvAwsRte53RecordInfo) ToMap() (map[string]interface{}, error) {
...
func (o *RecordSrvAwsRte53RecordInfo) UnmarshalJSON(data []byte) (err error) {
	varRecordSrvAwsRte53RecordInfo := _RecordSrvAwsRte53RecordInfo{}

	err = json.Unmarshal(data, &varRecordSrvAwsRte53RecordInfo)

	if err != nil {
		return err
	}

	*o = RecordSrvAwsRte53RecordInfo(varRecordSrvAwsRte53RecordInfo)
...
type NullableRecordSrvAwsRte53RecordInfo struct {
	value *RecordSrvAwsRte53RecordInfo
	isSet bool
}

func (v NullableRecordSrvAwsRte53RecordInfo) Get() *RecordSrvAwsRte53RecordInfo {
	return v.value
}

func (v *NullableRecordSrvAwsRte53RecordInfo) Set(val *RecordSrvAwsRte53RecordInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordSrvAwsRte53RecordInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordSrvAwsRte53RecordInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordSrvAwsRte53RecordInfo(val *RecordSrvAwsRte53RecordInfo) *NullableRecordSrvAwsRte53RecordInfo {
	return &NullableRecordSrvAwsRte53RecordInfo{value: val, isSet: true}
}

func (v NullableRecordSrvAwsRte53RecordInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordSrvAwsRte53RecordInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
