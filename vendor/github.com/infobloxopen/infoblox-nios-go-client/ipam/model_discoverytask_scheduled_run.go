...
// checks if the DiscoverytaskScheduledRun type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiscoverytaskScheduledRun{}

// DiscoverytaskScheduledRun struct for DiscoverytaskScheduledRun
type DiscoverytaskScheduledRun struct {
...
type _DiscoverytaskScheduledRun DiscoverytaskScheduledRun

// NewDiscoverytaskScheduledRun instantiates a new DiscoverytaskScheduledRun object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDiscoverytaskScheduledRun() *DiscoverytaskScheduledRun {
	this := DiscoverytaskScheduledRun{}
	return &this
}

// NewDiscoverytaskScheduledRunWithDefaults instantiates a new DiscoverytaskScheduledRun object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDiscoverytaskScheduledRunWithDefaults() *DiscoverytaskScheduledRun {
	this := DiscoverytaskScheduledRun{}
	return &this
}

// GetWeekdays returns the Weekdays field value if set, zero value otherwise.
func (o *DiscoverytaskScheduledRun) GetWeekdays() []string {
...
func (o *DiscoverytaskScheduledRun) SetEvery(v int64) {
	o.Every = &v
}
...
func (o *DiscoverytaskScheduledRun) HasHourOfDay() bool {
	if o != nil && !IsNil(o.HourOfDay) {
		return true
	}
...
func (o DiscoverytaskScheduledRun) MarshalJSON() ([]byte, error) {
...
func (o DiscoverytaskScheduledRun) ToMap() (map[string]interface{}, error) {
...
func (o *DiscoverytaskScheduledRun) UnmarshalJSON(data []byte) (err error) {
	varDiscoverytaskScheduledRun := _DiscoverytaskScheduledRun{}

	err = json.Unmarshal(data, &varDiscoverytaskScheduledRun)

	if err != nil {
		return err
	}

	*o = DiscoverytaskScheduledRun(varDiscoverytaskScheduledRun)
...
type NullableDiscoverytaskScheduledRun struct {
	value *DiscoverytaskScheduledRun
	isSet bool
}

func (v NullableDiscoverytaskScheduledRun) Get() *DiscoverytaskScheduledRun {
	return v.value
}

func (v *NullableDiscoverytaskScheduledRun) Set(val *DiscoverytaskScheduledRun) {
	v.value = val
	v.isSet = true
}

func (v NullableDiscoverytaskScheduledRun) IsSet() bool {
	return v.isSet
}

func (v *NullableDiscoverytaskScheduledRun) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiscoverytaskScheduledRun(val *DiscoverytaskScheduledRun) *NullableDiscoverytaskScheduledRun {
	return &NullableDiscoverytaskScheduledRun{value: val, isSet: true}
}

func (v NullableDiscoverytaskScheduledRun) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiscoverytaskScheduledRun) UnmarshalJSON(src []byte) error {
	v.isSet = true
