...
// checks if the RangetemplateDelegatedMember type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RangetemplateDelegatedMember{}

// RangetemplateDelegatedMember struct for RangetemplateDelegatedMember
type RangetemplateDelegatedMember struct {
...
type _RangetemplateDelegatedMember RangetemplateDelegatedMember
...
func NewRangetemplateDelegatedMember() *RangetemplateDelegatedMember {
	this := RangetemplateDelegatedMember{}
	return &this
}
...
func (o RangetemplateDelegatedMember) MarshalJSON() ([]byte, error) {
...
func (o RangetemplateDelegatedMember) ToMap() (map[string]interface{}, error) {
...
func (o *RangetemplateDelegatedMember) UnmarshalJSON(data []byte) (err error) {
	varRangetemplateDelegatedMember := _RangetemplateDelegatedMember{}

	err = json.Unmarshal(data, &varRangetemplateDelegatedMember)

	if err != nil {
		return err
	}

	*o = RangetemplateDelegatedMember(varRangetemplateDelegatedMember)
...
type NullableRangetemplateDelegatedMember struct {
	value *RangetemplateDelegatedMember
	isSet bool
}

func (v NullableRangetemplateDelegatedMember) Get() *RangetemplateDelegatedMember {
	return v.value
}

func (v *NullableRangetemplateDelegatedMember) Set(val *RangetemplateDelegatedMember) {
	v.value = val
	v.isSet = true
}

func (v NullableRangetemplateDelegatedMember) IsSet() bool {
	return v.isSet
}

func (v *NullableRangetemplateDelegatedMember) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRangetemplateDelegatedMember(val *RangetemplateDelegatedMember) *NullableRangetemplateDelegatedMember {
	return &NullableRangetemplateDelegatedMember{value: val, isSet: true}
}

func (v NullableRangetemplateDelegatedMember) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRangetemplateDelegatedMember) UnmarshalJSON(src []byte) error {
	v.isSet = true
