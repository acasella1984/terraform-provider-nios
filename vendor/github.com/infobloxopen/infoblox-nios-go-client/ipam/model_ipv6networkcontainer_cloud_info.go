...
// checks if the Ipv6networkcontainerCloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Ipv6networkcontainerCloudInfo{}

// Ipv6networkcontainerCloudInfo struct for Ipv6networkcontainerCloudInfo
type Ipv6networkcontainerCloudInfo struct {
	DelegatedMember *Ipv6networkcontainercloudinfoDelegatedMember `json:"delegated_member,omitempty"`
...
type _Ipv6networkcontainerCloudInfo Ipv6networkcontainerCloudInfo
...
func NewIpv6networkcontainerCloudInfo() *Ipv6networkcontainerCloudInfo {
	this := Ipv6networkcontainerCloudInfo{}
	return &this
}
...
func (o *Ipv6networkcontainerCloudInfo) GetDelegatedMember() Ipv6networkcontainercloudinfoDelegatedMember {
	if o == nil || IsNil(o.DelegatedMember) {
		var ret Ipv6networkcontainercloudinfoDelegatedMember
		return ret
	}
...
// SetDelegatedMember gets a reference to the given Ipv6networkcontainercloudinfoDelegatedMember and assigns it to the DelegatedMember field.
...
func (o Ipv6networkcontainerCloudInfo) MarshalJSON() ([]byte, error) {
...
func (o Ipv6networkcontainerCloudInfo) ToMap() (map[string]interface{}, error) {
...
func (o *Ipv6networkcontainerCloudInfo) UnmarshalJSON(data []byte) (err error) {
	varIpv6networkcontainerCloudInfo := _Ipv6networkcontainerCloudInfo{}

	err = json.Unmarshal(data, &varIpv6networkcontainerCloudInfo)

	if err != nil {
		return err
	}

	*o = Ipv6networkcontainerCloudInfo(varIpv6networkcontainerCloudInfo)
...
type NullableIpv6networkcontainerCloudInfo struct {
	value *Ipv6networkcontainerCloudInfo
	isSet bool
}

func (v NullableIpv6networkcontainerCloudInfo) Get() *Ipv6networkcontainerCloudInfo {
	return v.value
}

func (v *NullableIpv6networkcontainerCloudInfo) Set(val *Ipv6networkcontainerCloudInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableIpv6networkcontainerCloudInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableIpv6networkcontainerCloudInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpv6networkcontainerCloudInfo(val *Ipv6networkcontainerCloudInfo) *NullableIpv6networkcontainerCloudInfo {
	return &NullableIpv6networkcontainerCloudInfo{value: val, isSet: true}
}

func (v NullableIpv6networkcontainerCloudInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpv6networkcontainerCloudInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
