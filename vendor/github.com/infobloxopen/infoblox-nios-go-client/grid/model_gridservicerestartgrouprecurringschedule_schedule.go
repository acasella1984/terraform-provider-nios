...
// checks if the GridservicerestartgrouprecurringscheduleSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridservicerestartgrouprecurringscheduleSchedule{}

// GridservicerestartgrouprecurringscheduleSchedule struct for GridservicerestartgrouprecurringscheduleSchedule
type GridservicerestartgrouprecurringscheduleSchedule struct {
...
type _GridservicerestartgrouprecurringscheduleSchedule GridservicerestartgrouprecurringscheduleSchedule
...
func NewGridservicerestartgrouprecurringscheduleSchedule() *GridservicerestartgrouprecurringscheduleSchedule {
	this := GridservicerestartgrouprecurringscheduleSchedule{}
	return &this
}
...
func (o GridservicerestartgrouprecurringscheduleSchedule) MarshalJSON() ([]byte, error) {
...
func (o GridservicerestartgrouprecurringscheduleSchedule) ToMap() (map[string]interface{}, error) {
...
func (o *GridservicerestartgrouprecurringscheduleSchedule) UnmarshalJSON(data []byte) (err error) {
	varGridservicerestartgrouprecurringscheduleSchedule := _GridservicerestartgrouprecurringscheduleSchedule{}

	err = json.Unmarshal(data, &varGridservicerestartgrouprecurringscheduleSchedule)

	if err != nil {
		return err
	}

	*o = GridservicerestartgrouprecurringscheduleSchedule(varGridservicerestartgrouprecurringscheduleSchedule)
...
type NullableGridservicerestartgrouprecurringscheduleSchedule struct {
	value *GridservicerestartgrouprecurringscheduleSchedule
	isSet bool
}

func (v NullableGridservicerestartgrouprecurringscheduleSchedule) Get() *GridservicerestartgrouprecurringscheduleSchedule {
	return v.value
}

func (v *NullableGridservicerestartgrouprecurringscheduleSchedule) Set(val *GridservicerestartgrouprecurringscheduleSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableGridservicerestartgrouprecurringscheduleSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableGridservicerestartgrouprecurringscheduleSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridservicerestartgrouprecurringscheduleSchedule(val *GridservicerestartgrouprecurringscheduleSchedule) *NullableGridservicerestartgrouprecurringscheduleSchedule {
	return &NullableGridservicerestartgrouprecurringscheduleSchedule{value: val, isSet: true}
}

func (v NullableGridservicerestartgrouprecurringscheduleSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridservicerestartgrouprecurringscheduleSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
