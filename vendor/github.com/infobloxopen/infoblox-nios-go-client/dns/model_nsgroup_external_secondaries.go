...
// checks if the NsgroupExternalSecondaries type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NsgroupExternalSecondaries{}

// NsgroupExternalSecondaries struct for NsgroupExternalSecondaries
type NsgroupExternalSecondaries struct {
...
type _NsgroupExternalSecondaries NsgroupExternalSecondaries
...
func NewNsgroupExternalSecondaries() *NsgroupExternalSecondaries {
	this := NsgroupExternalSecondaries{}
	return &this
}
...
func (o NsgroupExternalSecondaries) MarshalJSON() ([]byte, error) {
...
func (o NsgroupExternalSecondaries) ToMap() (map[string]interface{}, error) {
...
func (o *NsgroupExternalSecondaries) UnmarshalJSON(data []byte) (err error) {
	varNsgroupExternalSecondaries := _NsgroupExternalSecondaries{}

	err = json.Unmarshal(data, &varNsgroupExternalSecondaries)

	if err != nil {
		return err
	}

	*o = NsgroupExternalSecondaries(varNsgroupExternalSecondaries)
...
type NullableNsgroupExternalSecondaries struct {
	value *NsgroupExternalSecondaries
	isSet bool
}

func (v NullableNsgroupExternalSecondaries) Get() *NsgroupExternalSecondaries {
	return v.value
}

func (v *NullableNsgroupExternalSecondaries) Set(val *NsgroupExternalSecondaries) {
	v.value = val
	v.isSet = true
}

func (v NullableNsgroupExternalSecondaries) IsSet() bool {
	return v.isSet
}

func (v *NullableNsgroupExternalSecondaries) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNsgroupExternalSecondaries(val *NsgroupExternalSecondaries) *NullableNsgroupExternalSecondaries {
	return &NullableNsgroupExternalSecondaries{value: val, isSet: true}
}

func (v NullableNsgroupExternalSecondaries) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNsgroupExternalSecondaries) UnmarshalJSON(src []byte) error {
	v.isSet = true
