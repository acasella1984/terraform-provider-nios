...
// checks if the Ipv6rangeMember type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Ipv6rangeMember{}

// Ipv6rangeMember struct for Ipv6rangeMember
type Ipv6rangeMember struct {
...
type _Ipv6rangeMember Ipv6rangeMember
...
func (o Ipv6rangeMember) MarshalJSON() ([]byte, error) {
...
func (o Ipv6rangeMember) ToMap() (map[string]interface{}, error) {
...
func (o *Ipv6rangeMember) UnmarshalJSON(data []byte) (err error) {
	varIpv6rangeMember := _Ipv6rangeMember{}

	err = json.Unmarshal(data, &varIpv6rangeMember)

	if err != nil {
		return err
	}

	*o = Ipv6rangeMember(varIpv6rangeMember)
...
type NullableIpv6rangeMember struct {
	value *Ipv6rangeMember
	isSet bool
}

func (v NullableIpv6rangeMember) Get() *Ipv6rangeMember {
	return v.value
}

func (v *NullableIpv6rangeMember) Set(val *Ipv6rangeMember) {
	v.value = val
	v.isSet = true
}

func (v NullableIpv6rangeMember) IsSet() bool {
	return v.isSet
}

func (v *NullableIpv6rangeMember) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpv6rangeMember(val *Ipv6rangeMember) *NullableIpv6rangeMember {
	return &NullableIpv6rangeMember{value: val, isSet: true}
}

func (v NullableIpv6rangeMember) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpv6rangeMember) UnmarshalJSON(src []byte) error {
	v.isSet = true
