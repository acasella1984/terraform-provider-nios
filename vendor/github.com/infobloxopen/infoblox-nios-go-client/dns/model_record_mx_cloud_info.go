...
// checks if the RecordMxCloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordMxCloudInfo{}

// RecordMxCloudInfo struct for RecordMxCloudInfo
type RecordMxCloudInfo struct {
	DelegatedMember *RecordmxcloudinfoDelegatedMember `json:"delegated_member,omitempty"`
...
type _RecordMxCloudInfo RecordMxCloudInfo
...
func (o *RecordMxCloudInfo) GetDelegatedMember() RecordmxcloudinfoDelegatedMember {
	if o == nil || IsNil(o.DelegatedMember) {
		var ret RecordmxcloudinfoDelegatedMember
		return ret
	}
...
// SetDelegatedMember gets a reference to the given RecordmxcloudinfoDelegatedMember and assigns it to the DelegatedMember field.
...
func (o RecordMxCloudInfo) MarshalJSON() ([]byte, error) {
...
func (o RecordMxCloudInfo) ToMap() (map[string]interface{}, error) {
...
func (o *RecordMxCloudInfo) UnmarshalJSON(data []byte) (err error) {
	varRecordMxCloudInfo := _RecordMxCloudInfo{}

	err = json.Unmarshal(data, &varRecordMxCloudInfo)

	if err != nil {
		return err
	}

	*o = RecordMxCloudInfo(varRecordMxCloudInfo)
...
type NullableRecordMxCloudInfo struct {
	value *RecordMxCloudInfo
	isSet bool
}

func (v NullableRecordMxCloudInfo) Get() *RecordMxCloudInfo {
	return v.value
}

func (v *NullableRecordMxCloudInfo) Set(val *RecordMxCloudInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordMxCloudInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordMxCloudInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordMxCloudInfo(val *RecordMxCloudInfo) *NullableRecordMxCloudInfo {
	return &NullableRecordMxCloudInfo{value: val, isSet: true}
}

func (v NullableRecordMxCloudInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordMxCloudInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
