...
// checks if the Ipv6networkOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Ipv6networkOptions{}

// Ipv6networkOptions struct for Ipv6networkOptions
type Ipv6networkOptions struct {
...
type _Ipv6networkOptions Ipv6networkOptions
...
func (o Ipv6networkOptions) MarshalJSON() ([]byte, error) {
...
func (o *Ipv6networkOptions) UnmarshalJSON(data []byte) (err error) {
	varIpv6networkOptions := _Ipv6networkOptions{}

	err = json.Unmarshal(data, &varIpv6networkOptions)

	if err != nil {
		return err
	}

	*o = Ipv6networkOptions(varIpv6networkOptions)
...
type NullableIpv6networkOptions struct {
	value *Ipv6networkOptions
	isSet bool
}

func (v NullableIpv6networkOptions) Get() *Ipv6networkOptions {
	return v.value
}

func (v *NullableIpv6networkOptions) Set(val *Ipv6networkOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableIpv6networkOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableIpv6networkOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpv6networkOptions(val *Ipv6networkOptions) *NullableIpv6networkOptions {
	return &NullableIpv6networkOptions{value: val, isSet: true}
}

func (v NullableIpv6networkOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpv6networkOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
