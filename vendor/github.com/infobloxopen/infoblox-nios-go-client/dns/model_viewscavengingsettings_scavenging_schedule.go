...
// checks if the ViewscavengingsettingsScavengingSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewscavengingsettingsScavengingSchedule{}

// ViewscavengingsettingsScavengingSchedule struct for ViewscavengingsettingsScavengingSchedule
type ViewscavengingsettingsScavengingSchedule struct {
...
type _ViewscavengingsettingsScavengingSchedule ViewscavengingsettingsScavengingSchedule

// NewViewscavengingsettingsScavengingSchedule instantiates a new ViewscavengingsettingsScavengingSchedule object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewViewscavengingsettingsScavengingSchedule() *ViewscavengingsettingsScavengingSchedule {
	this := ViewscavengingsettingsScavengingSchedule{}
	return &this
}

// NewViewscavengingsettingsScavengingScheduleWithDefaults instantiates a new ViewscavengingsettingsScavengingSchedule object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewViewscavengingsettingsScavengingScheduleWithDefaults() *ViewscavengingsettingsScavengingSchedule {
	this := ViewscavengingsettingsScavengingSchedule{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *ViewscavengingsettingsScavengingSchedule) GetRecurringTimeOk() (*int64, bool) {
	if o == nil || IsNil(o.RecurringTime) {
		return nil, false
	}
...
func (o *ViewscavengingsettingsScavengingSchedule) SetEvery(v int64) {
	o.Every = &v
}
...
func (o *ViewscavengingsettingsScavengingSchedule) HasHourOfDay() bool {
	if o != nil && !IsNil(o.HourOfDay) {
		return true
	}
...
func (o ViewscavengingsettingsScavengingSchedule) MarshalJSON() ([]byte, error) {
...
func (o ViewscavengingsettingsScavengingSchedule) ToMap() (map[string]interface{}, error) {
...
func (o *ViewscavengingsettingsScavengingSchedule) UnmarshalJSON(data []byte) (err error) {
	varViewscavengingsettingsScavengingSchedule := _ViewscavengingsettingsScavengingSchedule{}

	err = json.Unmarshal(data, &varViewscavengingsettingsScavengingSchedule)

	if err != nil {
		return err
	}

	*o = ViewscavengingsettingsScavengingSchedule(varViewscavengingsettingsScavengingSchedule)
...
type NullableViewscavengingsettingsScavengingSchedule struct {
	value *ViewscavengingsettingsScavengingSchedule
	isSet bool
}

func (v NullableViewscavengingsettingsScavengingSchedule) Get() *ViewscavengingsettingsScavengingSchedule {
	return v.value
}

func (v *NullableViewscavengingsettingsScavengingSchedule) Set(val *ViewscavengingsettingsScavengingSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableViewscavengingsettingsScavengingSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableViewscavengingsettingsScavengingSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewscavengingsettingsScavengingSchedule(val *ViewscavengingsettingsScavengingSchedule) *NullableViewscavengingsettingsScavengingSchedule {
	return &NullableViewscavengingsettingsScavengingSchedule{value: val, isSet: true}
}

func (v NullableViewscavengingsettingsScavengingSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewscavengingsettingsScavengingSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
