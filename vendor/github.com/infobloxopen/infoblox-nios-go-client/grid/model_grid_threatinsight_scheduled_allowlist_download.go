...
// checks if the GridThreatinsightScheduledAllowlistDownload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GridThreatinsightScheduledAllowlistDownload{}

// GridThreatinsightScheduledAllowlistDownload struct for GridThreatinsightScheduledAllowlistDownload
type GridThreatinsightScheduledAllowlistDownload struct {
...
type _GridThreatinsightScheduledAllowlistDownload GridThreatinsightScheduledAllowlistDownload
...
func NewGridThreatinsightScheduledAllowlistDownload() *GridThreatinsightScheduledAllowlistDownload {
	this := GridThreatinsightScheduledAllowlistDownload{}
	return &this
}
...
func (o GridThreatinsightScheduledAllowlistDownload) MarshalJSON() ([]byte, error) {
...
func (o GridThreatinsightScheduledAllowlistDownload) ToMap() (map[string]interface{}, error) {
...
func (o *GridThreatinsightScheduledAllowlistDownload) UnmarshalJSON(data []byte) (err error) {
	varGridThreatinsightScheduledAllowlistDownload := _GridThreatinsightScheduledAllowlistDownload{}

	err = json.Unmarshal(data, &varGridThreatinsightScheduledAllowlistDownload)

	if err != nil {
		return err
	}

	*o = GridThreatinsightScheduledAllowlistDownload(varGridThreatinsightScheduledAllowlistDownload)
...
type NullableGridThreatinsightScheduledAllowlistDownload struct {
	value *GridThreatinsightScheduledAllowlistDownload
	isSet bool
}

func (v NullableGridThreatinsightScheduledAllowlistDownload) Get() *GridThreatinsightScheduledAllowlistDownload {
	return v.value
}

func (v *NullableGridThreatinsightScheduledAllowlistDownload) Set(val *GridThreatinsightScheduledAllowlistDownload) {
	v.value = val
	v.isSet = true
}

func (v NullableGridThreatinsightScheduledAllowlistDownload) IsSet() bool {
	return v.isSet
}

func (v *NullableGridThreatinsightScheduledAllowlistDownload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGridThreatinsightScheduledAllowlistDownload(val *GridThreatinsightScheduledAllowlistDownload) *NullableGridThreatinsightScheduledAllowlistDownload {
	return &NullableGridThreatinsightScheduledAllowlistDownload{value: val, isSet: true}
}

func (v NullableGridThreatinsightScheduledAllowlistDownload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGridThreatinsightScheduledAllowlistDownload) UnmarshalJSON(src []byte) error {
	v.isSet = true
