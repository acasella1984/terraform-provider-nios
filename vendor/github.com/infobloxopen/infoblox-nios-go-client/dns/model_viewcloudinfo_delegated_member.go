...
// checks if the ViewcloudinfoDelegatedMember type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewcloudinfoDelegatedMember{}

// ViewcloudinfoDelegatedMember struct for ViewcloudinfoDelegatedMember
type ViewcloudinfoDelegatedMember struct {
...
type _ViewcloudinfoDelegatedMember ViewcloudinfoDelegatedMember
...
func NewViewcloudinfoDelegatedMember() *ViewcloudinfoDelegatedMember {
	this := ViewcloudinfoDelegatedMember{}
	return &this
}
...
func (o ViewcloudinfoDelegatedMember) MarshalJSON() ([]byte, error) {
...
func (o ViewcloudinfoDelegatedMember) ToMap() (map[string]interface{}, error) {
...
func (o *ViewcloudinfoDelegatedMember) UnmarshalJSON(data []byte) (err error) {
	varViewcloudinfoDelegatedMember := _ViewcloudinfoDelegatedMember{}

	err = json.Unmarshal(data, &varViewcloudinfoDelegatedMember)

	if err != nil {
		return err
	}

	*o = ViewcloudinfoDelegatedMember(varViewcloudinfoDelegatedMember)
...
type NullableViewcloudinfoDelegatedMember struct {
	value *ViewcloudinfoDelegatedMember
	isSet bool
}

func (v NullableViewcloudinfoDelegatedMember) Get() *ViewcloudinfoDelegatedMember {
	return v.value
}

func (v *NullableViewcloudinfoDelegatedMember) Set(val *ViewcloudinfoDelegatedMember) {
	v.value = val
	v.isSet = true
}

func (v NullableViewcloudinfoDelegatedMember) IsSet() bool {
	return v.isSet
}

func (v *NullableViewcloudinfoDelegatedMember) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewcloudinfoDelegatedMember(val *ViewcloudinfoDelegatedMember) *NullableViewcloudinfoDelegatedMember {
	return &NullableViewcloudinfoDelegatedMember{value: val, isSet: true}
}

func (v NullableViewcloudinfoDelegatedMember) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewcloudinfoDelegatedMember) UnmarshalJSON(src []byte) error {
	v.isSet = true
