...
// checks if the RecordAliasCloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordAliasCloudInfo{}

// RecordAliasCloudInfo struct for RecordAliasCloudInfo
type RecordAliasCloudInfo struct {
	DelegatedMember *RecordaliascloudinfoDelegatedMember `json:"delegated_member,omitempty"`
...
type _RecordAliasCloudInfo RecordAliasCloudInfo
...
func (o *RecordAliasCloudInfo) GetDelegatedMember() RecordaliascloudinfoDelegatedMember {
	if o == nil || IsNil(o.DelegatedMember) {
		var ret RecordaliascloudinfoDelegatedMember
		return ret
	}
...
func (o *RecordAliasCloudInfo) GetDelegatedMemberOk() (*RecordaliascloudinfoDelegatedMember, bool) {
	if o == nil || IsNil(o.DelegatedMember) {
		return nil, false
	}
...
// SetDelegatedMember gets a reference to the given RecordaliascloudinfoDelegatedMember and assigns it to the DelegatedMember field.
...
func (o *RecordAliasCloudInfo) GetAuthorityType() string {
...
func (o RecordAliasCloudInfo) MarshalJSON() ([]byte, error) {
...
func (o RecordAliasCloudInfo) ToMap() (map[string]interface{}, error) {
...
func (o *RecordAliasCloudInfo) UnmarshalJSON(data []byte) (err error) {
	varRecordAliasCloudInfo := _RecordAliasCloudInfo{}

	err = json.Unmarshal(data, &varRecordAliasCloudInfo)

	if err != nil {
		return err
	}

	*o = RecordAliasCloudInfo(varRecordAliasCloudInfo)
...
type NullableRecordAliasCloudInfo struct {
	value *RecordAliasCloudInfo
	isSet bool
}

func (v NullableRecordAliasCloudInfo) Get() *RecordAliasCloudInfo {
	return v.value
}

func (v *NullableRecordAliasCloudInfo) Set(val *RecordAliasCloudInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordAliasCloudInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordAliasCloudInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordAliasCloudInfo(val *RecordAliasCloudInfo) *NullableRecordAliasCloudInfo {
	return &NullableRecordAliasCloudInfo{value: val, isSet: true}
}

func (v NullableRecordAliasCloudInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecordAliasCloudInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
