...
// checks if the Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{}

// Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule struct for Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule
type Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule struct {
...
type _Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule

// NewIpv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule instantiates a new Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewIpv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule() *Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule {
	this := Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{}
	return &this
}

// NewIpv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingScheduleWithDefaults instantiates a new Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewIpv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingScheduleWithDefaults() *Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule {
	this := Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{}
	return &this
}
...
func (o *Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) SetMinutesPastHour(v int64) {
	o.MinutesPastHour = &v
}
...
func (o *Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) SetYear(v int64) {
	o.Year = &v
}
...
func (o *Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) SetDayOfMonth(v int64) {
	o.DayOfMonth = &v
}
...
func (o *Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) SetDisable(v bool) {
	o.Disable = &v
}

func (o Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) MarshalJSON() ([]byte, error) {
...
func (o *Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) UnmarshalJSON(data []byte) (err error) {
	varIpv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule := _Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{}

	err = json.Unmarshal(data, &varIpv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule)

	if err != nil {
		return err
	}

	*o = Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule(varIpv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule)
...
type NullableIpv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule struct {
	value *Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule
	isSet bool
}

func (v NullableIpv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) Get() *Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule {
	return v.value
}

func (v *NullableIpv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) Set(val *Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableIpv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableIpv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule(val *Ipv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) *NullableIpv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule {
	return &NullableIpv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule{value: val, isSet: true}
}

func (v NullableIpv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpv6networkcontainerdiscoverybasicpollsettingsSwitchPortDataCollectionPollingSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
