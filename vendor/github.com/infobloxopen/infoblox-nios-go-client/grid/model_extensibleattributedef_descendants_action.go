...
// checks if the ExtensibleattributedefDescendantsAction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtensibleattributedefDescendantsAction{}

// ExtensibleattributedefDescendantsAction struct for ExtensibleattributedefDescendantsAction
type ExtensibleattributedefDescendantsAction struct {
...
type _ExtensibleattributedefDescendantsAction ExtensibleattributedefDescendantsAction
...
func NewExtensibleattributedefDescendantsAction() *ExtensibleattributedefDescendantsAction {
	this := ExtensibleattributedefDescendantsAction{}
	return &this
}
...
func (o ExtensibleattributedefDescendantsAction) MarshalJSON() ([]byte, error) {
...
func (o ExtensibleattributedefDescendantsAction) ToMap() (map[string]interface{}, error) {
...
func (o *ExtensibleattributedefDescendantsAction) UnmarshalJSON(data []byte) (err error) {
	varExtensibleattributedefDescendantsAction := _ExtensibleattributedefDescendantsAction{}

	err = json.Unmarshal(data, &varExtensibleattributedefDescendantsAction)

	if err != nil {
		return err
	}

	*o = ExtensibleattributedefDescendantsAction(varExtensibleattributedefDescendantsAction)
...
type NullableExtensibleattributedefDescendantsAction struct {
	value *ExtensibleattributedefDescendantsAction
	isSet bool
}

func (v NullableExtensibleattributedefDescendantsAction) Get() *ExtensibleattributedefDescendantsAction {
	return v.value
}

func (v *NullableExtensibleattributedefDescendantsAction) Set(val *ExtensibleattributedefDescendantsAction) {
	v.value = val
	v.isSet = true
}

func (v NullableExtensibleattributedefDescendantsAction) IsSet() bool {
	return v.isSet
}

func (v *NullableExtensibleattributedefDescendantsAction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtensibleattributedefDescendantsAction(val *ExtensibleattributedefDescendantsAction) *NullableExtensibleattributedefDescendantsAction {
	return &NullableExtensibleattributedefDescendantsAction{value: val, isSet: true}
}

func (v NullableExtensibleattributedefDescendantsAction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtensibleattributedefDescendantsAction) UnmarshalJSON(src []byte) error {
	v.isSet = true
