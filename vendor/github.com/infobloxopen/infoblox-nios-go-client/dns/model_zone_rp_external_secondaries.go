...
// checks if the ZoneRpExternalSecondaries type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoneRpExternalSecondaries{}

// ZoneRpExternalSecondaries struct for ZoneRpExternalSecondaries
type ZoneRpExternalSecondaries struct {
...
type _ZoneRpExternalSecondaries ZoneRpExternalSecondaries
...
func NewZoneRpExternalSecondaries() *ZoneRpExternalSecondaries {
	this := ZoneRpExternalSecondaries{}
	return &this
}
...
func (o *ZoneRpExternalSecondaries) SetAddress(v string) {
	o.Address = &v
}
...
func (o *ZoneRpExternalSecondaries) HasSharedWithMsParentDelegation() bool {
	if o != nil && !IsNil(o.SharedWithMsParentDelegation) {
		return true
	}
...
func (o ZoneRpExternalSecondaries) MarshalJSON() ([]byte, error) {
...
func (o ZoneRpExternalSecondaries) ToMap() (map[string]interface{}, error) {
...
func (o *ZoneRpExternalSecondaries) UnmarshalJSON(data []byte) (err error) {
	varZoneRpExternalSecondaries := _ZoneRpExternalSecondaries{}

	err = json.Unmarshal(data, &varZoneRpExternalSecondaries)

	if err != nil {
		return err
	}

	*o = ZoneRpExternalSecondaries(varZoneRpExternalSecondaries)
...
type NullableZoneRpExternalSecondaries struct {
	value *ZoneRpExternalSecondaries
	isSet bool
}

func (v NullableZoneRpExternalSecondaries) Get() *ZoneRpExternalSecondaries {
	return v.value
}

func (v *NullableZoneRpExternalSecondaries) Set(val *ZoneRpExternalSecondaries) {
	v.value = val
	v.isSet = true
}

func (v NullableZoneRpExternalSecondaries) IsSet() bool {
	return v.isSet
}

func (v *NullableZoneRpExternalSecondaries) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZoneRpExternalSecondaries(val *ZoneRpExternalSecondaries) *NullableZoneRpExternalSecondaries {
	return &NullableZoneRpExternalSecondaries{value: val, isSet: true}
}

func (v NullableZoneRpExternalSecondaries) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZoneRpExternalSecondaries) UnmarshalJSON(src []byte) error {
	v.isSet = true
