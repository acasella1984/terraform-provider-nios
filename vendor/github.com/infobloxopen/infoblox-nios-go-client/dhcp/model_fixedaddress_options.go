...
// checks if the FixedaddressOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FixedaddressOptions{}

// FixedaddressOptions struct for FixedaddressOptions
type FixedaddressOptions struct {
...
type _FixedaddressOptions FixedaddressOptions
...
func (o FixedaddressOptions) MarshalJSON() ([]byte, error) {
...
func (o FixedaddressOptions) ToMap() (map[string]interface{}, error) {
...
func (o *FixedaddressOptions) UnmarshalJSON(data []byte) (err error) {
	varFixedaddressOptions := _FixedaddressOptions{}

	err = json.Unmarshal(data, &varFixedaddressOptions)

	if err != nil {
		return err
	}

	*o = FixedaddressOptions(varFixedaddressOptions)
...
type NullableFixedaddressOptions struct {
	value *FixedaddressOptions
	isSet bool
}

func (v NullableFixedaddressOptions) Get() *FixedaddressOptions {
	return v.value
}

func (v *NullableFixedaddressOptions) Set(val *FixedaddressOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableFixedaddressOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableFixedaddressOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFixedaddressOptions(val *FixedaddressOptions) *NullableFixedaddressOptions {
	return &NullableFixedaddressOptions{value: val, isSet: true}
}

func (v NullableFixedaddressOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFixedaddressOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
